...
### Requirement: Graph Validation Fabric stays evidence-bound and non-destructive
The system MUST keep graph validation fabric actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
