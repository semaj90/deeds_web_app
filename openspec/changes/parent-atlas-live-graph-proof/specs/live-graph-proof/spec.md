...
### Requirement: Live Graph Proof stays evidence-bound and non-destructive
The system MUST keep live graph proof actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
