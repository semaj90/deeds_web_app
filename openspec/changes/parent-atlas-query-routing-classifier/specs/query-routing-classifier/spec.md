...
### Requirement: Query Routing Classifier stays evidence-bound and non-destructive
The system MUST keep query routing classifier actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
