...
- [ ] **VAL-02** Pydantic mirror in `python/` (transport only, never a second authority): round-trip test against a TS-emitted fixture; unknown fields rejected on both sides.
