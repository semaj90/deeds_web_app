...
### Requirement: Repair Candidate Feature Matrix stays evidence-bound and non-destructive
The system MUST keep repair candidate feature matrix actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
