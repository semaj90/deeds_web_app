...
### Requirement: Agentic File Compiler stays evidence-bound and non-destructive
The system MUST keep agentic file compiler actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
