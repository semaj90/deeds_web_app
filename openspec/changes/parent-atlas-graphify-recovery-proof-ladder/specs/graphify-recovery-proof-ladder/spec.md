...
### Requirement: Graphify Recovery Proof Ladder stays evidence-bound and non-destructive
The system MUST keep graphify recovery proof ladder actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
