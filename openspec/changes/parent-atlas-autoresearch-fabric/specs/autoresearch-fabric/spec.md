...
### Requirement: Autoresearch Fabric stays evidence-bound and non-destructive
The system MUST keep autoresearch fabric actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
