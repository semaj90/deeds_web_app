...
### Requirement: Route Import Infra Isolation stays evidence-bound and non-destructive
The system MUST keep route import infra isolation actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
