# Retrieval LOD — a domain classification for Parent Atlas ranking algorithms

## ADDED Requirements

### Requirement: Retrieval Lod Algorithm Taxonomy stays evidence-bound and non-destructive
The system MUST keep retrieval lod algorithm taxonomy actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
