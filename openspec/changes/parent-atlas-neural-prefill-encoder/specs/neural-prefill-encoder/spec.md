...
### Requirement: Neural Prefill Encoder stays evidence-bound and non-destructive
The system MUST keep neural prefill encoder actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
