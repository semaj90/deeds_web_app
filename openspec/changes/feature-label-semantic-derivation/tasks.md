...
| FEATURE_LABEL_DERIVATION_FN | NOT_STARTED (Phase 1) |
| FEATURE_LABEL_REPORT_FIELDS | NOT_STARTED (Phase 2) |
| FEATURE_LABEL_ENVELOPE_CARRY | NOT_STARTED (Phase 3) |
| FEATURE_LABEL_IN_OPENSPEC_DRAFTS | NOT_STARTED (Phase 4) |
