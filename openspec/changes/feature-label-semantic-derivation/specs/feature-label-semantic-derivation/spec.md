...
### Requirement: Feature Label Semantic Derivation stays evidence-bound and non-destructive
The system MUST keep feature label semantic derivation actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
