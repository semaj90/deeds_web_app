# Opencode Replay Proof

## ADDED Requirements

### Requirement: Opencode Replay Proof stays evidence-bound and non-destructive
The system MUST keep opencode replay proof actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
