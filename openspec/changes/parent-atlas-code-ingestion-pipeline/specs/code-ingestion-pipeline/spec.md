...
### Requirement: Code Ingestion Pipeline stays evidence-bound and non-destructive
The system MUST keep code ingestion pipeline actions identity-qualified, non-destructive, and traceable to real evidence rather than assumed or fabricated state.
