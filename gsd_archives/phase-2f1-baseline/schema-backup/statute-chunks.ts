 ...
 *   sveltekit-frontend/src/lib/server/db/schema-postgres.ts:1541
 *
...
export type StatuteChunks = typeof statuteChunks.$inferSelect;
export type NewStatuteChunks = typeof statuteChunks.$inferInsert;
