...
Suggested later aliases (only after wiring): `tensor:ae:smoke`, `tensor:lod:smoke`, `tensor:rerank-cache:smoke`. Do not add aliases until a live runtime caller exists.
