...
- `infra_status.json`
- `sveltekit_vlm_result.json`
- `text_test.json`
- `vlm_endpoint_request.json`
- `vlm_request.json`
- `vlm_result.json`
- `infra_status.json`
- `sveltekit_vlm_result.json`
...
- `graph_search({ query: "vlm-tests", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "tests vlm-tests", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/tests/vlm-tests/<file>" })` — fetch any file's contents (sandboxed to src/)
