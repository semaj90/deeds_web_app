...
- `wiki_note_lookup({ query: "eval data", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/eval/data/<file>" })` — fetch any file's contents (sandboxed to src/)
