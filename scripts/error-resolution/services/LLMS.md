# AGENTS.md — `scripts/error-resolution/services`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/error-resolution/services
...
- **Paired tests**: 12/12 files have paired tests
...
- `wiki_note_lookup({ query: "error-resolution services", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/error-resolution/services/<file>" })` — fetch any file's contents (sandboxed to src/)
