...
- `graph_search({ query: "error-resolution", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "scripts error-resolution", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/error-resolution/<file>" })` — fetch any file's contents (sandboxed to src/)
