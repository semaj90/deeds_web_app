...
const steps = [
  ...
  },
  {
    ...
    args: [
      '--test',
      './test/feature-intelligence.test.mjs',
      './test/hypergraph-retrieval.test.mjs',
      './test/feature-matrix.test.mjs',
      './test/feature-signal-alignment.test.mjs',
      './test/aligned-snapshot-experiment.test.mjs',
      './test/ace-hypergraph-packet.test.mjs',
      './test/hypergraph-ppr.test.mjs',
      './test/compute-comparison.test.mjs',
      './test/algorithm-execution-manifest.test.mjs',
      './test/scaffold-contracts.test.mjs',
      './test/structural-extraction.test.mjs',
      './test/structural-vertical.integration.test.mjs',
      './test/sidecar-provenance-compat.test.mjs',
      './test/evidence-entity-extractors.test.mjs',
      './test/openspec-evidence-compiler.test.mjs',
      './test/openspec-repository-ingestion.test.mjs',
      './test/workflow-action-event.test.mjs',
      './test/workflow-action-adapters.test.mjs',
      './test/schema-object-registry.test.mjs',
      './test/postgres-schema-introspector.test.mjs',
      './test/test-case-registry.test.mjs',
      './test/vitest-test-evidence-compiler.test.mjs',
      './test/identity-continuity.test.mjs',
      './test/assertion-registry.test.mjs',
    ],
    cwd: resolve(repoRoot, 'packages/parent-atlas'),
  },
  {
