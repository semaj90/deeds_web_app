...
function buildManifest(map, retrieval) {
  ...
  return {
    ...
    requestId,
    snapshotId,
    graphRevision: retrieval.graphFeatureJoin?.graphRevision ?? null,
    graphFeaturesPresent: retrieval.graphFeatureJoin?.status === 'CURRENT_GRAPH_FEATURE_GATHER_PROVEN_BOUNDED',
    query,
