...
const joinSql = `
  ...
  SELECT
    ...
    c.summary::text AS legacy_summary_column,
    c.summary_text::text AS chunk_summary_text,
    c.summary_hash::text AS chunk_summary_hash,
    c.summary_model::text AS chunk_summary_model,
...
const projected = rows.map((row) => ({
  ...
  legacySummaryColumn: text(row.legacy_summary_column),
  chunkSummaryText: text(row.chunk_summary_text),
  chunkSummaryHash: text(row.chunk_summary_hash),
  chunkSummaryModel: text(row.chunk_summary_model),
