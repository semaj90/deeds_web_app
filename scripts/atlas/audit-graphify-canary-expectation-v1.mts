...
const checks = {
  ...
  sourceInventoryRevisionMatchesAdmission: expectation.sourceInventoryRevision === admission.sourceInventoryRevision,
  sourceInventoryChecksumMatchesAdmission: expectation.sourceInventoryChecksum === admission.sourceInventoryChecksum,
...
console.log(JSON.stringify({
  ...
  sourceInventoryRevision: expectation.sourceInventoryRevision ?? null,
  sourceInventoryChecksum: expectation.sourceInventoryChecksum ?? null,
