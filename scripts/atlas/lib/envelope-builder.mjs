...
export function buildCanonicalFeatureEnvelope(packet) {
  ...
  const envelope = {
    ...
    canonical_source_ref: normalized.canonical_source_ref || normalized.source_ref || null,
    source_path: normalized.source_path || null,
    file_path: normalized.file_path || normalized.source_path || null,
    directory_path: normalized.directory_path || null,
...
function normalizePacket(packet) {
  ...
  return {
    ...
    file_path: packet.file_path || payload.file_path || metadata.file_path,
    directory_path: packet.directory_path || payload.directory_path || metadata.directory_path,
