...
- `phase89-cache.mjs`
- `phase89-cuda-tags.mjs`
- `phase89-embed.mjs`
- `phase89-graph-visualizer.mjs`
- `phase89-rrf.mjs`
...
- `read_file({ filePath: "sveltekit-frontend/scripts/lib/<file>" })` — fetch any file's contents (sandboxed to src/)
