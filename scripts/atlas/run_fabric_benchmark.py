...
def main():
    ...
    parser.add_argument("--cluster-count", type=int, help="Frozen spectral K; required for promotion-grade parity")
    parser.add_argument("--num-eigen-vects", type=int, help="Diagnostic spectral eigenvector count")
    parser.add_argument("--evs-tolerance", type=float, default=1e-5, help="Diagnostic spectral eigensolver tolerance")
    parser.add_argument("--evs-max-iter", type=int, default=100, help="Diagnostic spectral eigensolver iteration limit")
    parser.add_argument("--kmean-tolerance", type=float, default=1e-5, help="Diagnostic spectral k-means tolerance")
    parser.add_argument("--kmean-max-iter", type=int, default=100, help="Diagnostic spectral k-means iteration limit")
