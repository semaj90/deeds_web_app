...
- ❌ ace-chat-01 (ace_chat) — exact_cache:ok, semantic_cache:ok, postgres_jsonb:ok, karpathy:fail
- ❌ ace-chat-02 (ace_chat) — postgres_jsonb:ok, rrf:ok, karpathy:fail
- ✅ ace-chat-03 (ace_chat) — exact_cache:ok, semantic_cache:ok
- ❌ ace-chat-04 (ace_chat) — semantic_cache:ok, karpathy:fail
...
- ❌ rag-03 (rag) — semantic_cache:ok, qdrant:ok, karpathy:fail
...
- ❌ cases-03 (cases) — bm25:ok, karpathy:fail, rrf:ok
- ✅ citations-01 (citations) — postgres_jsonb:ok, bm25:ok
- ❌ citations-02 (citations) — karpathy:fail, source_ref_quality:ok
- ✅ graph-01 (graph) — graph:ok, rrf:ok
- ❌ graph-02 (graph) — graph:ok, karpathy:fail, rrf:ok
- ❌ atlas-01 (atlas) — postgres_jsonb:ok, karpathy:fail
