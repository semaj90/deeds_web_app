...
Overall progress: [#######---] 6284/9511 tasks
Execution states: 2421 actionable; 753 waiting on dependencies; 51 superseded/historical; 2 invariants.
...
- **STEP-01** [#######---] 518/787 complete; 269 open — Identity and source authority; depends on none; gate: Exact identity, source, symbol, and revision ownership
- **STEP-02** [#######---] 1275/1809 complete; 534 open — Eligibility and provenance; depends on STEP-01; gate: Canonical eligibility, readback, and lineage proofs
...
- **STEP-04** [#######---] 1508/2166 complete; 658 open — Feature and structural context; depends on STEP-03; gate: AST/CST, LSP, ontology, feature fabric, and ContextManifest
...
- [ ] **P10** [parent-atlas-retrieval-lineage-dag-convergence](openspec/changes/parent-atlas-retrieval-lineage-dag-convergence/tasks.md#L1569) PROMOTION-01 — Keep source lineage, graph identity, feature layout, — lane RETRIEVAL_ACE; last updated 2026-09-24T22:20:47.803Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P20** [parent-atlas-onnx-webgpu-embedding-promotion](openspec/changes/parent-atlas-onnx-webgpu-embedding-promotion/tasks.md#L93) **10. Scale 15 → 128 → 768 row parity benchmark** before any eligibility/primary-lane — lane GENERAL; last updated 2026-09-24T21:21:23.730Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P20** [parent-atlas-okf-knowledge-layers](openspec/changes/parent-atlas-okf-knowledge-layers/tasks.md#L74) Validate existing `.okf/` files against OKF v0.2 (provenance, trust, lifecycle fields present and well-formed). — lane GENERAL; last updated 2026-09-24T21:19:04.029Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P30** [parent-atlas-agentic-completion](openspec/changes/parent-atlas-agentic-completion/tasks.md#L14) **AGENT-09 — Tournament reuse.** Complete the existing graph-retrieval-proof three-candidate seam; do not create a second tournament owner. — lane RETRIEVAL_ACE; last updated 2026-09-24T22:25:45.121Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [parent-atlas-graph-runtime-python-consolidation](openspec/changes/parent-atlas-graph-runtime-python-consolidation/) — **ADVANCEABLE**; 4 actionable, 0 waiting, 0 superseded/historical; raw progress [########--] 14/18
...
- [parent-atlas-nlp-sidecar-feature-compiler](openspec/changes/parent-atlas-nlp-sidecar-feature-compiler/) — **MIXED_ACTIONABLE_AND_WAITING**; 37 actionable, 20 waiting, 3 superseded/historical; raw progress [######----] 88/148
...
- [parent-atlas-okf-knowledge-layers](openspec/changes/parent-atlas-okf-knowledge-layers/) — **MIXED_ACTIONABLE_AND_WAITING**; 4 actionable, 1 waiting, 0 superseded/historical; raw progress [#########-] 36/41
...
- **GENERAL** 2034 open / 5660 total
- **RESEARCH_CHALLENGER_EWIN_TANG** 31 open / 38 total
- **RETRIEVAL_ACE** 1150 open / 3791 total
...
- [parent-atlas-graph-runtime-python-consolidation](openspec/changes/parent-atlas-graph-runtime-python-consolidation/) [########--] 14/18 complete; 4 open
...
- [parent-atlas-nlp-sidecar-feature-compiler](openspec/changes/parent-atlas-nlp-sidecar-feature-compiler/) [######----] 88/148 complete; 60 open
- [parent-atlas-observation-routing-fabric](openspec/changes/parent-atlas-observation-routing-fabric/) [######----] 16/26 complete; 10 open
- [parent-atlas-okf-knowledge-layers](openspec/changes/parent-atlas-okf-knowledge-layers/) [#########-] 36/41 complete; 5 open
