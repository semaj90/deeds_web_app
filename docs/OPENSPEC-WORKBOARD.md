...
Overall progress: [######----] 5814/9143 tasks
Execution states: 2536 actionable; 742 waiting on dependencies; 49 superseded/historical; 2 invariants.
Change states: 9 complete; 26 advanceable; 51 mixed actionable/waiting; 0 waiting/historical; 0 review required.
...
- **STEP-01** [######----] 434/672 complete; 238 open — Identity and source authority; depends on none; gate: Exact identity, source, symbol, and revision ownership
- **STEP-02** [#######---] 1167/1709 complete; 542 open — Eligibility and provenance; depends on STEP-01; gate: Canonical eligibility, readback, and lineage proofs
- **STEP-03** [######----] 740/1263 complete; 523 open — Runtime and retrieval; depends on STEP-02; gate: Embedding, Qdrant, Go Retrieval, and fusion execution
- **STEP-04** [#######---] 1413/2091 complete; 678 open — Feature and structural context; depends on STEP-03; gate: AST/CST, LSP, ontology, feature fabric, and ContextManifest
- **STEP-05** [#####-----] 155/319 complete; 164 open — Workflow and receipts; depends on STEP-04; gate: Agent execution, NATS/JetStream, validation, and receipts
- **STEP-06** [#####-----] 36/70 complete; 34 open — Governance and operations; depends on STEP-05; gate: Admin, Kanban, documents, supersession, and archive
- **STEP-07** [######----] 1844/2926 complete; 1082 open — Unclassified supporting work; depends on STEP-01; gate: Review and attach each task to an upstream gate
- **STEP-08** [###-------] 25/93 complete; 68 open — Benchmarks and challengers; depends on STEP-03, STEP-04; gate: Evaluation, GPU challengers, topology, and Ewin Tang
...
- manual-migration-reconciliation:339 — GENERAL; Review each SQL file against live schema, current source/revision (openspec/changes/manual-migration-reconciliation/tasks.md:339)
...
- parent-atlas-agentic-file-compiler:24 — GENERAL; AFC-10 Wire query classifier to the live request front door. (openspec/changes/parent-atlas-agentic-file-compiler/tasks.md:24)
- parent-atlas-agentic-file-compiler:29 — GENERAL; AFC-13 Persist WorkflowActionEventV1 through the existing action/outbox writer. (openspec/changes/parent-atlas-agentic-file-compiler/tasks.md:29)
- parent-atlas-agentic-file-compiler:32 — GENERAL; AFC-16 Wire bounded filesystem mutation behind authorization and human-approval policy. (openspec/changes/parent-atlas-agentic-file-compiler/tasks.md:32)
- parent-atlas-agentic-file-compiler:35 — GENERAL; AFC-19 Run CPU/GPU semantic executor parity and confirm one-vote-per-lane behavior. (openspec/changes/parent-atlas-agentic-file-compiler/tasks.md:35)
...
- parent-atlas-branch-merge-consolidation-aug20:127 — GENERAL; `domain-classifier.ts` (classifier/ variant only — indexing/ re-export already archived) (openspec/changes/parent-atlas-branch-merge-consolidation-aug20/tasks.md:127)
...
- **INVARIANT** [parent-atlas-neural-prefill-encoder](openspec/changes/parent-atlas-neural-prefill-encoder/tasks.md#L3728) No canonical identity or source data changes during dry-run/training. — last updated 2026-09-14T17:00:50.490Z (FILESYSTEM_MTIME); ETA N/A
- **INVARIANT** [parent-atlas-neural-prefill-encoder](openspec/changes/parent-atlas-neural-prefill-encoder/tasks.md#L3729) No projection occurs while model, identity, or parity gates fail. — last updated 2026-09-14T17:00:50.490Z (FILESYSTEM_MTIME); ETA N/A
...
- [ ] **P10** [parent-atlas-retrieval-lineage-dag-convergence](openspec/changes/parent-atlas-retrieval-lineage-dag-convergence/tasks.md#L1534) PROMOTION-01 — Keep source lineage, graph identity, feature layout, — lane RETRIEVAL_ACE; last updated 2026-09-18T19:56:17.466Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P10** [parent-atlas-prefill-routing-residency-convergence](openspec/changes/parent-atlas-prefill-routing-residency-convergence/tasks.md#L268) ANN-03 Require the same semantic_768 matrix and identity manifest across Qdrant/cuVS. — lane RETRIEVAL_ACE; last updated 2026-09-18T21:20:13.836Z (FILESYSTEM_MTIME); ETA UNKNOWN

## Parallel proof frontiers

- [ ] **P10** [parent-atlas-candidate-feature-execution-fabric](openspec/changes/parent-atlas-candidate-feature-execution-fabric/tasks.md#L211) FANOUT-01 Normalize all semantic results to CandidateOrdinal before feature fanout. — lane GENERAL; last updated 2026-09-18T19:27:07.825Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-retrieval-executor-compatibility-convergence](openspec/changes/parent-atlas-retrieval-executor-compatibility-convergence/tasks.md#L10) 2.2 Add a lexical PostgreSQL read-only replay test covering tsvector/GIN results, source-revision filters, and stable evidence metadata. — lane RETRIEVAL_ACE; last updated 2026-09-18T16:57:09.391Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [manual-migration-reconciliation](openspec/changes/manual-migration-reconciliation/tasks.md#L321) Resolve the packet writer's admitted source-revision input and prove — lane GENERAL; last updated 2026-09-18T02:26:41.742Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P10** [atlas-feature-intelligence](openspec/changes/atlas-feature-intelligence/tasks.md#L138) Canonical identity survives path/cluster/projection changes in live Postgres readback. — lane GENERAL; last updated 2026-09-15T20:00:05.385Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-ace-bitfrost-cache-correctness](openspec/changes/parent-atlas-ace-bitfrost-cache-correctness/tasks.md#L370) **CACHE-RETRIEVAL-IDENTITY-03** — Update all callers, including the MCP trace route and — lane RETRIEVAL_ACE; last updated 2026-09-15T19:32:39.758Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-ace-rlm-bitfrost-integration](openspec/changes/parent-atlas-ace-rlm-bitfrost-integration/tasks.md#L2893) Add a revision-qualified centroid manifest/pointer and pass identity before enabling — lane RETRIEVAL_ACE; last updated 2026-09-14T20:53:52.983Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-neural-prefill-encoder](openspec/changes/parent-atlas-neural-prefill-encoder/tasks.md#L527) **SOURCE-REVISION-CANARY-01 — Persist one approved Graphify canary.** — lane GENERAL; last updated 2026-09-14T17:00:50.490Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P10** [parent-atlas-semantic-768-canonical-contract](openspec/changes/parent-atlas-semantic-768-canonical-contract/tasks.md#L862) Reconcile one source/revision-qualified representation owner against the — lane GENERAL; last updated 2026-09-14T16:25:07.820Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-retrieval-fusion-reachability](openspec/changes/parent-atlas-retrieval-fusion-reachability/tasks.md#L1591) Add or expose the canonical identity envelope at the caller boundary, — lane RETRIEVAL_ACE; last updated 2026-09-14T02:09:17.775Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-retrieval-logic-convergence](openspec/changes/parent-atlas-retrieval-logic-convergence/tasks.md#L128) **RETRIEVAL-OWNERSHIP-01 — Enforce one canonical document identity.** — lane RETRIEVAL_ACE; last updated 2026-09-14T01:45:28.007Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-transport-memory-boundaries](openspec/changes/parent-atlas-transport-memory-boundaries/tasks.md#L10) **ACP-02** Map ACP session/task/action identifiers to existing `runId`, `taskId`, `ContextManifest` hash, and `ExecutionReceipt`; ACP must not own graph identity. — lane RETRIEVAL_ACE; last updated 2026-09-14T01:44:50.721Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-topology-representation-admission](openspec/changes/parent-atlas-topology-representation-admission/tasks.md#L44) TOPO-02A Replace the latent writer's fallback identity/update path with — lane RETRIEVAL_ACE; last updated 2026-09-14T01:44:50.719Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P10** [parent-atlas-gpu-graph-vector-substrate](openspec/changes/parent-atlas-gpu-graph-vector-substrate/tasks.md#L47) 2.1 Canonical identity — confirm/fix the single identity join every retrieval — lane RETRIEVAL_ACE; last updated 2026-09-14T01:40:57.986Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P10** [parent-atlas-gpu-sidecar-patch-tournament](openspec/changes/parent-atlas-gpu-sidecar-patch-tournament/tasks.md#L199) CAGRA endpoint (`POST /v1/knn/cagra`) with the same bounded identity manifest — tiny-fixture runtime and exact-oracle Recall@3 are proven, but production remains **quarantined** because larger-corpus recall, filter parity, revision swaps, fallback, and promotion approval are open. `RAPIDS_CAGRA_ENDPOINT: RUNTIME_PROVEN_ON_TINY_FIXTURE; PRODUCTION_QUARANTINED`. — lane GENERAL; last updated 2026-09-09T23:37:32.371Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P20** [parent-atlas-rrf-fusion-consolidation](openspec/changes/parent-atlas-rrf-fusion-consolidation/tasks.md#L112) 3.1 For each non-`CANONICAL_OWNER` primitive: migrate its callers, formally designate it a — lane GENERAL; last updated 2026-09-18T01:43:09.093Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P20** [parent-atlas-workstation-domain-classifier](openspec/changes/parent-atlas-workstation-domain-classifier/tasks.md#L325) Revision-qualified HyperRAG cache admission and live MCP/API readback — lane GENERAL; last updated 2026-09-18T01:27:26.702Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P20** [parent-atlas-agentic-repair-fabric](openspec/changes/parent-atlas-agentic-repair-fabric/tasks.md#L37) 4.1 `AgenticHyperEdgeV1` needs a nullable `canonicalId` + `resolutionState` per member, — lane GENERAL; last updated 2026-09-16T00:39:54.259Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P20** [parent-atlas-nlp-sidecar-feature-compiler](openspec/changes/parent-atlas-nlp-sidecar-feature-compiler/tasks.md#L122) 0.4 Read `openspec/changes/parent-atlas-semantic-768-canonical-contract/` — lane GENERAL; last updated 2026-09-14T01:44:50.701Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P20** [parent-atlas-graphify-recovery-proof-ladder](openspec/changes/parent-atlas-graphify-recovery-proof-ladder/tasks.md#L527) Confirm `graph-projection-manifest.ts` remains the canonical place for — lane RETRIEVAL_ACE; last updated 2026-09-14T01:44:50.687Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P20** [local-llm-offload-ownership](openspec/changes/local-llm-offload-ownership/tasks.md#L260) Old-alias vs canonical-name **output** parity is guaranteed by shared implementation — lane GENERAL; last updated 2026-09-14T01:40:57.973Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P20** [parent-atlas-okf-knowledge-layers](openspec/changes/parent-atlas-okf-knowledge-layers/tasks.md#L74) Validate existing `.okf/` files against OKF v0.2 (provenance, trust, lifecycle fields present and well-formed). — lane GENERAL; last updated 2026-09-07T19:44:57.035Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [ ] **P20** [parent-atlas-opencode-replay-proof](openspec/changes/parent-atlas-opencode-replay-proof/tasks.md#L49) Record the current canonical row count for Phase 3 as the acceptance baseline. — lane GENERAL; last updated 2026-09-01T02:40:10.220Z (FILESYSTEM_MTIME); ETA UNKNOWN
- [ ] **P20** [parent-atlas-agentic-repair-bundle-integration](openspec/changes/parent-atlas-agentic-repair-bundle-integration/tasks.md#L103) Confirm (not assume) `parent-atlas-semantic-768-canonical-contract`'s outstanding drift item — lane GENERAL; last updated 2026-08-09T04:46:16.571Z (FILESYSTEM_MTIME); ETA UNKNOWN
...
- [atlas-feature-intelligence](openspec/changes/atlas-feature-intelligence/) — **MIXED_ACTIONABLE_AND_WAITING**; 39 actionable, 15 waiting, 1 superseded/historical; raw progress [###-------] 24/79
...
- [codereview-semantic-dimension-regression-aug22](openspec/changes/codereview-semantic-dimension-regression-aug22/) — **ADVANCEABLE**; 1 actionable, 0 waiting, 0 superseded/historical; raw progress [#########-] 11/12
...
- [local-llm-offload-ownership](openspec/changes/local-llm-offload-ownership/) — **ADVANCEABLE**; 6 actionable, 0 waiting, 0 superseded/historical; raw progress [#########-] 37/43
- [manual-migration-reconciliation](openspec/changes/manual-migration-reconciliation/) — **MIXED_ACTIONABLE_AND_WAITING**; 25 actionable, 5 waiting, 0 superseded/historical; raw progress [#######---] 59/89
- [parent-atlas-ace-bitfrost-cache-correctness](openspec/changes/parent-atlas-ace-bitfrost-cache-correctness/) — **MIXED_ACTIONABLE_AND_WAITING**; 27 actionable, 5 waiting, 0 superseded/historical; raw progress [######----] 56/88
- [parent-atlas-ace-rlm-bitfrost-integration](openspec/changes/parent-atlas-ace-rlm-bitfrost-integration/) — **MIXED_ACTIONABLE_AND_WAITING**; 118 actionable, 88 waiting, 4 superseded/historical; raw progress [########--] 698/908
...
- [parent-atlas-agentic-file-compiler](openspec/changes/parent-atlas-agentic-file-compiler/) — **MIXED_ACTIONABLE_AND_WAITING**; 10 actionable, 2 waiting, 0 superseded/historical; raw progress [######----] 22/34
- [parent-atlas-agentic-repair-bundle-integration](openspec/changes/parent-atlas-agentic-repair-bundle-integration/) — **MIXED_ACTIONABLE_AND_WAITING**; 52 actionable, 13 waiting, 1 superseded/historical; raw progress [##--------] 18/84
- [parent-atlas-agentic-repair-fabric](openspec/changes/parent-atlas-agentic-repair-fabric/) — **ADVANCEABLE**; 3 actionable, 0 waiting, 0 superseded/historical; raw progress [#########-] 17/20
- [parent-atlas-agentic-run-receipt-binding](openspec/changes/parent-atlas-agentic-run-receipt-binding/) — **MIXED_ACTIONABLE_AND_WAITING**; 12 actionable, 1 waiting, 0 superseded/historical; raw progress [##--------] 3/16
...
- [parent-atlas-candidate-feature-execution-fabric](openspec/changes/parent-atlas-candidate-feature-execution-fabric/) — **MIXED_ACTIONABLE_AND_WAITING**; 61 actionable, 31 waiting, 1 superseded/historical; raw progress [#######---] 228/321
- [parent-atlas-canonical-directory-ingestion-fabric](openspec/changes/parent-atlas-canonical-directory-ingestion-fabric/) — **ADVANCEABLE**; 49 actionable, 0 waiting, 1 superseded/historical; raw progress [###-------] 17/67
...
- [parent-atlas-gpu-graph-vector-substrate](openspec/changes/parent-atlas-gpu-graph-vector-substrate/) — **MIXED_ACTIONABLE_AND_WAITING**; 23 actionable, 1 waiting, 0 superseded/historical; raw progress [#---------] 2/26
...
- [parent-atlas-gpu-sidecar-patch-tournament](openspec/changes/parent-atlas-gpu-sidecar-patch-tournament/) — **MIXED_ACTIONABLE_AND_WAITING**; 43 actionable, 6 waiting, 2 superseded/historical; raw progress [###-------] 17/68
...
- [parent-atlas-graphify-recovery-proof-ladder](openspec/changes/parent-atlas-graphify-recovery-proof-ladder/) — **MIXED_ACTIONABLE_AND_WAITING**; 7 actionable, 2 waiting, 0 superseded/historical; raw progress [----------] 0/9
...
- [parent-atlas-native-acceleration-cabi](openspec/changes/parent-atlas-native-acceleration-cabi/) — **ADVANCEABLE**; 48 actionable, 0 waiting, 0 superseded/historical; raw progress [##--------] 14/62
...
- [parent-atlas-nlp-sidecar-feature-compiler](openspec/changes/parent-atlas-nlp-sidecar-feature-compiler/) — **MIXED_ACTIONABLE_AND_WAITING**; 33 actionable, 8 waiting, 0 superseded/historical; raw progress [######----] 51/92
...
- [parent-atlas-okf-knowledge-layers](openspec/changes/parent-atlas-okf-knowledge-layers/) — **MIXED_ACTIONABLE_AND_WAITING**; 15 actionable, 1 waiting, 0 superseded/historical; raw progress [######----] 25/41
...
- [parent-atlas-pca-svd-representation-baseline](openspec/changes/parent-atlas-pca-svd-representation-baseline/) — **MIXED_ACTIONABLE_AND_WAITING**; 1 actionable, 1 waiting, 0 superseded/historical; raw progress [########--] 7/9
...
- [parent-atlas-prefill-routing-residency-convergence](openspec/changes/parent-atlas-prefill-routing-residency-convergence/) — **MIXED_ACTIONABLE_AND_WAITING**; 82 actionable, 15 waiting, 0 superseded/historical; raw progress [####------] 55/152
...
- [parent-atlas-retrieval-executor-compatibility-convergence](openspec/changes/parent-atlas-retrieval-executor-compatibility-convergence/) — **ADVANCEABLE**; 8 actionable, 0 waiting, 0 superseded/historical; raw progress [########--] 38/46
- [parent-atlas-retrieval-fusion-reachability](openspec/changes/parent-atlas-retrieval-fusion-reachability/) — **MIXED_ACTIONABLE_AND_WAITING**; 10 actionable, 14 waiting, 0 superseded/historical; raw progress [########--] 119/143
- [parent-atlas-retrieval-lineage-dag-convergence](openspec/changes/parent-atlas-retrieval-lineage-dag-convergence/) — **MIXED_ACTIONABLE_AND_WAITING**; 100 actionable, 120 waiting, 5 superseded/historical; raw progress [########--] 701/926
...
- [parent-atlas-retrieval-logic-convergence](openspec/changes/parent-atlas-retrieval-logic-convergence/) — **ADVANCEABLE**; 43 actionable, 0 waiting, 1 superseded/historical; raw progress [##--------] 8/52
...
- [parent-atlas-semantic-768-canonical-contract](openspec/changes/parent-atlas-semantic-768-canonical-contract/) — **MIXED_ACTIONABLE_AND_WAITING**; 4 actionable, 17 waiting, 0 superseded/historical; raw progress [#######---] 43/64
...
- [parent-atlas-topology-representation-admission](openspec/changes/parent-atlas-topology-representation-admission/) — **ADVANCEABLE**; 18 actionable, 0 waiting, 0 superseded/historical; raw progress [###-------] 6/24
- [parent-atlas-transport-memory-boundaries](openspec/changes/parent-atlas-transport-memory-boundaries/) — **MIXED_ACTIONABLE_AND_WAITING**; 57 actionable, 6 waiting, 2 superseded/historical; raw progress [###-------] 23/88
...
- [parent-atlas-workstation-domain-classifier](openspec/changes/parent-atlas-workstation-domain-classifier/) — **MIXED_ACTIONABLE_AND_WAITING**; 14 actionable, 12 waiting, 0 superseded/historical; raw progress [########--] 113/139
...
- [route-import-infra-isolation](openspec/changes/route-import-infra-isolation/) — **ADVANCEABLE**; 2 actionable, 0 waiting, 0 superseded/historical; raw progress [#########-] 14/16

## Task indexing coverage

- Declared source_ref: 2/9143
- Declared source_revision: 3/9143
- Task ledger source pointer: 9143/9143 (OpenSpec file + line)
- Metadata-unclassified rows: 9138/9143; no source identity was inferred.
...
- **GENERAL** 2162 open / 5488 total
- **RESEARCH_CHALLENGER_EWIN_TANG** 30 open / 35 total
- **RETRIEVAL_ACE** 1125 open / 3598 total
...
- Snapshot age: 76.1 days; tasks: 123; sourceRefs: 246
...
- **HISTORICAL_TASK_RANKING_REFERENCE** HISTORICAL_OR_STALE: memory/exports/kanban-ranking-report.json; task/board records 858; age 99.7 days
...
- [atlas-feature-intelligence](openspec/changes/atlas-feature-intelligence/) [###-------] 24/79 complete; 55 open
...
- [manual-migration-reconciliation](openspec/changes/manual-migration-reconciliation/) [#######---] 59/89 complete; 30 open
- [parent-atlas-ace-bitfrost-cache-correctness](openspec/changes/parent-atlas-ace-bitfrost-cache-correctness/) [######----] 56/88 complete; 32 open
- [parent-atlas-ace-rlm-bitfrost-integration](openspec/changes/parent-atlas-ace-rlm-bitfrost-integration/) [########--] 698/908 complete; 210 open
- [parent-atlas-adaptive-dag-fabric](openspec/changes/parent-atlas-adaptive-dag-fabric/) [#####-----] 7/13 complete; 6 open
- [parent-atlas-agentic-file-compiler](openspec/changes/parent-atlas-agentic-file-compiler/) [######----] 22/34 complete; 12 open
...
- [parent-atlas-agentic-repair-fabric](openspec/changes/parent-atlas-agentic-repair-fabric/) [#########-] 17/20 complete; 3 open
...
- [parent-atlas-candidate-feature-execution-fabric](openspec/changes/parent-atlas-candidate-feature-execution-fabric/) [#######---] 228/321 complete; 93 open
...
- [parent-atlas-gpu-sidecar-patch-tournament](openspec/changes/parent-atlas-gpu-sidecar-patch-tournament/) [###-------] 17/68 complete; 51 open
...
- [parent-atlas-nlp-sidecar-feature-compiler](openspec/changes/parent-atlas-nlp-sidecar-feature-compiler/) [######----] 51/92 complete; 41 open
- [parent-atlas-observation-routing-fabric](openspec/changes/parent-atlas-observation-routing-fabric/) [######----] 16/26 complete; 10 open
- [parent-atlas-okf-knowledge-layers](openspec/changes/parent-atlas-okf-knowledge-layers/) [######----] 25/41 complete; 16 open
...
- [parent-atlas-pca-svd-representation-baseline](openspec/changes/parent-atlas-pca-svd-representation-baseline/) [########--] 7/9 complete; 2 open
- [parent-atlas-policy-routing-integration](openspec/changes/parent-atlas-policy-routing-integration/) [######----] 25/40 complete; 15 open
- [parent-atlas-prefill-routing-residency-convergence](openspec/changes/parent-atlas-prefill-routing-residency-convergence/) [####------] 55/152 complete; 97 open
...
- [parent-atlas-retrieval-executor-compatibility-convergence](openspec/changes/parent-atlas-retrieval-executor-compatibility-convergence/) [########--] 38/46 complete; 8 open
- [parent-atlas-retrieval-fusion-reachability](openspec/changes/parent-atlas-retrieval-fusion-reachability/) [########--] 119/143 complete; 24 open
- [parent-atlas-retrieval-lineage-dag-convergence](openspec/changes/parent-atlas-retrieval-lineage-dag-convergence/) [########--] 701/926 complete; 225 open
...
- [parent-atlas-retrieval-logic-convergence](openspec/changes/parent-atlas-retrieval-logic-convergence/) [##--------] 8/52 complete; 44 open
...
- [parent-atlas-semantic-768-canonical-contract](openspec/changes/parent-atlas-semantic-768-canonical-contract/) [#######---] 43/64 complete; 21 open
...
- [parent-atlas-transport-memory-boundaries](openspec/changes/parent-atlas-transport-memory-boundaries/) [###-------] 23/88 complete; 65 open
...
- [parent-atlas-workstation-domain-classifier](openspec/changes/parent-atlas-workstation-domain-classifier/) [########--] 113/139 complete; 26 open
