# Latent Representation Identity Audit — 2026-08-23

**Read-only. Zero production mutations.** Repository commit: `86447310172e7433a5c9fb9aaf353bc8ed132b82`. Database: `127.0.0.1:5434`.
...
- `MISSING_SOURCE_REVISION`: 37
- `MISSING_PACKET_KEY`: 213
...
## Vector-store inventory (62 columns db-wide)
