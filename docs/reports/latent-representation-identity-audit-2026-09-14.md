# Latent Representation Identity Audit — 2026-09-14

**Read-only. Zero production mutations.** Repository commit: `cb122d7415a9a3ed570b759495888bf0a8c71413`. Database: `127.0.0.1:5434`.
...
## Vector-store inventory (71 columns db-wide)
...
| atlas_external_doc_chunks | content_embedding | vector | UNKNOWN |
...
| atlas_packets | embedding | vector | SECONDARY_768_SURFACE_UNRESOLVED |
...
| codebase_chunk_index | content_embedding | halfvec | ACTIVE_CANONICAL_CANDIDATE |
| codebase_chunk_index | content_embedding_768 | vector | LEGACY_OR_TRANSITIONAL |
| codebase_chunk_index | error_embedding | halfvec | UNKNOWN |
| codebase_chunk_index | error_embedding_latent_128 | halfvec | UNKNOWN |
| codebase_chunk_index | error_embedding_latent_256 | halfvec | UNKNOWN |
| codebase_chunk_index | error_embedding_latent_64 | vector | UNKNOWN |
| codebase_chunk_index | latent_128 | halfvec | UNKNOWN |
