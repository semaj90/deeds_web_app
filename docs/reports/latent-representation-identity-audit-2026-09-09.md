# Latent Representation Identity Audit — 2026-09-09

**Read-only. Zero production mutations.** Repository commit: `f88c49bcdbaef3b8058761411c8a519e47984b29`. Database: `127.0.0.1:5434`.
...
## Vector-store inventory (67 columns db-wide)
