# Latent Representation Identity Audit — 2026-08-03

**Read-only. Zero production mutations.** Repository commit: `691154f1b49b332f8b0507e5300fef19197c1457`. Database: `127.0.0.1:5434`.
...
- `missing_qdrant_point_id_count`: 656
...
- `tree_node_joined_count`: 339
- `tree_node_missing_count`: 0
- `tree_node_fanout_count`: 0
- `tree_node_id_format_mismatch_count`: 661
...
- `producer_revision`: ABSENT
- `input_digest`: ABSENT

## Vector-store inventory (61 columns db-wide)
...
| codebase_chunk_index | content_embedding_384 | vector | UNKNOWN |
