...
Generated: 2026-08-27T04:59:19.453Z
...
- postgres
  ...
  - evidence: parent_atlas_documents:READY:61660 | route_runtime_packets:READY:7 | codebase_chunk_index:READY:55206 | atlas_feature_map_synthesized:DATA_ABSENT:0 | atlas_feature_synthesis:DATA_ABSENT:0
...
- duckdb
  - status: READY
  - evidence: tables=domain_training_rows, snapshot_packets, test_packets | views=none | tables=atlas_feature_map, mapreduce_consolidated_index, mapreduce_consolidated_index_meta | views=none | tables=hidden_packet_pathmap, hidden_packet_pathmap_summary | views=none | tables=agg_facts, agg_rewards, agg_source_refs, agg_tokens, edges, facts, packets, raw_edges, raw_facts, raw_packets, raw_rewards, raw_token_map | views=none | tables=cards_raw, outcomes_raw, training_examples | views=atlas_cards_enriched, cluster_summary, parent_atlas_index
  - actual field names: content, content_embedding_768, content_hash, domain, embedding_digest, embedding_dim, id, kmeans_cluster, label, legacy_domain, lexical_identifiers, lexical_imported_modules, lexical_keywords, lexical_symbols, normalized_domain, normalized_domain_confidence, packet_key, page_rank_score, qdrant_point_id, qdrant_vector_dim, relative_path, representation_id, representation_revision, som_cluster, source_group, source_ref, split_name, structural_calls, structural_exports, structural_imports, structural_path, structural_symbol_kind, structural_symbol_name, summary, summary_hash, text, used_concepts, atlas_version, centroid_id, cluster_id, colocatedFiles, contentHash, directory, dynamicImports, dynamic_imports, extension, extensions, feature, feature_id, features, fileName, filePath, importErrorCount, indexed_at, keywords, lane_ids, lastScanned, lines, metadata, neo4j_node_id, nes_card_id, normalized_path, related_feature_ids, resolvedDynamicImports, resolvedStaticImports, rows, semanticMarkers, size, source_id, stableKey, staticImports, static_imports, bucket, bucket_rows, description, duckdb_rows, feature_ids, feature_key, file, joined_rows, line_number, packet_kind, path, pathmap_root, section, source, source_ref_joins, source_refs, stable_id, stable_id_joins, status, task_id, title, todo_source_ref_rows, answer_hint, cache_hit, cache_tier, captured_at, confidence, created_at, dst, edge_type, fact_key, fact_type, fact_value, latency_ms, packet_id, packet_uuid, prompt_hash, qdrant_hits, query_hash, redis_hot_keys, reward, reward_samples, route, route_state, score, scored_at, source_ref_count, src, token_hint, token_hints, weight, cardId, enrichment_phase, input, instruction, kind, output, reward_avg, reward_count, reward_total, som_bmu_col, som_bmu_distance, som_bmu_row, som_cluster_col, som_cluster_row, sourceRef, vector64_compressed, semantic_embedding_768, title_id, atlas_id, avg_reward, card_count, card_id, cards_with_rewards, cluster_avg_reward, cluster_size, column0, degree, from_node_id, import_errors, lane, node_count, node_id, out_degree, payload_json, som_col, som_index, som_row, to_node_id, total_degree, total_outcomes, unique_sources, afm_indexed_at, alias_id, atlas_file_count, attention_score, avg_confidence, behavior_score, cluster_ids, cold_storage_ready, dominant_status, drizzle_refs, exports, feature_avg_confidence, feature_behavior_score, feature_dominant_status, feature_primary_cluster, file_ext, file_path, has_auth, has_blocked, has_centroid, has_vector, has_zod, imports, ingest_source, is_route, is_svelte_comp, karpathy_blend, line_count, max_confidence, next_actions, packet_count, pad_centroid_count, pad_file_count, pad_qdrant_count, pagerank_score, primary_centroid_id, primary_cluster_id, qdrant_point_count, rel_path, route_handlers, runtime_hot_path_score, semantic_confidence, source_kind, synthesized_at, synthesized_summary, tags, top_file_paths, updated_at, workspace_id, labels, payload, score_authority, score_rank, score_recency, sourceRefs, term_type, term_value
  - expected aliases present: source_ref, feature_id, sourceRef
  - expected aliases missing: featureId, feature_id, sourceRef, source_ref
- couchdb
  - status: DATA_ABSENT
  - evidence: none
  - actual field names: none
