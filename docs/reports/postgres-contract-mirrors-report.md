...
Generated: 2026-06-12T19:38:38.737Z
...
- manual sources: sveltekit-frontend/drizzle/manual/20260611_atlas_packets_schema.sql
- static columns: artifact_id, byte_end, byte_start, cluster_id, community_id, concept_ids, created_at, embedding, feature_id, packet_id, packet_key, payload, reward_prior, sha256, source_kind, source_path, source_ref, summary, updated_at
- static indexes: atlas_packets_feature_idx, atlas_packets_payload_gin, idx_atlas_packets_packet_key, idx_atlas_packets_source_kind, idx_atlas_packets_source_ref
- live columns: packet_id, artifact_id, source_ref, feature_id, community_id, concept_ids, cluster_id, embedding, payload, summary, byte_start, byte_end, sha256, created_at, packet_key, source_kind, reward_prior, source_path, updated_at, source_ref_key, community_source, community_confidence
- live indexes: atlas_packets_feature_idx, atlas_packets_payload_gin, atlas_packets_pkey, idx_atlas_packets_community_id, idx_atlas_packets_concept_ids, idx_atlas_packets_feature_id, idx_atlas_packets_packet_key, idx_atlas_packets_source_kind, idx_atlas_packets_source_ref, idx_atlas_packets_source_ref_key, idx_atlas_packets_summary_fts
- live rows: 17020
...
- static indexes: idx_nes_chrom_packets_feature_ids_gin, idx_nes_chrom_packets_lane_ids_gin, idx_nes_chrom_packets_som_cluster, nes_chrom_packets_chunk_id_idx, nes_chrom_packets_embedding_hnsw, nes_chrom_packets_feature_code_idx, nes_chrom_packets_feature_id_idx, nes_chrom_packets_kag_run_idx, nes_chrom_packets_packet_key_key, nes_chrom_packets_payload_gin, nes_chrom_packets_qdrant_point_idx, nes_chrom_packets_query_hash_idx, nes_chrom_packets_som_code_idx, nes_chrom_packets_source_ref_id_idx, nes_chrom_packets_source_ref_idx, nes_chrom_packets_source_refs_gin
...
- classification: INDEX_MISMATCH
- repair_class: IGNORE_IMPLICIT_INDEX
- static: SQL_AND_DRIZZLE_ALIGNED
- live: INDEX_MISMATCH
- schema sources: sveltekit-frontend/src/lib/server/db/schema/nes-chrom-packets.ts
...
- static columns: cache_hit, cache_tier, captured_at, cluster_id, feature_id, feature_ids, id, lane_ids, latency_ms, qdrant_hits, query_hash, query_preview, raw, redis_hot_keys, response_tokens, route, route_state, session_id, som_cluster, source_refs, user_id
- static indexes: idx_rrp_captured_at, idx_rrp_cluster_id, idx_rrp_feature_ids_gin, idx_rrp_route, idx_rrp_source_refs_gin, rrp_feature_idx, rrp_packet_uuid_uidx, rrp_raw_gin, rrp_state_idx
...
- nes_chrom_packets: live INDEX_MISMATCH
- nes_chrom_kag_dag_hits: live INDEX_MISMATCH
- parent_atlas_documents: live INDEX_MISMATCH
- route_runtime_packets: static COLUMN_MISMATCH
