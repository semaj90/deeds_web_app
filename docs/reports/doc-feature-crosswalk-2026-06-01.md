...
Generated: 2026-06-02T02:29:34.187Z
...
- Parent atlas entries: 9374
- Entries with sourceRefs: 0
- Discovered doc/report files: 5132
...
- Sample docs:
  ...
  - `.tmp/parent_atlas_packets/001570455730d2d7.json`
  - `.tmp/parent_atlas_packets/001f2d08e4459234.json`
  - `.tmp/parent_atlas_packets/0024f386d46d7f23.json`
...
- Sample docs:
  ...
  - `.tmp/parent_atlas_packets/sourceRef-first/parent_atlas_sourceRef_first_cluster_19067cadf0_fb3aec99cf9cad58.json`
  - `.tmp/phase19c_qdrant/atlas-reward-attribution.json`
  - `.tmp/qdrant-index-report.json`
...
- Sample docs:
  ...
  - `.tmp/phase19b-cache-config-join-debug.md`
...
- Sample docs:
  ...
  - `.tmp/parent_atlas_packets/00e5d971c47c8ae9.json`
  - `.tmp/parent_atlas_packets/01319072d7ae35fa66f718d3588536753e17465995467e266798d453b7b075c8.json`
...
- Sample docs:
  ...
  - `.tmp/mapreduce-full.ndjson.manifest.json`
  - `.tmp/mapreduce-test.ndjson.manifest.json`
