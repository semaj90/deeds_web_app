...
# Python 3.13's dataclasses resolves ClassVar/KW_ONLY via sys.modules[cls.__module__];
# the module must be registered before exec_module() or frozen dataclasses in the
# target module raise AttributeError: 'NoneType' object has no attribute '__dict__'.
