...
Separate process from atlas_rapids_sidecar.py so existing exact-KNN/CAGRA proof
status is not silently expanded. This service exposes only non-mutating
community challenger endpoints over explicit undirected weighted projections.
