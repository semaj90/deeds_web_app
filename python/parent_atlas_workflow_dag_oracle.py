...
def evaluate(plan: dict[str, Any]) -> dict[str, Any]:
    ...
    # Retry lineage is observable provenance, not a backward edge. We only
    # report attempts here; DAG legality is still decided by graph topology.
