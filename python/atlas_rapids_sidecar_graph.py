...
installs revision-qualified graph/PageRank, bounded outbound cuGraph BFS,
semantic_512 exact-KNN, and latent_64 KMeans routing on the same FastAPI
application. Run this entrypoint on port 8098 when enabling Parent Atlas GPU
acceleration.
"""
...
from atlas_rapids_graph_traversal_runtime import install_graph_traversal_routes
...
install_graph_traversal_routes(app, _GRAPH_RUNTIME)
