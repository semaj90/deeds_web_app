# AGENTS.md — `simd-bridge/rust/graph-engine/target`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: simd-bridge/rust/graph-engine/target
...
- `graph_search({ query: "target", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "graph-engine target", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "simd-bridge/rust/graph-engine/target/<file>" })` — fetch any file's contents (sandboxed to src/)
