...
- `graph_search({ query: "cpp", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "simd-bridge cpp", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "simd-bridge/cpp/<file>" })` — fetch any file's contents (sandboxed to src/)
