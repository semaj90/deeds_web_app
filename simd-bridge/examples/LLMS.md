...
- `wiki_note_lookup({ query: "simd-bridge examples", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "simd-bridge/examples/<file>" })` — fetch any file's contents (sandboxed to src/)
