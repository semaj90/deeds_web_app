...
- `graph_search({ query: ".vscode", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "sveltekit-frontend .vscode", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/.vscode/<file>" })` — fetch any file's contents (sandboxed to src/)
