...
- Tags: `tests` `e2e` `route-forensic` `auth` `test`

## Files (3)

- `tests/e2e/route-forensic/fixtures/authed-page.ts`
- `tests/e2e/route-forensic/fixtures/db.ts`
- `tests/e2e/route-forensic/fixtures/forensic-page.ts`
...
- `graph_search({ query: "fixtures", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "route-forensic fixtures", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "tests/e2e/route-forensic/fixtures/<file>" })` — fetch any file's contents (sandboxed to src/)
