...
> Directory audit: tests/fixtures
...
- Tags: `tests` `fixtures` `demo-auth.ts` `auth` `test` `test-cases.ts`
...
- `read_file({ filePath: "tests/fixtures/<file>" })` — fetch any file's contents (sandboxed to src/)
