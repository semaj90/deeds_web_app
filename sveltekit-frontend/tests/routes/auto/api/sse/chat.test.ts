...
describe('src/routes/api/sse/chat/+server.ts', () => {
  describe('POST /api/sse/chat', () => {
    ...
    function makeUrl() { return new URL('http://localhost/api/sse/chat'); }
