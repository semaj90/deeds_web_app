...
describe('src/routes/api/sse/[id]/+server.ts', () => {
  describe('GET /api/sse/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/sse/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/sse/:id'); }
