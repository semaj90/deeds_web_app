 ...
 *
 * Run:  npm run test -- api/simulation/__sessionId
 */
...
describe('src/routes/api/simulation/[sessionId]/+server.ts', () => {
  describe('GET /api/simulation/:sessionId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/simulation/:sessionId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/simulation/:sessionId'); }
  ...
  describe('POST /api/simulation/:sessionId', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/simulation/:sessionId', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/simulation/:sessionId'); }
  ...
  describe('DELETE /api/simulation/:sessionId', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/simulation/:sessionId', body !== undefined ? { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/simulation/:sessionId'); }
