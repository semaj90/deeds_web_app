 ...
 *
 * Run:  npm run test -- api/audio/progress/__evidenceId
 */
...
describe('src/routes/api/audio/progress/[evidenceId]/+server.ts', () => {
  describe('GET /api/audio/progress/:evidenceId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/audio/progress/:evidenceId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/audio/progress/:evidenceId'); }
