 ...
 *
 * Run:  npm run test -- api/stream/__chatId
 */
...
describe('src/routes/api/stream/[chatId]/+server.ts', () => {
  describe('GET /api/stream/:chatId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/stream/:chatId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/stream/:chatId'); }
