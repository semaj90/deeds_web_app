 ...
 *
 * Run:  npm run test -- api/citations/collections/__collectionId
 */
...
describe('src/routes/api/citations/collections/[collectionId]/+server.ts', () => {
  describe('GET /api/citations/collections/:collectionId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/citations/collections/:collectionId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/citations/collections/:collectionId'); }
  ...
  describe('DELETE /api/citations/collections/:collectionId', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/citations/collections/:collectionId', body !== undefined ? { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/citations/collections/:collectionId'); }
  ...
  describe('PATCH /api/citations/collections/:collectionId', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/citations/collections/:collectionId', body !== undefined ? { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/citations/collections/:collectionId'); }
