 ...
 *
 * Run:  npm run test -- api/recommendations/jobs/__jobId
 */
...
describe('src/routes/api/recommendations/jobs/[jobId]/+server.ts', () => {
  describe('GET /api/recommendations/jobs/:jobId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/recommendations/jobs/:jobId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/recommendations/jobs/:jobId'); }
