 ...
 *
 * Run:  npm run test -- api/analytics/research-summaries/__id
 */
...
describe('src/routes/api/analytics/research-summaries/[id]/+server.ts', () => {
  describe('GET /api/analytics/research-summaries/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/analytics/research-summaries/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/analytics/research-summaries/:id'); }
  ...
  describe('DELETE /api/analytics/research-summaries/:id', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/analytics/research-summaries/:id', body !== undefined ? { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/analytics/research-summaries/:id'); }
