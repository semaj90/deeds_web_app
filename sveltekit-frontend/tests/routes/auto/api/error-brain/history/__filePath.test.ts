 ...
 *
 * Run:  npm run test -- api/error-brain/history/__filePath
 */
...
describe('src/routes/api/error-brain/history/[filePath]/+server.ts', () => {
  describe('GET /api/error-brain/history/:filePath', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/error-brain/history/:filePath', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/error-brain/history/:filePath'); }
