 ...
 *
 * Route: src/routes/api/error-brain/diagnosis-history/+server.ts
 ...
 *
 * Run:  npm run test -- api/error-brain/diagnosis-history
 */
...
describe('src/routes/api/error-brain/diagnosis-history/+server.ts', () => {
  describe('GET /api/error-brain/diagnosis-history', () => {
    ...
    beforeEach(async () => {
      vi.resetAllMocks();
      const mod = await import('../../../../../src/routes/api/error-brain/diagnosis-history/+server.js') as Record<string, unknown>;
      handler = mod.GET as typeof handler;
    });

    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/error-brain/diagnosis-history', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/error-brain/diagnosis-history'); }
  ...
  describe('POST /api/error-brain/diagnosis-history', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/error-brain/diagnosis-history', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/error-brain/diagnosis-history'); }
  ...
  describe('PATCH /api/error-brain/diagnosis-history', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/error-brain/diagnosis-history', body !== undefined ? { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/error-brain/diagnosis-history'); }
  ...
  describe('DELETE /api/error-brain/diagnosis-history', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/error-brain/diagnosis-history', body !== undefined ? { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/error-brain/diagnosis-history'); }
