 ...
 *
 * Run:  npm run test -- api/reports/preview/__id
 */
...
describe('src/routes/api/reports/preview/[id]/+server.ts', () => {
  describe('GET /api/reports/preview/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/reports/preview/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/reports/preview/:id'); }
  ...
  describe('POST /api/reports/preview/:id', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/reports/preview/:id', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/reports/preview/:id'); }
