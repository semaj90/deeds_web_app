 ...
 *
 * Route: src/routes/api/reports/[id]/publish/+server.ts
 ...
 *
 * Run:  npm run test -- api/reports/__id/publish
 */
...
describe('src/routes/api/reports/[id]/publish/+server.ts', () => {
  describe('POST /api/reports/:id/publish', () => {
    ...
    beforeEach(async () => {
      vi.resetAllMocks();
      const mod = await import('../../../../../../src/routes/api/reports/[id]/publish/+server.js') as Record<string, unknown>;
      handler = mod.POST as typeof handler;
    });

    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/reports/:id/publish', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/reports/:id/publish'); }
  ...
  describe('DELETE /api/reports/:id/publish', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/reports/:id/publish', body !== undefined ? { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/reports/:id/publish'); }
