 ...
 *
 * Run:  npm run test -- api/phase89/related/__id
 */
...
describe('src/routes/api/phase89/related/[id]/+server.ts', () => {
  describe('GET /api/phase89/related/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/phase89/related/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/phase89/related/:id'); }
