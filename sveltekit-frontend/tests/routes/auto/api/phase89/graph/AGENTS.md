# AGENTS.md — `tests/routes/auto/api/phase89/graph`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-12T03:12:15.164Z · agents.md spec · regen: npm run agents:write -->

> Directory: tests/routes/auto/api/phase89/graph
...
- `read_file({ filePath: "tests/routes/auto/api/phase89/graph/<file>" })` — fetch any file's contents (sandboxed to src/)
