...
describe('src/routes/api/search/filters/+server.ts', () => {
  describe('GET /api/search/filters', () => {
    ...
    beforeEach(async () => {
      vi.resetAllMocks();
      const mod = await import('../../../../../src/routes/api/search/filters/+server.js') as Record<string, unknown>;
      handler = mod.GET as typeof handler;
    });

    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/search/filters', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/search/filters'); }
