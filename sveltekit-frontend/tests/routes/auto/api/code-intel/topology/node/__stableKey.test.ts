 ...
 *
 * Run:  npm run test -- api/code-intel/topology/node/__stableKey
 */
...
describe('src/routes/api/code-intel/topology/node/[stableKey]/+server.ts', () => {
  describe('GET /api/code-intel/topology/node/:stableKey', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/code-intel/topology/node/:stableKey', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/code-intel/topology/node/:stableKey'); }
