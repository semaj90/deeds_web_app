 ...
 *
 * Run:  npm run test -- api/code-intel/clusters/__clusterKey
 */
...
describe('src/routes/api/code-intel/clusters/[clusterKey]/+server.ts', () => {
  describe('GET /api/code-intel/clusters/:clusterKey', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/code-intel/clusters/:clusterKey', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/code-intel/clusters/:clusterKey'); }
