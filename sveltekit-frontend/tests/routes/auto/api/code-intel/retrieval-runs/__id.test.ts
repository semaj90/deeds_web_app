 ...
 *
 * Run:  npm run test -- api/code-intel/retrieval-runs/__id
 */
...
describe('src/routes/api/code-intel/retrieval-runs/[id]/+server.ts', () => {
  describe('GET /api/code-intel/retrieval-runs/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/code-intel/retrieval-runs/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/code-intel/retrieval-runs/:id'); }
