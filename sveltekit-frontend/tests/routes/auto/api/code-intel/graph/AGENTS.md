# AGENTS.md — `tests/routes/auto/api/code-intel/graph`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-13T00:19:23.638Z · agents.md spec · regen: npm run agents:write -->

> Directory: tests/routes/auto/api/code-intel/graph
...
- `read_file({ filePath: "tests/routes/auto/api/code-intel/graph/<file>" })` — fetch any file's contents (sandboxed to src/)
