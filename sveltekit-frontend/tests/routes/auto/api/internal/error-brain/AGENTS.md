# AGENTS.md — `tests/routes/auto/api/internal/error-brain`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-08T21:57:37.606Z · agents.md spec · regen: npm run agents:write -->

> Directory: tests/routes/auto/api/internal/error-brain
...
- `read_file({ filePath: "tests/routes/auto/api/internal/error-brain/<file>" })` — fetch any file's contents (sandboxed to src/)
