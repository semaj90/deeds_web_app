 ...
 *
 * Run:  npm run test -- api/persons-of-interest/__id/associates/__associateId
 */
...
describe('src/routes/api/persons-of-interest/[id]/associates/[associateId]/+server.ts', () => {
  describe('DELETE /api/persons-of-interest/:id/associates/:associateId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/persons-of-interest/:id/associates/:associateId', body !== undefined ? { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/persons-of-interest/:id/associates/:associateId'); }
