 ...
 *
 * Run:  npm run test -- api/document/__docId
 */
...
describe('src/routes/api/document/[docId]/+server.ts', () => {
  describe('GET /api/document/:docId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/document/:docId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/document/:docId'); }
