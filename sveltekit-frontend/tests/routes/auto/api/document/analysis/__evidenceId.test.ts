 ...
 *
 * Run:  npm run test -- api/document/analysis/__evidenceId
 */
...
describe('src/routes/api/document/analysis/[evidenceId]/+server.ts', () => {
  describe('GET /api/document/analysis/:evidenceId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/document/analysis/:evidenceId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/document/analysis/:evidenceId'); }
