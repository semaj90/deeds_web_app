 ...
 *
 * Run:  npm run test -- api/canon/chunks/__chunkId
 */
...
describe('src/routes/api/canon/chunks/[chunkId]/+server.ts', () => {
  describe('GET /api/canon/chunks/:chunkId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/canon/chunks/:chunkId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/canon/chunks/:chunkId'); }
