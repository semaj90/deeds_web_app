...
describe('src/routes/api/courtroom/models/+server.ts', () => {
  describe('GET /api/courtroom/models', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;

    beforeEach(async () => {
      vi.resetAllMocks();
      const mod = await import('../../../../../src/routes/api/courtroom/models/+server.js') as Record<string, unknown>;
    ...
    function makeUrl() { return new URL('http://localhost/api/courtroom/models'); }
  ...
  describe('POST /api/courtroom/models', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/courtroom/models', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/courtroom/models'); }
