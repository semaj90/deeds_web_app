 ...
 *
 * Run:  npm run test -- api/hypergraph/edge/__id
 */
...
describe('src/routes/api/hypergraph/edge/[id]/+server.ts', () => {
  describe('GET /api/hypergraph/edge/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/hypergraph/edge/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/hypergraph/edge/:id'); }
