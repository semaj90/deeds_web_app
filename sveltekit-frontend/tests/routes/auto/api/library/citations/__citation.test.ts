 ...
 *
 * Run:  npm run test -- api/library/citations/__citation
 */
...
describe('src/routes/api/library/citations/[citation]/+server.ts', () => {
  describe('GET /api/library/citations/:citation', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/library/citations/:citation', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/library/citations/:citation'); }
