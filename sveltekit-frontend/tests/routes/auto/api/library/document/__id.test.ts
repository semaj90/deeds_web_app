 ...
 *
 * Run:  npm run test -- api/library/document/__id
 */
...
describe('src/routes/api/library/document/[id]/+server.ts', () => {
  describe('GET /api/library/document/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/library/document/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/library/document/:id'); }
