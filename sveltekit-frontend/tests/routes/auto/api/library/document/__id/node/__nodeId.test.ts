 ...
 *
 * Run:  npm run test -- api/library/document/__id/node/__nodeId
 */
...
describe('src/routes/api/library/document/[id]/node/[nodeId]/+server.ts', () => {
  describe('GET /api/library/document/:id/node/:nodeId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/library/document/:id/node/:nodeId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/library/document/:id/node/:nodeId'); }
