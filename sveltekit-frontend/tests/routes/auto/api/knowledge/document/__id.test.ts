 ...
 *
 * Run:  npm run test -- api/knowledge/document/__id
 */
...
describe('src/routes/api/knowledge/document/[id]/+server.ts', () => {
  describe('GET /api/knowledge/document/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/knowledge/document/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/knowledge/document/:id'); }
