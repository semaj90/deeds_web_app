 ...
 *
 * Route: src/routes/api/browser-context/snapshot/+server.ts
 ...
 *
 * Run:  npm run test -- api/browser-context/snapshot
 */
...
describe('src/routes/api/browser-context/snapshot/+server.ts', () => {
  describe('POST /api/browser-context/snapshot', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;

    beforeEach(async () => {
      vi.resetAllMocks();
      const mod = await import('../../../../../src/routes/api/browser-context/snapshot/+server.js') as Record<string, unknown>;
      handler = mod.POST as typeof handler;
    });

    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/browser-context/snapshot', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/browser-context/snapshot'); }
  ...
  describe('GET /api/browser-context/snapshot', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/browser-context/snapshot', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/browser-context/snapshot'); }
  ...
  describe('DELETE /api/browser-context/snapshot', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/browser-context/snapshot', body !== undefined ? { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/browser-context/snapshot'); }
