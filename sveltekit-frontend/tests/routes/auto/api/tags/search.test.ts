...
describe('src/routes/api/tags/search/+server.ts', () => {
  describe('GET /api/tags/search', () => {
    ...
    beforeEach(async () => {
      vi.resetAllMocks();
      const mod = await import('../../../../../src/routes/api/tags/search/+server.js') as Record<string, unknown>;
      handler = mod.GET as typeof handler;
    });

    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/tags/search', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/tags/search'); }
