 ...
 *
 * Run:  npm run test -- api/codeintel/chunks/__chunkId
 */
...
describe('src/routes/api/codeintel/chunks/[chunkId]/+server.ts', () => {
  describe('GET /api/codeintel/chunks/:chunkId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/codeintel/chunks/:chunkId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/codeintel/chunks/:chunkId'); }
