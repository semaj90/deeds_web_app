 ...
 *
 * Run:  npm run test -- api/codeintel/jobs/__jobId
 */
...
describe('src/routes/api/codeintel/jobs/[jobId]/+server.ts', () => {
  describe('GET /api/codeintel/jobs/:jobId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/codeintel/jobs/:jobId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/codeintel/jobs/:jobId'); }
