 ...
 *
 * Run:  npm run test -- api/codeintel/clusters/__id
 */
...
describe('src/routes/api/codeintel/clusters/[id]/+server.ts', () => {
  describe('GET /api/codeintel/clusters/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/codeintel/clusters/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/codeintel/clusters/:id'); }
  ...
  describe('POST /api/codeintel/clusters/:id', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/codeintel/clusters/:id', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
    function makeUrl() { return new URL('http://localhost/api/codeintel/clusters/:id'); }
