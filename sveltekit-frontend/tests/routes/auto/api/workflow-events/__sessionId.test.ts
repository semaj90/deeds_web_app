 ...
 *
 * Run:  npm run test -- api/workflow-events/__sessionId
 */
...
describe('src/routes/api/workflow-events/[sessionId]/+server.ts', () => {
  describe('GET /api/workflow-events/:sessionId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/workflow-events/:sessionId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/workflow-events/:sessionId'); }
