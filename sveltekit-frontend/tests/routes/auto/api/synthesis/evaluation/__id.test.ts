 ...
 *
 * Run:  npm run test -- api/synthesis/evaluation/__id
 */
...
describe('src/routes/api/synthesis/evaluation/[id]/+server.ts', () => {
  describe('GET /api/synthesis/evaluation/:id', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/synthesis/evaluation/:id', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/synthesis/evaluation/:id'); }
