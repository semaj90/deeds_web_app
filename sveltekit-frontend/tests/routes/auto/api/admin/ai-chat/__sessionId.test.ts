 ...
 *
 * Run:  npm run test -- api/admin/ai-chat/__sessionId
 */
...
describe('src/routes/api/admin/ai-chat/[sessionId]/+server.ts', () => {
  describe('GET /api/admin/ai-chat/:sessionId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/admin/ai-chat/:sessionId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/admin/ai-chat/:sessionId'); }
