...
describe('src/routes/api/ai/contextual-chat/+server.ts', () => {
  describe('POST /api/ai/contextual-chat', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/ai/contextual-chat', body !== undefined ? { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) } : { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({}) });
    }
