 ...
 *
 * Run:  npm run test -- api/pipeline/status/__jobId
 */
...
describe('src/routes/api/pipeline/status/[jobId]/+server.ts', () => {
  describe('GET /api/pipeline/status/:jobId', () => {
    ...
    function makeReq(body?: unknown) {
      return new Request('http://localhost/api/pipeline/status/:jobId', { method: 'GET' });
    }
    function makeUrl() { return new URL('http://localhost/api/pipeline/status/:jobId'); }
