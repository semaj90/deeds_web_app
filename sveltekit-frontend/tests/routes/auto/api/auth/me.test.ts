...
describe('src/routes/api/auth/me/+server.ts', () => {
  describe('GET /api/auth/me', () => {
    let handler: (evt: { request: Request; locals: Record<string, unknown>; url: URL; params: Record<string, string> }) => Promise<Response>;

    beforeEach(async () => {
      vi.resetAllMocks();
      const mod = await import('../../../../../src/routes/api/auth/me/+server.js') as Record<string, unknown>;
    ...
    function makeUrl() { return new URL('http://localhost/api/auth/me'); }
