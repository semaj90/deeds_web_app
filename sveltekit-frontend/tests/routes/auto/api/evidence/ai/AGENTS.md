# AGENTS.md — `tests/routes/auto/api/evidence/ai`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-11T23:28:38.745Z · agents.md spec · regen: npm run agents:write -->

> Directory: tests/routes/auto/api/evidence/ai
...
- `read_file({ filePath: "tests/routes/auto/api/evidence/ai/<file>" })` — fetch any file's contents (sandboxed to src/)
