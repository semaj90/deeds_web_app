...
- Audit score: **90/100**
- no audit signals
- Tags: `tests` `intent` `intent-router.spec.ts` `zod` `test` `regex-intent.spec.ts`
...
- `read_file({ filePath: "tests/intent/<file>" })` — fetch any file's contents (sandboxed to src/)
