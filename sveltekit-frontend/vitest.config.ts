...
export default defineConfig({
  ...
  test: {
    include: [
      ...
      'tests/langgraph-optionalization.spec.ts',
      ...
      'tests/phase-lanes-proof-route.spec.ts',
      'tests/pass-fabric-boundary-route.spec.ts',
      'tests/pass-fabric-current-route.spec.ts',
      'tests/pass-fabric-live-route.spec.ts',
      'tests/pass-fabric-proof-route.spec.ts',
      ...
      'tests/routes/api/ai/context-compact-search.test.ts',
      ...
      'tests/exact-retriever-recall-baseline.spec.ts',
      'tests/fusion-strategy-benchmark.spec.ts',
      'tests/collection-aliases.spec.ts',
      'tests/snapshot-restore.spec.ts',
      'tests/hnsw-ef-profiles.spec.ts',
      'tests/batch-search.spec.ts',
