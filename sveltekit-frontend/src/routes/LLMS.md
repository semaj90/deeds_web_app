...
| `+error.svelte` | 0.000 | 0x9 |
| `+page.svelte` | 0.000 | 0x209 |
| `+layout.svelte` | 0.000 | 0xb |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/+server.ts" })`
