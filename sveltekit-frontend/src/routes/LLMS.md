# LLMS.md — `sveltekit-frontend/src/routes`
...
> Directory: sveltekit-frontend/src/routes
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/<file>" })` — fetch any file's contents (sandboxed to src/)
