# LLMS.md — `sveltekit-frontend/src/routes/(dev)/demo/bits-ui`
...
> Directory: sveltekit-frontend/src/routes/(dev)/demo/bits-ui
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(dev)/demo/bits-ui/<file>" })` — fetch any file's contents (sandboxed to src/)
