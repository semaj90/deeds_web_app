# LLMS.md — `sveltekit-frontend/src/routes/(dev)/tts-demo`
...
> Directory: sveltekit-frontend/src/routes/(dev)/tts-demo
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(dev)/tts-demo/<file>" })` — fetch any file's contents (sandboxed to src/)
