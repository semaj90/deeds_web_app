# LLMS.md — `sveltekit-frontend/src/routes/(dev)/odin`
...
> Directory: sveltekit-frontend/src/routes/(dev)/odin
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(dev)/odin/<file>" })` — fetch any file's contents (sandboxed to src/)
