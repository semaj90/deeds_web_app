# LLMS.md — `sveltekit-frontend/src/routes/(dev)/voice-chat-demo`
...
> Directory: sveltekit-frontend/src/routes/(dev)/voice-chat-demo
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(dev)/voice-chat-demo/<file>" })` — fetch any file's contents (sandboxed to src/)
