...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(dev)/voice-chat-demo/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(dev)/voice-chat-demo/+server.ts" })`
