...
| `22e920c9da` | 2026-05-10T17:38 | feat(evidence): SSE /api/evidence/[id]/analyze/stream — Phase 3 Item 6 |
...
- module directory with 6 files, 665 API handlers, 256 Drizzle refs, 7 TODOs, 1 SSR-unsafe
- Audit score: **83/100**
- no audit signals
...
- ⚠️ 108 routes lack test pairing
...
- **[MED]** 108 routes lack test pairing
