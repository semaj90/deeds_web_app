...
| `68e5a515b1` | 2026-05-10T03:45 | fix(api): add Zod validation to evidence/tags and research/encode POST handlers |
...
- module directory with 6 files, 653 API handlers, 247 Drizzle refs, 7 TODOs, 1 SSR-unsafe
- Audit score: **83/100**
- no audit signals
...
- ⚠️ 101 routes lack test pairing
...
- **[MED]** 101 routes lack test pairing
