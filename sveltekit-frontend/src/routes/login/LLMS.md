# LLMS.md — `sveltekit-frontend/src/routes/login`
...
> Directory: sveltekit-frontend/src/routes/login
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/login/<file>" })` — fetch any file's contents (sandboxed to src/)
