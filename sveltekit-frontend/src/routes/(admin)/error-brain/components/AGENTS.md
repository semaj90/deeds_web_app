# AGENTS.md — `src/routes/(admin)/error-brain/components`
...
> Directory: src/routes/(admin)/error-brain/components
...
- `read_file({ filePath: "src/routes/(admin)/error-brain/components/<file>" })` — fetch any file's contents (sandboxed to src/)
