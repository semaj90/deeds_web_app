# LLMS.md — `sveltekit-frontend/src/routes/(app)/fictional-cases`
...
> Directory: sveltekit-frontend/src/routes/(app)/fictional-cases
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/fictional-cases/<file>" })` — fetch any file's contents (sandboxed to src/)
