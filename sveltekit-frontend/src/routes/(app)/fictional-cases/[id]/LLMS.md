# AGENTS.md — `sveltekit-frontend/src/routes/(app)/fictional-cases/[id]`
...
> Directory: sveltekit-frontend/src/routes/(app)/fictional-cases/[id]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/fictional-cases/[id]/<file>" })` — fetch any file's contents (sandboxed to src/)
