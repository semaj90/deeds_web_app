# LLMS.md — `sveltekit-frontend/src/routes/(app)/analysis-center`
...
> Directory: sveltekit-frontend/src/routes/(app)/analysis-center
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/analysis-center/<file>" })` — fetch any file's contents (sandboxed to src/)
