...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/analysis-center/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/analysis-center/+server.ts" })`
