# AGENTS.md — `sveltekit-frontend/src/routes/(app)/legal-corpus/[id]`
...
> Directory: sveltekit-frontend/src/routes/(app)/legal-corpus/[id]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/legal-corpus/[id]/<file>" })` — fetch any file's contents (sandboxed to src/)
