# LLMS.md — `sveltekit-frontend/src/routes/(app)/legal-corpus`
...
> Directory: sveltekit-frontend/src/routes/(app)/legal-corpus
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/legal-corpus/<file>" })` — fetch any file's contents (sandboxed to src/)
