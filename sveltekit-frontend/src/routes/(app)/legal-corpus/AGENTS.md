# AGENTS.md — `src/routes/(app)/legal-corpus`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-06T16:15:22.211Z · agents.md spec · regen: npm run agents:write -->

> Directory audit: src/routes/(app)/legal-corpus

## Snapshot

- route handler directory with 5 files, 0 API handlers, 2 Drizzle refs
- Audit score: **100/100**
- no audit signals
...
- `src/routes/(app)/legal-corpus/+page.svelte`
- `src/routes/(app)/legal-corpus/[id]/+page.server.ts`
- `src/routes/(app)/legal-corpus/[id]/+page.svelte`
- `src/routes/(app)/legal-corpus/[id]/+page.ts`
...
- `wiki_note_lookup({ query: "(app) legal-corpus", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/legal-corpus/<file>" })` — fetch any file's contents (sandboxed to src/)
