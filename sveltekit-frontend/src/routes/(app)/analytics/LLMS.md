# LLMS.md — `sveltekit-frontend/src/routes/(app)/analytics`
...
> Directory: sveltekit-frontend/src/routes/(app)/analytics
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/analytics/<file>" })` — fetch any file's contents (sandboxed to src/)
