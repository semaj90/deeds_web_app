# LLMS.md — `sveltekit-frontend/src/routes/(app)/rag-search`
...
> Directory: sveltekit-frontend/src/routes/(app)/rag-search
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/rag-search/<file>" })` — fetch any file's contents (sandboxed to src/)
