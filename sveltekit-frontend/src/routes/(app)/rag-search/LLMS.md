...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/rag-search/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/rag-search/+server.ts" })`
