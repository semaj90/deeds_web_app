# LLMS.md — `sveltekit-frontend/src/routes/(app)/persons-of-interest`
...
> Directory: sveltekit-frontend/src/routes/(app)/persons-of-interest
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/persons-of-interest/<file>" })` — fetch any file's contents (sandboxed to src/)
