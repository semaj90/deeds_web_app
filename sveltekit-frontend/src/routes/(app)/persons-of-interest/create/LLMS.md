# LLMS.md — `sveltekit-frontend/src/routes/(app)/persons-of-interest/create`
...
> Directory: sveltekit-frontend/src/routes/(app)/persons-of-interest/create
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/persons-of-interest/create/<file>" })` — fetch any file's contents (sandboxed to src/)
