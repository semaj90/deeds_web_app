# AGENTS.md — `sveltekit-frontend/src/routes/(app)/persons-of-interest/[id]`
...
> Directory: sveltekit-frontend/src/routes/(app)/persons-of-interest/[id]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/persons-of-interest/[id]/<file>" })` — fetch any file's contents (sandboxed to src/)
