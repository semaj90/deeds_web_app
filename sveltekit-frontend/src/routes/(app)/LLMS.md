# LLMS.md — `sveltekit-frontend/src/routes/(app)`
...
> Directory: sveltekit-frontend/src/routes/(app)
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/<file>" })` — fetch any file's contents (sandboxed to src/)
