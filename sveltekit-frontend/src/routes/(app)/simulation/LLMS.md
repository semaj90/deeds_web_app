# LLMS.md — `sveltekit-frontend/src/routes/(app)/simulation`
...
> Directory: sveltekit-frontend/src/routes/(app)/simulation
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/simulation/<file>" })` — fetch any file's contents (sandboxed to src/)
