# AGENTS.md — `src/routes/(app)/dashboard`
...
| `7c08bbb909` | 2026-04-06T21:32 | Batch 6-8: SQL injection elimination, command injection fix, error leak plugs, upload/save UX wiring |
| `ee44c0b3d0` | 2026-04-06T10:23 | feat: expand citations CRUD + add glossary/precedents/statutes APIs |
| `d80469aa3b` | 2026-03-22T23:13 | feat: 51 new API endpoints, Zod validation across all routes, Phase 0 config fixes |
...
> Directory audit: src/routes/(app)/dashboard
...
- `wiki_note_lookup({ query: "(app) dashboard", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/dashboard/<file>" })` — fetch any file's contents (sandboxed to src/)
