# LLMS.md — `sveltekit-frontend/src/routes/(app)/recommendations`
...
> Directory: sveltekit-frontend/src/routes/(app)/recommendations
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/recommendations/<file>" })` — fetch any file's contents (sandboxed to src/)
