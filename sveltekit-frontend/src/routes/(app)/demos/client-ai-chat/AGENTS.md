# AGENTS.md — `src/routes/(app)/demos/client-ai-chat`
...
> Directory: src/routes/(app)/demos/client-ai-chat
...
- `graph_search({ query: "client-ai-chat", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos client-ai-chat", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/client-ai-chat/<file>" })` — fetch any file's contents (sandboxed to src/)
