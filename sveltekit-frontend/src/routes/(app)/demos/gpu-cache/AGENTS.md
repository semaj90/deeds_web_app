# AGENTS.md — `src/routes/(app)/demos/gpu-cache`
...
| `6530e65d2f` | 2026-02-23T12:16 | Rewrite .gitignore: fix 6 overly broad patterns hiding source code, remove 230 duplicate lines |
...
> Directory: src/routes/(app)/demos/gpu-cache
...
- `graph_search({ query: "gpu-cache", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos gpu-cache", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/gpu-cache/<file>" })` — fetch any file's contents (sandboxed to src/)
