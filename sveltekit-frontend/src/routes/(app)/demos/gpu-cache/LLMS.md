# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/gpu-cache`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/gpu-cache
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/gpu-cache/<file>" })` — fetch any file's contents (sandboxed to src/)
