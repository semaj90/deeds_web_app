# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/phantom-code-lab`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/phantom-code-lab
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/phantom-code-lab/<file>" })` — fetch any file's contents (sandboxed to src/)
