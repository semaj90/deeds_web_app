# AGENTS.md — `src/routes/(app)/demos/phantom-code-lab`
...
| `2c41dd098a` | 2026-03-15T19:01 | fix: GPU audit — add mandatory directory audit protocol + TRT fallback + llm-router fix |
...
> Directory: src/routes/(app)/demos/phantom-code-lab
...
- `wiki_note_lookup({ query: "demos phantom-code-lab", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/phantom-code-lab/<file>" })` — fetch any file's contents (sandboxed to src/)
