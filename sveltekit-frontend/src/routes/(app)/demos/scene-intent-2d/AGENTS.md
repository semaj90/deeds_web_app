# AGENTS.md — `src/routes/(app)/demos/scene-intent-2d`
...
> Directory: src/routes/(app)/demos/scene-intent-2d
...
- `read_file({ filePath: "src/routes/(app)/demos/scene-intent-2d/<file>" })` — fetch any file's contents (sandboxed to src/)
