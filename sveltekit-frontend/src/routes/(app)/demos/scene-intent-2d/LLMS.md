...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/scene-intent-2d/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/scene-intent-2d/+server.ts" })`
