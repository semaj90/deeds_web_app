# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/scene-intent-2d`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/scene-intent-2d
...
- `graph_search({ query: "scene-intent-2d", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos scene-intent-2d", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/scene-intent-2d/<file>" })` — fetch any file's contents (sandboxed to src/)
