# AGENTS.md — `src/routes/(app)/demos/ai-assistant`
...
> Directory: src/routes/(app)/demos/ai-assistant
...
- `read_file({ filePath: "src/routes/(app)/demos/ai-assistant/<file>" })` — fetch any file's contents (sandboxed to src/)
