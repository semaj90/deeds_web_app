# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/ai-assistant`
...
| `0c856a1e38` | 2026-04-07T21:14 | chore: linter auto-fixes on demo pages + 7 new demo routes |
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/ai-assistant
...
- `graph_search({ query: "ai-assistant", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos ai-assistant", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/ai-assistant/<file>" })` — fetch any file's contents (sandboxed to src/)
