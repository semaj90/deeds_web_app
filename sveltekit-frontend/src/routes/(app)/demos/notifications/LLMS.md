# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/notifications`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/notifications
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/notifications/<file>" })` — fetch any file's contents (sandboxed to src/)
