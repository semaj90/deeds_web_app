# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/synthesis-chat`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/synthesis-chat
...
- `graph_search({ query: "synthesis-chat", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos synthesis-chat", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/synthesis-chat/<file>" })` — fetch any file's contents (sandboxed to src/)
