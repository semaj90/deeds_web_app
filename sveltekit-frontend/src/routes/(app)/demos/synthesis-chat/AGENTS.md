# AGENTS.md — `src/routes/(app)/demos/synthesis-chat`
...
> Directory: src/routes/(app)/demos/synthesis-chat
...
- `read_file({ filePath: "src/routes/(app)/demos/synthesis-chat/<file>" })` — fetch any file's contents (sandboxed to src/)
