# AGENTS.md — `src/routes/(app)/demos/search-tools`
...
> Directory: src/routes/(app)/demos/search-tools
...
- `read_file({ filePath: "src/routes/(app)/demos/search-tools/<file>" })` — fetch any file's contents (sandboxed to src/)
