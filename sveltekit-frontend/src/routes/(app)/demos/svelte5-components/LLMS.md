# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/svelte5-components`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/svelte5-components
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/svelte5-components/<file>" })` — fetch any file's contents (sandboxed to src/)
