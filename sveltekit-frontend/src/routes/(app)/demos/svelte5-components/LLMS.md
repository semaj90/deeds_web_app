...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/svelte5-components/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/svelte5-components/+server.ts" })`
