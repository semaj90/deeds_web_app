# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/citation-tools`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/citation-tools
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/citation-tools/<file>" })` — fetch any file's contents (sandboxed to src/)
