# AGENTS.md — `src/routes/(app)/demos/yorha-icons`
...
> Directory: src/routes/(app)/demos/yorha-icons
...
- `read_file({ filePath: "src/routes/(app)/demos/yorha-icons/<file>" })` — fetch any file's contents (sandboxed to src/)
