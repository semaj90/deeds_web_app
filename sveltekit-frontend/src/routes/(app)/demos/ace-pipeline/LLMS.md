# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/ace-pipeline`
...
| `dbb605a8a4` | 2026-02-24T18:55 | Session 93r18: Cache pipeline wiring + 4 new cache APIs + archive dead files + ACE demo page |
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/ace-pipeline
...
- `graph_search({ query: "ace-pipeline", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos ace-pipeline", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/ace-pipeline/<file>" })` — fetch any file's contents (sandboxed to src/)
