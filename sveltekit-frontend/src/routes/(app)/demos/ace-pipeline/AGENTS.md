# AGENTS.md — `src/routes/(app)/demos/ace-pipeline`
...
> Directory: src/routes/(app)/demos/ace-pipeline
...
- `read_file({ filePath: "src/routes/(app)/demos/ace-pipeline/<file>" })` — fetch any file's contents (sandboxed to src/)
