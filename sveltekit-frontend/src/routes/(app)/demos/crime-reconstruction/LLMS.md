...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/crime-reconstruction/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/crime-reconstruction/+server.ts" })`
