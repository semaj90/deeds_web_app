# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/crime-reconstruction`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/crime-reconstruction
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/crime-reconstruction/<file>" })` — fetch any file's contents (sandboxed to src/)
