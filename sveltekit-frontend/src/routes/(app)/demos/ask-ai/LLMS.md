# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/ask-ai`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/ask-ai
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/ask-ai/<file>" })` — fetch any file's contents (sandboxed to src/)
