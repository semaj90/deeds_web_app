# AGENTS.md — `src/routes/(app)/demos/agent-chat`
...
> Directory: src/routes/(app)/demos/agent-chat
...
- `read_file({ filePath: "src/routes/(app)/demos/agent-chat/<file>" })` — fetch any file's contents (sandboxed to src/)
