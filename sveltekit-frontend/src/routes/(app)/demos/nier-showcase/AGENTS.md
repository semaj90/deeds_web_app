# AGENTS.md — `src/routes/(app)/demos/nier-showcase`
...
> Directory: src/routes/(app)/demos/nier-showcase
...
- `read_file({ filePath: "src/routes/(app)/demos/nier-showcase/<file>" })` — fetch any file's contents (sandboxed to src/)
