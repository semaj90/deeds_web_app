# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/nier-showcase`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/nier-showcase
...
- `graph_search({ query: "nier-showcase", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos nier-showcase", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/nier-showcase/<file>" })` — fetch any file's contents (sandboxed to src/)
