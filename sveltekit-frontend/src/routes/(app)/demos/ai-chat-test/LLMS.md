# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/ai-chat-test`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/ai-chat-test
...
- `graph_search({ query: "ai-chat-test", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos ai-chat-test", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/ai-chat-test/<file>" })` — fetch any file's contents (sandboxed to src/)
