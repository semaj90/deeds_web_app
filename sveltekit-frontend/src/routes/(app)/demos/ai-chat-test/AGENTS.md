# AGENTS.md — `src/routes/(app)/demos/ai-chat-test`
...
> Directory: src/routes/(app)/demos/ai-chat-test
...
- `read_file({ filePath: "src/routes/(app)/demos/ai-chat-test/<file>" })` — fetch any file's contents (sandboxed to src/)
