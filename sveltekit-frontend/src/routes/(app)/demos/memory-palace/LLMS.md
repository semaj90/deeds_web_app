# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/memory-palace`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/memory-palace
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/memory-palace/<file>" })` — fetch any file's contents (sandboxed to src/)
