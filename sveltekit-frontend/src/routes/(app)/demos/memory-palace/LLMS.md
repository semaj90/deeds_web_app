...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/memory-palace/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/memory-palace/+server.ts" })`
