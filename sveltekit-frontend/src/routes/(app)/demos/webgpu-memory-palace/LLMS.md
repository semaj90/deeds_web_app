# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/webgpu-memory-palace`
...
| `773e48748d` | 2026-04-12T09:32 | feat(cache): add ETag+cache-control to fictional-cases list (batch 11) |
| `82d5e02165` | 2026-04-12T09:07 | feat(cache): add ETag+cache-control to yorha/cluster-health (batch 9) |
| `5ac105890b` | 2026-03-16T13:14 | chore: Consolidate 8 single-file dirs into canonical locations |
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/webgpu-memory-palace
...
- `graph_search({ query: "webgpu-memory-palace", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos webgpu-memory-palace", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/webgpu-memory-palace/<file>" })` — fetch any file's contents (sandboxed to src/)
