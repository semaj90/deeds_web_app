# AGENTS.md — `src/routes/(app)/demos/webgpu-memory-palace`
...
| `8ef1b7b021` | 2026-02-28T18:26 | Add Piper TTS neural voice synthesis (WASM) |
...
> Directory: src/routes/(app)/demos/webgpu-memory-palace
...
- `read_file({ filePath: "src/routes/(app)/demos/webgpu-memory-palace/<file>" })` — fetch any file's contents (sandboxed to src/)
