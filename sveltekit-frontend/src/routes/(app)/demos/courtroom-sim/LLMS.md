...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/courtroom-sim/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/courtroom-sim/+server.ts" })`
