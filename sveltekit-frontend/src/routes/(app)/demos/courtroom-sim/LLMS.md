# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/courtroom-sim`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/courtroom-sim
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/courtroom-sim/<file>" })` — fetch any file's contents (sandboxed to src/)
