# AGENTS.md — `src/routes/(app)/demos/agentic-errors/analysis`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-04T16:09:09.941Z · agents.md spec · regen: npm run agents:write -->

> Directory audit: src/routes/(app)/demos/agentic-errors/analysis

## Snapshot

- src/routes/(app)/demos/agentic-errors/analysis/+page.server.ts, src/routes/(app)/demos/agentic-errors/analysis/+page.svelte
...
- `wiki_note_lookup({ query: "agentic-errors analysis", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/agentic-errors/analysis/<file>" })` — fetch any file's contents (sandboxed to src/)
