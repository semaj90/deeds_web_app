# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/agentic-errors/analysis`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/agentic-errors/analysis
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/agentic-errors/analysis/<file>" })` — fetch any file's contents (sandboxed to src/)
