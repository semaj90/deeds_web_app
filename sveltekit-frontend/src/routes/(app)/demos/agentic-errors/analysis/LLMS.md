...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/agentic-errors/analysis/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/agentic-errors/analysis/+server.ts" })`
