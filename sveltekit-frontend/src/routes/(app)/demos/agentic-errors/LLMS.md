...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/agentic-errors/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/agentic-errors/+server.ts" })`
