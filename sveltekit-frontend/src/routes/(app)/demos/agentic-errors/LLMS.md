# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/agentic-errors`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/agentic-errors
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/agentic-errors/<file>" })` — fetch any file's contents (sandboxed to src/)
