# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/context-menu`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/context-menu
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/context-menu/<file>" })` — fetch any file's contents (sandboxed to src/)
