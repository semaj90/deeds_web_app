# AGENTS.md — `src/routes/(app)/demos/context-menu`
...
> Directory: src/routes/(app)/demos/context-menu
...
- `wiki_note_lookup({ query: "demos context-menu", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/context-menu/<file>" })` — fetch any file's contents (sandboxed to src/)
