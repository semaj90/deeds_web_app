# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/contextual-chat`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/contextual-chat
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/contextual-chat/<file>" })` — fetch any file's contents (sandboxed to src/)
