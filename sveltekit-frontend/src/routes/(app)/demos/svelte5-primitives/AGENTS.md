# AGENTS.md — `src/routes/(app)/demos/svelte5-primitives`
...
> Directory: src/routes/(app)/demos/svelte5-primitives
...
- `read_file({ filePath: "src/routes/(app)/demos/svelte5-primitives/<file>" })` — fetch any file's contents (sandboxed to src/)
