# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/svelte5-primitives`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/svelte5-primitives
...
- `graph_search({ query: "svelte5-primitives", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos svelte5-primitives", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/svelte5-primitives/<file>" })` — fetch any file's contents (sandboxed to src/)
