# AGENTS.md — `src/routes/(app)/demos/case-form`
...
> Directory: src/routes/(app)/demos/case-form
...
- `read_file({ filePath: "src/routes/(app)/demos/case-form/<file>" })` — fetch any file's contents (sandboxed to src/)
