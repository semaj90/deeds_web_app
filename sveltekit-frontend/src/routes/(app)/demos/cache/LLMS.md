# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/cache`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/cache
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/cache/<file>" })` — fetch any file's contents (sandboxed to src/)
