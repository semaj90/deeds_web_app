# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/detective-command`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/detective-command
...
- `graph_search({ query: "detective-command", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos detective-command", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/detective-command/<file>" })` — fetch any file's contents (sandboxed to src/)
