# AGENTS.md — `src/routes/(app)/demos/detective-command`
...
> Directory: src/routes/(app)/demos/detective-command
...
- `read_file({ filePath: "src/routes/(app)/demos/detective-command/<file>" })` — fetch any file's contents (sandboxed to src/)
