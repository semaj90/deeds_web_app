# AGENTS.md — `src/routes/(app)/demos`
...
> Directory audit: src/routes/(app)/demos

## Snapshot

- route handler directory with 104 files, 0 API handlers, 3 Drizzle refs, 1 TODOs
- Audit score: **88/100**
- no audit signals
...
- `src/routes/(app)/demos/agentic-errors/+layout.svelte`
- `src/routes/(app)/demos/agentic-errors/+layout.ts`
...
- **[MED]** 5 routes lack test pairing
...
- `read_file({ filePath: "src/routes/(app)/demos/<file>" })` — fetch any file's contents (sandboxed to src/)
