# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/keyboard-shortcuts`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/keyboard-shortcuts
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/keyboard-shortcuts/<file>" })` — fetch any file's contents (sandboxed to src/)
