# AGENTS.md — `src/routes/(app)/demos/keyboard-shortcuts`
...
| `decb63ec3c` | 2026-03-16T08:54 | feat: Add /audit-components + /prune-codebase skills, clean 43 dead files |
...
> Directory: src/routes/(app)/demos/keyboard-shortcuts
...
- `graph_search({ query: "keyboard-shortcuts", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos keyboard-shortcuts", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/keyboard-shortcuts/<file>" })` — fetch any file's contents (sandboxed to src/)
