# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/ai-file-upload`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/ai-file-upload
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/ai-file-upload/<file>" })` — fetch any file's contents (sandboxed to src/)
