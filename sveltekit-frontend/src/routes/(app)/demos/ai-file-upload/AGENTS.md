# AGENTS.md — `src/routes/(app)/demos/ai-file-upload`
...
> Directory: src/routes/(app)/demos/ai-file-upload
...
- `graph_search({ query: "ai-file-upload", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos ai-file-upload", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/ai-file-upload/<file>" })` — fetch any file's contents (sandboxed to src/)
