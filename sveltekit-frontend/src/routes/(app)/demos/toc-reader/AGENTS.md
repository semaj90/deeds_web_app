# AGENTS.md — `src/routes/(app)/demos/toc-reader`
...
> Directory: src/routes/(app)/demos/toc-reader
...
- `read_file({ filePath: "src/routes/(app)/demos/toc-reader/<file>" })` — fetch any file's contents (sandboxed to src/)
