# AGENTS.md — `src/routes/(app)/demos/yorha`
...
> Directory: src/routes/(app)/demos/yorha
...
- `read_file({ filePath: "src/routes/(app)/demos/yorha/<file>" })` — fetch any file's contents (sandboxed to src/)
