# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/yorha/components/cases`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/yorha/components/cases
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/yorha/components/cases/<file>" })` — fetch any file's contents (sandboxed to src/)
