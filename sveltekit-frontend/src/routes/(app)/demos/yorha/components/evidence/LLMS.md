# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/yorha/components/evidence`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/yorha/components/evidence
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/yorha/components/evidence/<file>" })` — fetch any file's contents (sandboxed to src/)
