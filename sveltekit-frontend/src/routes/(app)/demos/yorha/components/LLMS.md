...
| `YoRHaAIChat.svelte` | 0.150 | 0x9 |
| `EnhancedYoRHaAIAssistant.svelte` | 0.150 | 0x9 |
| `YoRHaDetectiveModal.svelte` | 0.150 | 0x9 |
| `YoRHaDetectiveForm.svelte` | 0.150 | 0x8 |
| `PoliceReportGenerator.svelte` | 0.150 | 0x8 |
| `PhoenixProsecutorDashboard.svelte` | 0.150 | 0x9 |
| `JudicialAnalysisAgent.svelte` | 0.150 | 0x8 |
| `YoRHaForm.svelte` | 0.150 | 0x8 |
| `YoRHaDialog.svelte` | 0.150 | 0x9 |
## Audit Gates — General
