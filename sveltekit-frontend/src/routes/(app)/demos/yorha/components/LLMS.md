...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/yorha/components/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/yorha/components/+server.ts" })`
