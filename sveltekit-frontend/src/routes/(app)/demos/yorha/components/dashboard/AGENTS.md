# AGENTS.md — `src/routes/(app)/demos/yorha/components/dashboard`
...
> Directory: src/routes/(app)/demos/yorha/components/dashboard
...
- `read_file({ filePath: "src/routes/(app)/demos/yorha/components/dashboard/<file>" })` — fetch any file's contents (sandboxed to src/)
