# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/yorha/components/dashboard`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/yorha/components/dashboard
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/yorha/components/dashboard/<file>" })` — fetch any file's contents (sandboxed to src/)
