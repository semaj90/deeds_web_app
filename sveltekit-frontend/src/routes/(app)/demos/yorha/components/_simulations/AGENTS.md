# AGENTS.md — `src/routes/(app)/demos/yorha/components/_simulations`
...
> Directory: src/routes/(app)/demos/yorha/components/_simulations
...
- `read_file({ filePath: "src/routes/(app)/demos/yorha/components/_simulations/<file>" })` — fetch any file's contents (sandboxed to src/)
