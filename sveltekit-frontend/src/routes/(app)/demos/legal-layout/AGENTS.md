# AGENTS.md — `src/routes/(app)/demos/legal-layout`
...
> Directory: src/routes/(app)/demos/legal-layout
...
- `read_file({ filePath: "src/routes/(app)/demos/legal-layout/<file>" })` — fetch any file's contents (sandboxed to src/)
