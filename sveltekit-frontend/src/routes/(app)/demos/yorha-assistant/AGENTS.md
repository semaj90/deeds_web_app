# AGENTS.md — `src/routes/(app)/demos/yorha-assistant`
...
> Directory: src/routes/(app)/demos/yorha-assistant
...
- `read_file({ filePath: "src/routes/(app)/demos/yorha-assistant/<file>" })` — fetch any file's contents (sandboxed to src/)
