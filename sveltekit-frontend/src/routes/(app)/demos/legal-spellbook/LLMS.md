# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/legal-spellbook`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/legal-spellbook
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/legal-spellbook/<file>" })` — fetch any file's contents (sandboxed to src/)
