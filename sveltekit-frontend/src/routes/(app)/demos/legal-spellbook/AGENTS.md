# AGENTS.md — `src/routes/(app)/demos/legal-spellbook`
...
> Directory: src/routes/(app)/demos/legal-spellbook
...
- `graph_search({ query: "legal-spellbook", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos legal-spellbook", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/legal-spellbook/<file>" })` — fetch any file's contents (sandboxed to src/)
