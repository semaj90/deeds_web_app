# AGENTS.md — `src/routes/(app)/demos/collab-canvas`
...
> Directory: src/routes/(app)/demos/collab-canvas
...
- `read_file({ filePath: "src/routes/(app)/demos/collab-canvas/<file>" })` — fetch any file's contents (sandboxed to src/)
