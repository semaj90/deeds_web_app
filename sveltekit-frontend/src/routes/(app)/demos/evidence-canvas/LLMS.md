# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/evidence-canvas`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/evidence-canvas
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/evidence-canvas/<file>" })` — fetch any file's contents (sandboxed to src/)
