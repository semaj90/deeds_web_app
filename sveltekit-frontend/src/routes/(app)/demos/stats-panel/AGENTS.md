# AGENTS.md — `src/routes/(app)/demos/stats-panel`
...
> Directory: src/routes/(app)/demos/stats-panel
...
- `read_file({ filePath: "src/routes/(app)/demos/stats-panel/<file>" })` — fetch any file's contents (sandboxed to src/)
