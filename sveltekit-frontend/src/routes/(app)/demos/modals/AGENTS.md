# AGENTS.md — `src/routes/(app)/demos/modals`
...
> Directory: src/routes/(app)/demos/modals
...
- `read_file({ filePath: "src/routes/(app)/demos/modals/<file>" })` — fetch any file's contents (sandboxed to src/)
