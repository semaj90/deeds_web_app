# AGENTS.md — `src/routes/(app)/demos/dialog-wrapper`
...
> Directory: src/routes/(app)/demos/dialog-wrapper
...
- `read_file({ filePath: "src/routes/(app)/demos/dialog-wrapper/<file>" })` — fetch any file's contents (sandboxed to src/)
