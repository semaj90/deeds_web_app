# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/dialog-wrapper`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/dialog-wrapper
...
- `graph_search({ query: "dialog-wrapper", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos dialog-wrapper", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/dialog-wrapper/<file>" })` — fetch any file's contents (sandboxed to src/)
