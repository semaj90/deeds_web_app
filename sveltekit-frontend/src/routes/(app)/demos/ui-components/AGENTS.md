# AGENTS.md — `src/routes/(app)/demos/ui-components`
...
> Directory: src/routes/(app)/demos/ui-components
...
- `read_file({ filePath: "src/routes/(app)/demos/ui-components/<file>" })` — fetch any file's contents (sandboxed to src/)
