# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/ui-components`
...
| `e71fc212c8` | 2026-04-08T22:35 | feat: GPU audit orchestrator + Gemma tool router, nes-command-center rename, env audit |
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/ui-components
...
- `graph_search({ query: "ui-components", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos ui-components", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/ui-components/<file>" })` — fetch any file's contents (sandboxed to src/)
