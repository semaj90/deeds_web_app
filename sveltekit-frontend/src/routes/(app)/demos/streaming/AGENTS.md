# AGENTS.md — `src/routes/(app)/demos/streaming`
...
> Directory: src/routes/(app)/demos/streaming
...
- `read_file({ filePath: "src/routes/(app)/demos/streaming/<file>" })` — fetch any file's contents (sandboxed to src/)
