# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/client-inference`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/client-inference
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/client-inference/<file>" })` — fetch any file's contents (sandboxed to src/)
