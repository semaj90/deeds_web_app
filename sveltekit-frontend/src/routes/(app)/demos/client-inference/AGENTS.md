# AGENTS.md — `src/routes/(app)/demos/client-inference`
...
> Directory: src/routes/(app)/demos/client-inference
...
- `graph_search({ query: "client-inference", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos client-inference", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/client-inference/<file>" })` — fetch any file's contents (sandboxed to src/)
