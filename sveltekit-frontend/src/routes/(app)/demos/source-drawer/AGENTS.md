# AGENTS.md — `src/routes/(app)/demos/source-drawer`
...
> Directory: src/routes/(app)/demos/source-drawer
...
- `read_file({ filePath: "src/routes/(app)/demos/source-drawer/<file>" })` — fetch any file's contents (sandboxed to src/)
