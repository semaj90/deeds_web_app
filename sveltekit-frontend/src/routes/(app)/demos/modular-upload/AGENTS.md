# AGENTS.md — `src/routes/(app)/demos/modular-upload`
...
> Directory: src/routes/(app)/demos/modular-upload
...
- `read_file({ filePath: "src/routes/(app)/demos/modular-upload/<file>" })` — fetch any file's contents (sandboxed to src/)
