# AGENTS.md — `src/routes/(app)/demos/evidence-form`
...
> Directory: src/routes/(app)/demos/evidence-form
...
- `read_file({ filePath: "src/routes/(app)/demos/evidence-form/<file>" })` — fetch any file's contents (sandboxed to src/)
