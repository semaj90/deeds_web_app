# AGENTS.md — `src/routes/(app)/demos/chat-messages`
...
> Directory: src/routes/(app)/demos/chat-messages
...
- `read_file({ filePath: "src/routes/(app)/demos/chat-messages/<file>" })` — fetch any file's contents (sandboxed to src/)
