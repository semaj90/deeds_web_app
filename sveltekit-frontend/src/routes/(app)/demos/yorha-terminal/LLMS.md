# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/yorha-terminal`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/yorha-terminal
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/yorha-terminal/<file>" })` — fetch any file's contents (sandboxed to src/)
