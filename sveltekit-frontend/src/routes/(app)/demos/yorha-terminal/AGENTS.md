# AGENTS.md — `src/routes/(app)/demos/yorha-terminal`
...
> Directory: src/routes/(app)/demos/yorha-terminal
...
- `graph_search({ query: "yorha-terminal", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos yorha-terminal", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/yorha-terminal/<file>" })` — fetch any file's contents (sandboxed to src/)
