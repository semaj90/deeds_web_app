# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/prosecutor-dashboard`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/prosecutor-dashboard
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/prosecutor-dashboard/<file>" })` — fetch any file's contents (sandboxed to src/)
