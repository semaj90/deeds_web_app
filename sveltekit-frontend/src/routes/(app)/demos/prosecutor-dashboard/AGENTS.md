# AGENTS.md — `src/routes/(app)/demos/prosecutor-dashboard`
...
> Directory: src/routes/(app)/demos/prosecutor-dashboard
...
- `graph_search({ query: "prosecutor-dashboard", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos prosecutor-dashboard", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/prosecutor-dashboard/<file>" })` — fetch any file's contents (sandboxed to src/)
