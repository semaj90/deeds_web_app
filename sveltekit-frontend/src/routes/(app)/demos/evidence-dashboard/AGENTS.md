# AGENTS.md — `src/routes/(app)/demos/evidence-dashboard`
...
> Directory: src/routes/(app)/demos/evidence-dashboard
...
- `read_file({ filePath: "src/routes/(app)/demos/evidence-dashboard/<file>" })` — fetch any file's contents (sandboxed to src/)
