# AGENTS.md — `src/routes/(app)/demos/enhanced-upload`
...
> Directory: src/routes/(app)/demos/enhanced-upload
...
- `read_file({ filePath: "src/routes/(app)/demos/enhanced-upload/<file>" })` — fetch any file's contents (sandboxed to src/)
