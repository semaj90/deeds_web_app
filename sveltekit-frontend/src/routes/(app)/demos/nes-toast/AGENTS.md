# AGENTS.md — `src/routes/(app)/demos/nes-toast`
...
> Directory: src/routes/(app)/demos/nes-toast
...
- `read_file({ filePath: "src/routes/(app)/demos/nes-toast/<file>" })` — fetch any file's contents (sandboxed to src/)
