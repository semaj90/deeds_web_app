# AGENTS.md — `src/routes/(app)/demos/rich-text-editor`
...
> Directory: src/routes/(app)/demos/rich-text-editor
...
- `read_file({ filePath: "src/routes/(app)/demos/rich-text-editor/<file>" })` — fetch any file's contents (sandboxed to src/)
