# AGENTS.md — `src/routes/(app)/demos/webgpu-showcase`
...
> Directory: src/routes/(app)/demos/webgpu-showcase
...
- `read_file({ filePath: "src/routes/(app)/demos/webgpu-showcase/<file>" })` — fetch any file's contents (sandboxed to src/)
