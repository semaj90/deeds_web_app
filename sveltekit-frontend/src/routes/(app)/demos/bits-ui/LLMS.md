# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/bits-ui`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/bits-ui
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/bits-ui/<file>" })` — fetch any file's contents (sandboxed to src/)
