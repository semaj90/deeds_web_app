# AGENTS.md — `src/routes/(app)/demos/bits-ui`
...
| `4ce2af2558` | 2026-02-24T14:30 | Session 93r14: Migrate @lucide/svelte → UnoCSS icon classes across 132 files |
...
> Directory: src/routes/(app)/demos/bits-ui
...
- `wiki_note_lookup({ query: "demos bits-ui", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/demos/bits-ui/<file>" })` — fetch any file's contents (sandboxed to src/)
