# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/nes-routes`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/nes-routes
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/nes-routes/<file>" })` — fetch any file's contents (sandboxed to src/)
