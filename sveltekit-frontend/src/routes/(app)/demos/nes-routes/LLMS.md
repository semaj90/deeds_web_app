...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/nes-routes/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/nes-routes/+server.ts" })`
