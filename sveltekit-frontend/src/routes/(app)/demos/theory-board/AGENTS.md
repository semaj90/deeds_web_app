# AGENTS.md — `src/routes/(app)/demos/theory-board`
...
> Directory: src/routes/(app)/demos/theory-board
...
- `read_file({ filePath: "src/routes/(app)/demos/theory-board/<file>" })` — fetch any file's contents (sandboxed to src/)
