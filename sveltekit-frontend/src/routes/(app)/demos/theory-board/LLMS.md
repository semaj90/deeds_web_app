# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/theory-board`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/theory-board
...
- `graph_search({ query: "theory-board", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos theory-board", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/theory-board/<file>" })` — fetch any file's contents (sandboxed to src/)
