# AGENTS.md — `src/routes/(app)/demos/embedding-stream`
...
> Directory: src/routes/(app)/demos/embedding-stream
...
- `read_file({ filePath: "src/routes/(app)/demos/embedding-stream/<file>" })` — fetch any file's contents (sandboxed to src/)
