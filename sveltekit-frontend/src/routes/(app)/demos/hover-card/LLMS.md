# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/hover-card`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/hover-card
...
- `graph_search({ query: "hover-card", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "demos hover-card", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/hover-card/<file>" })` — fetch any file's contents (sandboxed to src/)
