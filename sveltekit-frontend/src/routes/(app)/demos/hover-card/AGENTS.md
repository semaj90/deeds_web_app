# AGENTS.md — `src/routes/(app)/demos/hover-card`
...
> Directory: src/routes/(app)/demos/hover-card
...
- `read_file({ filePath: "src/routes/(app)/demos/hover-card/<file>" })` — fetch any file's contents (sandboxed to src/)
