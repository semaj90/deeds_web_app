# AGENTS.md — `src/routes/(app)/demos/celestial-icons`
...
> Directory: src/routes/(app)/demos/celestial-icons
...
- `read_file({ filePath: "src/routes/(app)/demos/celestial-icons/<file>" })` — fetch any file's contents (sandboxed to src/)
