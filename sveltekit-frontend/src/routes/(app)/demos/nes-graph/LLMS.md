...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/nes-graph/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/demos/nes-graph/+server.ts" })`
