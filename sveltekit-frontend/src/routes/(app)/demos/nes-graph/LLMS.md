# LLMS.md — `sveltekit-frontend/src/routes/(app)/demos/nes-graph`
...
> Directory: sveltekit-frontend/src/routes/(app)/demos/nes-graph
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/demos/nes-graph/<file>" })` — fetch any file's contents (sandboxed to src/)
