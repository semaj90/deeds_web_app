# LLMS.md — `sveltekit-frontend/src/routes/(app)/evidence-library`
...
> Directory: sveltekit-frontend/src/routes/(app)/evidence-library
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/evidence-library/<file>" })` — fetch any file's contents (sandboxed to src/)
