# LLMS.md — `sveltekit-frontend/src/routes/(app)/global-search`
...
| `28efa7d3d8` | 2026-04-14T19:12 | fix: global-search UX + G25 sse-client cleanup + sidebar library link |
| `fb9e3616fd` | 2026-04-14T18:21 | feat: Phase 109 — LangGraph error fixer, audit fixes, rune compliance, route URL fixes |
| `1436a7b443` | 2026-03-26T20:46 | feat: UUID validation audit, TypeScript any-type cleanup, user analytics pipeline, auth guards |
| `5c2a68b651` | 2026-03-21T21:16 | feat: SSE chat contract hardening + ACE/evidence bug fixes + Vitest regression suite |
...
> Directory: sveltekit-frontend/src/routes/(app)/global-search
...
- `graph_search({ query: "global-search", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "(app) global-search", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/global-search/<file>" })` — fetch any file's contents (sandboxed to src/)
