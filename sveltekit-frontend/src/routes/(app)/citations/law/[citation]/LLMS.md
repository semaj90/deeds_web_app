# AGENTS.md — `sveltekit-frontend/src/routes/(app)/citations/law/[citation]`
...
> Directory: sveltekit-frontend/src/routes/(app)/citations/law/[citation]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/citations/law/[citation]/<file>" })` — fetch any file's contents (sandboxed to src/)
