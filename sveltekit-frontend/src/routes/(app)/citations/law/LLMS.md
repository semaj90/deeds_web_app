# LLMS.md — `sveltekit-frontend/src/routes/(app)/citations/law`
...
> Directory: sveltekit-frontend/src/routes/(app)/citations/law
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/citations/law/<file>" })` — fetch any file's contents (sandboxed to src/)
