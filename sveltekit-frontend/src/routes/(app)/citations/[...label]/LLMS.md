# AGENTS.md — `sveltekit-frontend/src/routes/(app)/citations/[...label]`
...
> Directory: sveltekit-frontend/src/routes/(app)/citations/[...label]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/citations/[...label]/<file>" })` — fetch any file's contents (sandboxed to src/)
