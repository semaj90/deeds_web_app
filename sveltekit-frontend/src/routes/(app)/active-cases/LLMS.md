# LLMS.md — `sveltekit-frontend/src/routes/(app)/active-cases`
...
> Directory: sveltekit-frontend/src/routes/(app)/active-cases
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/active-cases/<file>" })` — fetch any file's contents (sandboxed to src/)
