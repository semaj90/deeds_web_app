# LLMS.md — `sveltekit-frontend/src/routes/(app)/code-intel/clusters`
...
> Directory: sveltekit-frontend/src/routes/(app)/code-intel/clusters
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/clusters/<file>" })` — fetch any file's contents (sandboxed to src/)
