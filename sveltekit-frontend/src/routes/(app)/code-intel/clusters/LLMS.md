...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/clusters/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/clusters/+server.ts" })`
