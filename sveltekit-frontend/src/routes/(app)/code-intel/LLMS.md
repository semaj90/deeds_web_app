# LLMS.md — `sveltekit-frontend/src/routes/(app)/code-intel`
...
> Directory: sveltekit-frontend/src/routes/(app)/code-intel
...
- `wiki_note_lookup({ query: "(app) code-intel", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/<file>" })` — fetch any file's contents (sandboxed to src/)
