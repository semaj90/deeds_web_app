# AGENTS.md — `src/routes/(app)/code-intel/topology`
...
> Directory: src/routes/(app)/code-intel/topology
...
- `read_file({ filePath: "src/routes/(app)/code-intel/topology/<file>" })` — fetch any file's contents (sandboxed to src/)
