...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/audit/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/audit/+server.ts" })`
