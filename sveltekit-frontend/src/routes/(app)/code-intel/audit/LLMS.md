# LLMS.md — `sveltekit-frontend/src/routes/(app)/code-intel/audit`
...
> Directory: sveltekit-frontend/src/routes/(app)/code-intel/audit
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/audit/<file>" })` — fetch any file's contents (sandboxed to src/)
