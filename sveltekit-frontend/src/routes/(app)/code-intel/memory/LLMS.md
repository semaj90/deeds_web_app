...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/memory/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/memory/+server.ts" })`
