# LLMS.md — `sveltekit-frontend/src/routes/(app)/code-intel/memory`
...
> Directory: sveltekit-frontend/src/routes/(app)/code-intel/memory
...
- `wiki_note_lookup({ query: "code-intel memory", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/memory/<file>" })` — fetch any file's contents (sandboxed to src/)
