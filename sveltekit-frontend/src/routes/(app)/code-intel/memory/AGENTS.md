# AGENTS.md — `src/routes/(app)/code-intel/memory`
...
> Directory: src/routes/(app)/code-intel/memory
...
- `read_file({ filePath: "src/routes/(app)/code-intel/memory/<file>" })` — fetch any file's contents (sandboxed to src/)
