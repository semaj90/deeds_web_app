# LLMS.md — `sveltekit-frontend/src/routes/(app)/code-intel/wiki`
...
> Directory: sveltekit-frontend/src/routes/(app)/code-intel/wiki
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/wiki/<file>" })` — fetch any file's contents (sandboxed to src/)
