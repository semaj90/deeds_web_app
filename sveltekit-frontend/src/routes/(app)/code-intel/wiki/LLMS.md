...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/wiki/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/wiki/+server.ts" })`
