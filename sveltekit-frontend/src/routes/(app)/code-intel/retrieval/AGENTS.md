# AGENTS.md — `src/routes/(app)/code-intel/retrieval`
...
> Directory: src/routes/(app)/code-intel/retrieval
...
- `read_file({ filePath: "src/routes/(app)/code-intel/retrieval/<file>" })` — fetch any file's contents (sandboxed to src/)
