...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/retrieval/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/code-intel/retrieval/+server.ts" })`
