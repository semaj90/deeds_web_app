# LLMS.md — `sveltekit-frontend/src/routes/(app)/terminal`
...
> Directory: sveltekit-frontend/src/routes/(app)/terminal
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/terminal/<file>" })` — fetch any file's contents (sandboxed to src/)
