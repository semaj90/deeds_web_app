# AGENTS.md — `sveltekit-frontend/src/routes/(app)/reports/[id]`
...
> Directory: sveltekit-frontend/src/routes/(app)/reports/[id]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/reports/[id]/<file>" })` — fetch any file's contents (sandboxed to src/)
