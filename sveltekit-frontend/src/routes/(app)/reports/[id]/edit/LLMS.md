# AGENTS.md — `sveltekit-frontend/src/routes/(app)/reports/[id]/edit`
...
> Directory: sveltekit-frontend/src/routes/(app)/reports/[id]/edit
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/reports/[id]/edit/<file>" })` — fetch any file's contents (sandboxed to src/)
