# AGENTS.md — `src/routes/(app)/admin/unified-indexing-studio`
...
> Directory: src/routes/(app)/admin/unified-indexing-studio
...
- `read_file({ filePath: "src/routes/(app)/admin/unified-indexing-studio/<file>" })` — fetch any file's contents (sandboxed to src/)
