# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/unified-indexing-studio`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/unified-indexing-studio
...
- `graph_search({ query: "unified-indexing-studio", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "admin unified-indexing-studio", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/unified-indexing-studio/<file>" })` — fetch any file's contents (sandboxed to src/)
