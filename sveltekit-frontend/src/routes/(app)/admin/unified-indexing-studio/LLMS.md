...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/unified-indexing-studio/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/unified-indexing-studio/+server.ts" })`
