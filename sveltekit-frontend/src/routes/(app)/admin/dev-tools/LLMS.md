# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/dev-tools`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/dev-tools
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/dev-tools/<file>" })` — fetch any file's contents (sandboxed to src/)
