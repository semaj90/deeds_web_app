# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/dev-tools/component-showcase`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/dev-tools/component-showcase
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/dev-tools/component-showcase/<file>" })` — fetch any file's contents (sandboxed to src/)
