# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/codebase-index`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/codebase-index
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/codebase-index/<file>" })` — fetch any file's contents (sandboxed to src/)
