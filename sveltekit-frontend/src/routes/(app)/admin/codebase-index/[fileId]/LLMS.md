# AGENTS.md — `sveltekit-frontend/src/routes/(app)/admin/codebase-index/[fileId]`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/codebase-index/[fileId]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/codebase-index/[fileId]/<file>" })` — fetch any file's contents (sandboxed to src/)
