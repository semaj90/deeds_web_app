# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/knowledge-base`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/knowledge-base
...
- `graph_search({ query: "knowledge-base", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "admin knowledge-base", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/knowledge-base/<file>" })` — fetch any file's contents (sandboxed to src/)
