...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/knowledge-base/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/knowledge-base/+server.ts" })`
