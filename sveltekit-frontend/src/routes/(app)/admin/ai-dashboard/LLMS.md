...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/+server.ts" })`
