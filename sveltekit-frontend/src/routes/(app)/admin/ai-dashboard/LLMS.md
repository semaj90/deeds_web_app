# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/ai-dashboard`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/ai-dashboard
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/<file>" })` — fetch any file's contents (sandboxed to src/)
