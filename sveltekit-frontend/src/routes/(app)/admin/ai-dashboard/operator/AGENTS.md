# AGENTS.md — `src/routes/(app)/admin/ai-dashboard/operator`
...
> Directory: src/routes/(app)/admin/ai-dashboard/operator
...
- `read_file({ filePath: "src/routes/(app)/admin/ai-dashboard/operator/<file>" })` — fetch any file's contents (sandboxed to src/)
