...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/lab/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/lab/+server.ts" })`
