# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/lab`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/lab
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/ai-dashboard/lab/<file>" })` — fetch any file's contents (sandboxed to src/)
