# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/search-intelligence`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/search-intelligence
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/search-intelligence/<file>" })` — fetch any file's contents (sandboxed to src/)
