...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/search-intelligence/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/search-intelligence/+server.ts" })`
