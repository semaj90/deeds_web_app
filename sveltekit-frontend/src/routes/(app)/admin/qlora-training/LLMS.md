# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/qlora-training`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/qlora-training
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/qlora-training/<file>" })` — fetch any file's contents (sandboxed to src/)
