# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/ast-topology`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/ast-topology
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/ast-topology/<file>" })` — fetch any file's contents (sandboxed to src/)
