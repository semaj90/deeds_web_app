# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/chat-memory`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/chat-memory
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/chat-memory/<file>" })` — fetch any file's contents (sandboxed to src/)
