# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/library`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/library
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/library/<file>" })` — fetch any file's contents (sandboxed to src/)
