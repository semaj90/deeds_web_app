# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/cache`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/cache
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/cache/<file>" })` — fetch any file's contents (sandboxed to src/)
