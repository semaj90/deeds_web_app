# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/workflows`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/workflows
...
- `wiki_note_lookup({ query: "admin workflows", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/workflows/<file>" })` — fetch any file's contents (sandboxed to src/)
