# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/component-analysis`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/component-analysis
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/component-analysis/<file>" })` — fetch any file's contents (sandboxed to src/)
