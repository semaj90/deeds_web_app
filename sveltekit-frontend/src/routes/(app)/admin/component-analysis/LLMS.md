...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/component-analysis/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/component-analysis/+server.ts" })`
