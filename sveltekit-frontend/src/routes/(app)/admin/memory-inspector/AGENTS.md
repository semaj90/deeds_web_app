# AGENTS.md — `src/routes/(app)/admin/memory-inspector`
...
> Directory: src/routes/(app)/admin/memory-inspector
...
- `read_file({ filePath: "src/routes/(app)/admin/memory-inspector/<file>" })` — fetch any file's contents (sandboxed to src/)
