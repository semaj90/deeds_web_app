# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/knowledge-search`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/knowledge-search
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/knowledge-search/<file>" })` — fetch any file's contents (sandboxed to src/)
