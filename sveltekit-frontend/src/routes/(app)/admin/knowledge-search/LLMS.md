...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/knowledge-search/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/knowledge-search/+server.ts" })`
