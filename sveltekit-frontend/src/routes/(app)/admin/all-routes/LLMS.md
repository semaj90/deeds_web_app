# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/all-routes`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/all-routes
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/all-routes/<file>" })` — fetch any file's contents (sandboxed to src/)
