# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/phase89`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/phase89
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/phase89/<file>" })` — fetch any file's contents (sandboxed to src/)
