# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/gpu-evidence-graph`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/gpu-evidence-graph
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/gpu-evidence-graph/<file>" })` — fetch any file's contents (sandboxed to src/)
