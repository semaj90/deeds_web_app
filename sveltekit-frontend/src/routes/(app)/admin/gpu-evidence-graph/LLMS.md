...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/gpu-evidence-graph/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/gpu-evidence-graph/+server.ts" })`
