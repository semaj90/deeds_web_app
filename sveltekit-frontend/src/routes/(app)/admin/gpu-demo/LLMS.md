# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/gpu-demo`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/gpu-demo
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/gpu-demo/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/admin/gpu-demo/+server.ts" })`
