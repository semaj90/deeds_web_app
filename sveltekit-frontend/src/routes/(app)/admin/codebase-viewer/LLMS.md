# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/codebase-viewer`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/codebase-viewer
...
_Gates checked: G18, G19, G26, G21-24, G20. Run `npm run index:codebase:fast && npm run llms:write` to refresh._
## Todos + Enhancements
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/codebase-viewer/<file>" })` — fetch any file's contents (sandboxed to src/)
