# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin
...
- `wiki_note_lookup({ query: "(app) admin", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/<file>" })` — fetch any file's contents (sandboxed to src/)
