# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/error-analysis`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/error-analysis
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/error-analysis/<file>" })` — fetch any file's contents (sandboxed to src/)
