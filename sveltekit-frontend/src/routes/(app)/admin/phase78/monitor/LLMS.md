# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/phase78/monitor`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/phase78/monitor
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/phase78/monitor/<file>" })` — fetch any file's contents (sandboxed to src/)
