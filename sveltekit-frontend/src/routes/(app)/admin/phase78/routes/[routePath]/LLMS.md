# AGENTS.md — `sveltekit-frontend/src/routes/(app)/admin/phase78/routes/[routePath]`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/phase78/routes/[routePath]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/phase78/routes/[routePath]/<file>" })` — fetch any file's contents (sandboxed to src/)
