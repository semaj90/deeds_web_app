# LLMS.md — `sveltekit-frontend/src/routes/(app)/admin/error-brain`
...
> Directory: sveltekit-frontend/src/routes/(app)/admin/error-brain
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/admin/error-brain/<file>" })` — fetch any file's contents (sandboxed to src/)
