# LLMS.md — `src/routes/(app)/evidence-board`
...
<!-- generated: 2026-05-15T02:51:04.152Z · LLMS.md spec · regen: npm run llms:write -->

> Directory audit: src/routes/(app)/evidence-board
...
- Audit score: **90/100**
- no audit signals
- Tags: `src` `routes` `(app)` `route` `auth`

## Files (2)

- `src/routes/(app)/evidence-board/+page.server.ts`
- `src/routes/(app)/evidence-board/+page.server.ts`
...
- `wiki_note_lookup({ query: "(app) evidence-board", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/routes/(app)/evidence-board/<file>" })` — fetch any file's contents (sandboxed to src/)
