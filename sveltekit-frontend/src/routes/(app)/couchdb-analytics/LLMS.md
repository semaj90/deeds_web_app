# LLMS.md — `sveltekit-frontend/src/routes/(app)/couchdb-analytics`
...
> Directory: sveltekit-frontend/src/routes/(app)/couchdb-analytics
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/couchdb-analytics/<file>" })` — fetch any file's contents (sandboxed to src/)
