...
|------|-----------|-------|
| `ClusterInspector.svelte` | 0.000 | 0x8 |
| `+page.svelte` | 0.000 | 0x209 |
| `SummaryCard.svelte` | 0.000 | 0x8 |
| `ErrorPropagationGraph.svelte` | 0.000 | 0x9 |
| `DependencyChart.svelte` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/couchdb-analytics/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/couchdb-analytics/+server.ts" })`
