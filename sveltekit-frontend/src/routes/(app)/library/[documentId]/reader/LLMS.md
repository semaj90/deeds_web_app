# AGENTS.md — `sveltekit-frontend/src/routes/(app)/library/[documentId]/reader`
...
> Directory: sveltekit-frontend/src/routes/(app)/library/[documentId]/reader
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/library/[documentId]/reader/<file>" })` — fetch any file's contents (sandboxed to src/)
