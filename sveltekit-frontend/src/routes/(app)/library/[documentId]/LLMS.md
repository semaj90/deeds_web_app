# AGENTS.md — `sveltekit-frontend/src/routes/(app)/library/[documentId]`
...
> Directory: sveltekit-frontend/src/routes/(app)/library/[documentId]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/library/[documentId]/<file>" })` — fetch any file's contents (sandboxed to src/)
