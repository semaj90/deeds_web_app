# AGENTS.md — `sveltekit-frontend/src/routes/(app)/library/[documentId]/node/[nodeId]`
...
> Directory: sveltekit-frontend/src/routes/(app)/library/[documentId]/node/[nodeId]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/library/[documentId]/node/[nodeId]/<file>" })` — fetch any file's contents (sandboxed to src/)
...
|------|-----------|-------|
| `+page.server.ts` | 0.538 | 0x205 |
| `+page.svelte` | 0.538 | 0x209 |
## Audit Gates — General
