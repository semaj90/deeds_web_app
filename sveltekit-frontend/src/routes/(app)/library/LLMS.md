# LLMS.md — `sveltekit-frontend/src/routes/(app)/library`
...
> Directory: sveltekit-frontend/src/routes/(app)/library
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/library/<file>" })` — fetch any file's contents (sandboxed to src/)
