# LLMS.md — `sveltekit-frontend/src/routes/(app)/library/glossary`
...
> Directory: sveltekit-frontend/src/routes/(app)/library/glossary
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/library/glossary/<file>" })` — fetch any file's contents (sandboxed to src/)
