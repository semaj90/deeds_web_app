...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/library/glossary/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/library/glossary/+server.ts" })`
