# LLMS.md — `sveltekit-frontend/src/routes/(app)/library/corpus`
...
> Directory: sveltekit-frontend/src/routes/(app)/library/corpus
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/library/corpus/<file>" })` — fetch any file's contents (sandboxed to src/)
