# LLMS.md — `sveltekit-frontend/src/routes/(app)/evidence/upload`
...
> Directory: sveltekit-frontend/src/routes/(app)/evidence/upload
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/evidence/upload/<file>" })` — fetch any file's contents (sandboxed to src/)
