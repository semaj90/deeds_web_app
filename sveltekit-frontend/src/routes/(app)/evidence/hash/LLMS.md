# LLMS.md — `sveltekit-frontend/src/routes/(app)/evidence/hash`
...
> Directory: sveltekit-frontend/src/routes/(app)/evidence/hash
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/evidence/hash/<file>" })` — fetch any file's contents (sandboxed to src/)
