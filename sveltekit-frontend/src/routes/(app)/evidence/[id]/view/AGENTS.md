# AGENTS.md — `src/routes/(app)/evidence/[id]/view`
...
> Directory: src/routes/(app)/evidence/[id]/view
...
- `read_file({ filePath: "src/routes/(app)/evidence/[id]/view/<file>" })` — fetch any file's contents (sandboxed to src/)
