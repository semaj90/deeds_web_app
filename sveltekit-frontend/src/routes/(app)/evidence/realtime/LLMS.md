# LLMS.md — `sveltekit-frontend/src/routes/(app)/evidence/realtime`
...
> Directory: sveltekit-frontend/src/routes/(app)/evidence/realtime
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/evidence/realtime/<file>" })` — fetch any file's contents (sandboxed to src/)
