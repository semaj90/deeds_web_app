# LLMS.md — `sveltekit-frontend/src/routes/(app)/evidence/analyze`
...
> Directory: sveltekit-frontend/src/routes/(app)/evidence/analyze
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/evidence/analyze/<file>" })` — fetch any file's contents (sandboxed to src/)
