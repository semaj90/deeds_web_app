...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/evidence/analyze/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/evidence/analyze/+server.ts" })`
