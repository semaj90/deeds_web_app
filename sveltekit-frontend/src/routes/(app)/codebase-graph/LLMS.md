# LLMS.md — `sveltekit-frontend/src/routes/(app)/codebase-graph`
...
> Directory: sveltekit-frontend/src/routes/(app)/codebase-graph
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/codebase-graph/<file>" })` — fetch any file's contents (sandboxed to src/)
