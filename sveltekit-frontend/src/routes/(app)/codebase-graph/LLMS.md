...
|------|-----------|-------|
| `CodebaseGraphSidebar.svelte` | 0.000 | 0x9 |
| `CodebaseGraphCanvas.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/codebase-graph/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/codebase-graph/+server.ts" })`
