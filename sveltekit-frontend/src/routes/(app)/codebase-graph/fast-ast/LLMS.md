# LLMS.md — `sveltekit-frontend/src/routes/(app)/codebase-graph/fast-ast`
...
> Directory: sveltekit-frontend/src/routes/(app)/codebase-graph/fast-ast
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/codebase-graph/fast-ast/<file>" })` — fetch any file's contents (sandboxed to src/)
