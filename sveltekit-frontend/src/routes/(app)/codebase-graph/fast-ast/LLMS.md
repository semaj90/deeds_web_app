...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/codebase-graph/fast-ast/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/codebase-graph/fast-ast/+server.ts" })`
