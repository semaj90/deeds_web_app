# AGENTS.md — `sveltekit-frontend/src/routes/(app)/chat/[id]`
...
> Directory: sveltekit-frontend/src/routes/(app)/chat/[id]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/chat/[id]/<file>" })` — fetch any file's contents (sandboxed to src/)
