# LLMS.md — `sveltekit-frontend/src/routes/(app)/chat`
...
> Directory: sveltekit-frontend/src/routes/(app)/chat
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/chat/<file>" })` — fetch any file's contents (sandboxed to src/)
