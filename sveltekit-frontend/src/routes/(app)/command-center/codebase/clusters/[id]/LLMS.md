# AGENTS.md — `sveltekit-frontend/src/routes/(app)/command-center/codebase/clusters/[id]`
...
> Directory: sveltekit-frontend/src/routes/(app)/command-center/codebase/clusters/[id]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/codebase/clusters/[id]/<file>" })` — fetch any file's contents (sandboxed to src/)
