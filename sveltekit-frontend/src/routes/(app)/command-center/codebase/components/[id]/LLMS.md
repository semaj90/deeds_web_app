# AGENTS.md — `sveltekit-frontend/src/routes/(app)/command-center/codebase/components/[id]`
...
> Directory: sveltekit-frontend/src/routes/(app)/command-center/codebase/components/[id]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/codebase/components/[id]/<file>" })` — fetch any file's contents (sandboxed to src/)
