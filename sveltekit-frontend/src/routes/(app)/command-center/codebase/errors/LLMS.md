# LLMS.md — `sveltekit-frontend/src/routes/(app)/command-center/codebase/errors`
...
> Directory: sveltekit-frontend/src/routes/(app)/command-center/codebase/errors
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/codebase/errors/<file>" })` — fetch any file's contents (sandboxed to src/)
