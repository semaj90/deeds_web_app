...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/codebase/errors/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/codebase/errors/+server.ts" })`
