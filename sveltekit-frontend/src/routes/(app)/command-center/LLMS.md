# LLMS.md — `sveltekit-frontend/src/routes/(app)/command-center`
...
> Directory: sveltekit-frontend/src/routes/(app)/command-center
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/<file>" })` — fetch any file's contents (sandboxed to src/)
