...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/command-center/+server.ts" })`
