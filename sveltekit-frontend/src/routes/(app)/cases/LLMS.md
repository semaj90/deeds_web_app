# LLMS.md — `sveltekit-frontend/src/routes/(app)/cases`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/<file>" })` — fetch any file's contents (sandboxed to src/)
