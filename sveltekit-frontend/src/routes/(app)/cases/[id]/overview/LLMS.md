# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/overview`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/overview
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/overview/<file>" })` — fetch any file's contents (sandboxed to src/)
