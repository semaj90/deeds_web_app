# AGENTS.md — `src/routes/(app)/cases/[id]/chat`
...
| `a925318b7f` | 2026-02-15T16:38 | Session 33: RAG pipeline proven end-to-end — SSE chat, multi-collection Qdrant, confidence scoring |
...
> Directory: src/routes/(app)/cases/[id]/chat
...
- `read_file({ filePath: "src/routes/(app)/cases/[id]/chat/<file>" })` — fetch any file's contents (sandboxed to src/)
