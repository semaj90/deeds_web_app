# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/chat`
...
| `0a662e2b72` | 2026-04-03T23:44 | Checkpoint legal AI platform updates |
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/chat
...
- `wiki_note_lookup({ query: "[id] chat", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/chat/<file>" })` — fetch any file's contents (sandboxed to src/)
