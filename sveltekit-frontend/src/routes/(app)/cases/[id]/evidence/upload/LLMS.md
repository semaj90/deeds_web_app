# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/evidence/upload`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/evidence/upload
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/evidence/upload/<file>" })` — fetch any file's contents (sandboxed to src/)
