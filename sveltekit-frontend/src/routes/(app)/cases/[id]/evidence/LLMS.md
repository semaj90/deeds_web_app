# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/evidence`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/evidence
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/evidence/<file>" })` — fetch any file's contents (sandboxed to src/)
