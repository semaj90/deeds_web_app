# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/ai`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/ai
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/ai/<file>" })` — fetch any file's contents (sandboxed to src/)
