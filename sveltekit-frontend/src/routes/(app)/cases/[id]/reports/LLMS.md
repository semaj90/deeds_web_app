# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/reports`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/reports
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/reports/<file>" })` — fetch any file's contents (sandboxed to src/)
