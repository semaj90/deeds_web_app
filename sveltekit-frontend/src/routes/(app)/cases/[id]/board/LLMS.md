# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/board`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/board
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/board/<file>" })` — fetch any file's contents (sandboxed to src/)
