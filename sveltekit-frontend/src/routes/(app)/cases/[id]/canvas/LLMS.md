# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/canvas`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/canvas
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/canvas/<file>" })` — fetch any file's contents (sandboxed to src/)
