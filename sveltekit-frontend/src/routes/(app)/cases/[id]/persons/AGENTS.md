# AGENTS.md — `src/routes/(app)/cases/[id]/persons`
...
| `a1fa37db78` | 2026-02-23T10:14 | Session 93r6: Fix cases/[id]/ai + persons pages, fix $types import |
| `49376649aa` | 2026-02-23T09:55 | Session 93r6: Fix last broken route + add 3 missing API endpoints |
...
> Directory: src/routes/(app)/cases/[id]/persons
...
- `read_file({ filePath: "src/routes/(app)/cases/[id]/persons/<file>" })` — fetch any file's contents (sandboxed to src/)
