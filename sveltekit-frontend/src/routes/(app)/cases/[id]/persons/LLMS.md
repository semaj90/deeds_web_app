# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/persons`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/persons
...
- `graph_search({ query: "persons", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "[id] persons", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/persons/<file>" })` — fetch any file's contents (sandboxed to src/)
