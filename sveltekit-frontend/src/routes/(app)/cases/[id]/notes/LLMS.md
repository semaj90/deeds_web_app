# AGENTS.md — `sveltekit-frontend/src/routes/(app)/cases/[id]/notes`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/[id]/notes
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/[id]/notes/<file>" })` — fetch any file's contents (sandboxed to src/)
