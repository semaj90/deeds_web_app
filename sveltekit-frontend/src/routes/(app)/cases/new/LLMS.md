...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/new/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/routes/(app)/cases/new/+server.ts" })`
