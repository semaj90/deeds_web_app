# LLMS.md — `sveltekit-frontend/src/routes/(app)/cases/new`
...
> Directory: sveltekit-frontend/src/routes/(app)/cases/new
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(app)/cases/new/<file>" })` — fetch any file's contents (sandboxed to src/)
