# AGENTS.md — `sveltekit-frontend/src/routes/(analysis)/audio-analysis/[evidenceId]`
...
> Directory: sveltekit-frontend/src/routes/(analysis)/audio-analysis/[evidenceId]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(analysis)/audio-analysis/[evidenceId]/<file>" })` — fetch any file's contents (sandboxed to src/)
