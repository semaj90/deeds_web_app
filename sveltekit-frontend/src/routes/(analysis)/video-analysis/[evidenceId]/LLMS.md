# AGENTS.md — `sveltekit-frontend/src/routes/(analysis)/video-analysis/[evidenceId]`
...
> Directory: sveltekit-frontend/src/routes/(analysis)/video-analysis/[evidenceId]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(analysis)/video-analysis/[evidenceId]/<file>" })` — fetch any file's contents (sandboxed to src/)
