# LLMS.md — `sveltekit-frontend/src/routes/(analysis)`
...
> Directory: sveltekit-frontend/src/routes/(analysis)
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(analysis)/<file>" })` — fetch any file's contents (sandboxed to src/)
