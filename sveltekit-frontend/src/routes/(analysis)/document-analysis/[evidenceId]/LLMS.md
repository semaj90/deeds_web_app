# AGENTS.md — `sveltekit-frontend/src/routes/(analysis)/document-analysis/[evidenceId]`
...
> Directory: sveltekit-frontend/src/routes/(analysis)/document-analysis/[evidenceId]
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/(analysis)/document-analysis/[evidenceId]/<file>" })` — fetch any file's contents (sandboxed to src/)
