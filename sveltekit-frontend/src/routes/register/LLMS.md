# LLMS.md — `sveltekit-frontend/src/routes/register`
...
> Directory: sveltekit-frontend/src/routes/register
...
- `read_file({ filePath: "sveltekit-frontend/src/routes/register/<file>" })` — fetch any file's contents (sandboxed to src/)
