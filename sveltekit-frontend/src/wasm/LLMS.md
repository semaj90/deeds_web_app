# LLMS.md — `sveltekit-frontend/src/wasm`
...
> Directory: sveltekit-frontend/src/wasm
...
- `read_file({ filePath: "sveltekit-frontend/src/wasm/<file>" })` — fetch any file's contents (sandboxed to src/)
