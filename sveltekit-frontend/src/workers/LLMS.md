# LLMS.md — `sveltekit-frontend/src/workers`
...
> Directory: sveltekit-frontend/src/workers
...
- `read_file({ filePath: "sveltekit-frontend/src/workers/<file>" })` — fetch any file's contents (sandboxed to src/)
