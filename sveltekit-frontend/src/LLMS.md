...
|------|-----------|-------|
| `hooks.server.ts` | 1.159 | 0x7 |
| `poi-store.ts` | 0.564 | 0x8 |
| `qdrant-client.ts` | 0.541 | 0xa |
| `pgvector-search.ts` | 0.502 | 0x9 |
| `service-worker.ts` | 0.436 | 0x8 |
| `mcp-gpu-orchestrator.ts` | 0.150 | 0x9 |
| `localDocs.svelte.ts` | 0.150 | 0x9 |
| `test-setup.ts` | 0.150 | 0x9 |
| `minio.ts` | 0.150 | 0x9 |
| `hooks.client.ts` | 0.150 | 0xb |
## Audit Gates — General
