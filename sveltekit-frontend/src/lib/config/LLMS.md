...
|------|-----------|-------|
| `redis-config.ts` | 0.863 | 0x9 |
| `env.server.ts` | 0.491 | 0x5 |
| `database.ts` | 0.491 | 0x9 |
| `pgvector-gpu-config.js` | 0.150 | 0x8 |
| `env.ts` | 0.150 | 0x8 |
| `retro-console-palettes.ts` | 0.150 | 0x8 |
| `themes.ts` | 0.150 | 0x8 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/config/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/config/+server.ts" })`
