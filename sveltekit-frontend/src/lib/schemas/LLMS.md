# LLMS.md — `sveltekit-frontend/src/lib/schemas`
...
> Directory: sveltekit-frontend/src/lib/schemas
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/schemas/<file>" })` — fetch any file's contents (sandboxed to src/)
