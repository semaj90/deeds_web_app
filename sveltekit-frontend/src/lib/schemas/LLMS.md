...
|------|-----------|-------|
| `evidence-upload.ts` | 0.721 | 0x9 |
| `board.ts` | 0.471 | 0x9 |
| `evidence.ts` | 0.427 | 0x9 |
| `forms.ts` | 0.150 | 0x9 |
| `auth.ts` | 0.150 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/schemas/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/schemas/+server.ts" })`
