# LLMS.md — `sveltekit-frontend/src/lib/schemas/tools`
...
> Directory: sveltekit-frontend/src/lib/schemas/tools
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/schemas/tools/<file>" })` — fetch any file's contents (sandboxed to src/)
