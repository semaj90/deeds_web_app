# LLMS.md — `sveltekit-frontend/src/lib/shared`
...
> Directory: sveltekit-frontend/src/lib/shared
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/shared/<file>" })` — fetch any file's contents (sandboxed to src/)
