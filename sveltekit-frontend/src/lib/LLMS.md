...
|------|-----------|-------|
| `AGENTS.md` | 0.556 | - |
| `uno-shortcuts.ts` | 0.533 | 0x8 |
| `types.ts` | 0.477 | 0x8 |
| `env.server.ts` | 0.471 | 0x5 |
| `stores.svelte.ts` | 0.471 | 0x8 |
| `polyfills.ts` | 0.459 | 0x8 |
| `ClientEmbeddingGemma.README.md` | 0.458 | - |
| `schemas.ts` | 0.150 | 0x9 |
| `index.ts` | 0.150 | 0x9 |
| `command-center-manifest.ts` | 0.150 | 0x8 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/+server.ts" })`
