...
|------|-----------|-------|
| `EvidenceChatPane.svelte` | 0.531 | 0x8 |
| `EvidenceGraphPane.svelte` | 0.150 | 0x8 |
| `EvidenceCommandPalette.svelte` | 0.150 | 0x9 |
| `EvidenceBoardPane.svelte` | 0.150 | 0x9 |
| `CommandCenterShell.svelte` | 0.150 | 0x9 |
## Audit Gates — General
