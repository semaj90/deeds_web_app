...
|------|-----------|-------|
| `EvidenceGraphPane.svelte` | 0.000 | 0x8 |
| `EvidenceCommandPalette.svelte` | 0.000 | 0x9 |
| `EvidenceChatPane.svelte` | 0.000 | 0x8 |
| `EvidenceBoardPane.svelte` | 0.000 | 0x9 |
| `CommandCenterShell.svelte` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/features/evidence-command-center/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/features/evidence-command-center/+server.ts" })`
