# LLMS.md — `sveltekit-frontend/src/lib/features/evidence-command-center`
...
> Directory: sveltekit-frontend/src/lib/features/evidence-command-center
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/features/evidence-command-center/<file>" })` — fetch any file's contents (sandboxed to src/)
