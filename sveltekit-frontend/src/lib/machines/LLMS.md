...
|------|-----------|-------|
| `evidence-analysis-machine.ts` | 0.000 | 0x9 |
| `document-upload-machine.ts` | 0.000 | 0x9 |
| `auth-machine.ts` | 0.000 | 0x9 |
| `userTypingStateMachine.ts` | 0.000 | 0x9 |
| `evidenceCustodyMachine.ts` | 0.000 | 0x9 |
| `evidence-processing-machine.ts` | 0.000 | 0x9 |
| `uploadMachine.ts` | 0.000 | 0x9 |
| `retrieval-machine.ts` | 0.000 | 0x9 |
| `audio-upload-machine.ts` | 0.000 | 0x9 |
| `AIAssistantMachineComponent.svelte` | 0.000 | 0x9 |
## Audit Gates — General
