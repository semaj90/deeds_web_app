# LLMS.md — `sveltekit-frontend/src/lib/server/cartridge`
...
> Directory: sveltekit-frontend/src/lib/server/cartridge
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/cartridge/<file>" })` — fetch any file's contents (sandboxed to src/)
