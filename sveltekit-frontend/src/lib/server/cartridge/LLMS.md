...
|------|-----------|-------|
| `chr97-builder.ts` | 0.000 | 0x9 |
| `glyph-tile-engine.ts` | 0.000 | 0xb |
| `glyph-mappers.ts` | 0.000 | 0x9 |
| `index.ts` | 0.000 | 0x8 |
| `glyph-record.ts` | 0.000 | 0xb |
## Audit Gates — Cartridge / Glyph Tiles
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/cartridge/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/cartridge/+server.ts" })`
