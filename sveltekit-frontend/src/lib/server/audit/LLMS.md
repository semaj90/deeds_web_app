...
|------|-----------|-------|
| `gemma-tool-router.ts` | 0.000 | 0xb |
| `evidence-audit.ts` | 0.000 | 0x9 |
| `api-audit-buffer.ts` | 0.000 | 0x9 |
| `gpu-audit-orchestrator.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/audit/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/audit/+server.ts" })`
