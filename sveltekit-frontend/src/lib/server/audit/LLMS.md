# LLMS.md — `sveltekit-frontend/src/lib/server/audit`
...
> Directory: sveltekit-frontend/src/lib/server/audit
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/audit/<file>" })` — fetch any file's contents (sandboxed to src/)
