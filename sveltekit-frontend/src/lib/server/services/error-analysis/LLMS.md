...
- [ ] **test-coverage** `src/lib/server/services/error-analysis/types.ts` fanIn=14 — add G26-pattern test (14 consumers depend on this)
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/services/error-analysis/<file>" })` — fetch any file's contents (sandboxed to src/)
