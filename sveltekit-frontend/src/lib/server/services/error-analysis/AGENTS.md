# AGENTS.md — `src/lib/server/services/error-analysis`
...
> Directory: src/lib/server/services/error-analysis
...
- `read_file({ filePath: "src/lib/server/services/error-analysis/<file>" })` — fetch any file's contents (sandboxed to src/)
