...
|------|-----------|-------|
| `qdrant-client.ts` | 0.000 | 0x9 |
| `report-auto-populator.ts` | 0.000 | 0xb |
| `pipeline-orchestrator.ts` | 0.000 | 0x9 |
| `langextract-service.ts` | 0.000 | 0xb |
| `couchdb-client.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/services/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/services/+server.ts" })`
