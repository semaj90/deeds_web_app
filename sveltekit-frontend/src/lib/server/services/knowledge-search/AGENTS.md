# AGENTS.md — `src/lib/server/services/knowledge-search`
...
> Directory: src/lib/server/services/knowledge-search
...
- `read_file({ filePath: "src/lib/server/services/knowledge-search/<file>" })` — fetch any file's contents (sandboxed to src/)
