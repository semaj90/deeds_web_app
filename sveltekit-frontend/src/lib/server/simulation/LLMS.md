# LLMS.md — `sveltekit-frontend/src/lib/server/simulation`
...
> Directory: sveltekit-frontend/src/lib/server/simulation
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/simulation/<file>" })` — fetch any file's contents (sandboxed to src/)
