...
|------|-----------|-------|
| `grpo-strategy.ts` | 0.000 | 0xb |
| `grpo-types.ts` | 0.000 | 0x8 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/simulation/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/simulation/+server.ts" })`
