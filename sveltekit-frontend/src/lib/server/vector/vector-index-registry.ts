...
export const VECTOR_INDEX_REGISTRY = {
  ...
  qdrantSource768V2: {
    ...
    name: 'Qdrant canonical semantic_768 index',
    backend: 'qdrant-hnsw',
    contractVersion: EMBEDDINGGEMMA_FULL768_V1,
    vectorContract: EMBEDDINGGEMMA_FULL768_CONTRACT,
    ...
    notes: 'Active rebuildable Qdrant projection for native EmbeddingGemma semantic_768; PostgreSQL owns canonical identity and lineage.',
  },
  qdrantSource768: {
    id: 'qdrant-codebase-chunks-768',
    name: 'Qdrant pre-v2 768-dim source index',
    backend: 'qdrant-hnsw',
    contractVersion: EMBEDDINGGEMMA_FULL768_V1,
    vectorContract: EMBEDDINGGEMMA_FULL768_CONTRACT,
    ...
    notes: 'Native 768 source/reference collection retained for parity checks; it is not the active runtime projection after the v2 cutover.',
  },
  qdrantDense: {
