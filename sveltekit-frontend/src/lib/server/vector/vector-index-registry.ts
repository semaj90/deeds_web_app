...
export const VECTOR_INDEX_REGISTRY = {
  ...
  qdrantHybrid: {
    ...
    notes: 'Legacy 384 retrieval lane kept for migration/reference only; canonical production retrieval is codebase_chunks_768_v2.',
  },
  qdrantSource768V2: {
    id: 'qdrant-codebase-chunks-768-v2',
    name: 'Qdrant canonical 768-dim semantic index',
    backend: 'qdrant-hnsw',
    ...
    notes: 'Canonical dense lane for production retrieval proof and cutover validation.',
  },
  qdrantSource768: {
    ...
    notes: 'Native EmbeddingGemma source lane; keep separate from legacy 384 retrieval projection and sparse/multivector lanes.',
  },
  qdrantDense: {
    id: 'qdrant-codebase-chunks-384',
    name: 'Legacy dense fallback retrieval index',
    backend: 'qdrant-hnsw',
    contractVersion: ATLAS_EMBEDDINGGEMMA_DIRECT_SLICE384_V1,
    vectorContract: EMBEDDINGGEMMA_PREFIX384_CONTRACT,
