...
|------|-----------|-------|
| `qdrant-manager.ts` | 26.000 | 0xb |
| `bm42-sparse.ts` | 5.000 | 0x8 |
| `hypergraph-service.ts` | 0.000 | 0x9 |
| `quantize.ts` | 0.000 | 0x8 |
| `qdrant-health.ts` | 0.000 | 0xb |
| `pgvector.ts` | 0.000 | 0x9 |
| `image-search.ts` | 0.000 | 0xb |
| `embedding-gemma.ts` | 0.000 | 0x9 |
| `qdrant-api-wrapper.ts` | 0.000 | 0x9 |
| `multi-store.ts` | 0.000 | 0x9 |
