# AGENTS.md — `src/lib/server/phase72`
...
> Directory audit: src/lib/server/phase72
...
- `src/lib/server/phase72/astVectorizer.ts`
...
- `read_file({ filePath: "src/lib/server/phase72/<file>" })` — fetch any file's contents (sandboxed to src/)
