...
| `warm-up.ts` | 0.000 | 0x9 |
| `code-llm-index.ts` | 0.000 | 0xb |
| `cluster-summary-forest.ts` | 0.000 | 0xb |
| `topo-candidate-cache.ts` | 0.000 | 0x9 |
| `rpc-cache.ts` | 0.000 | 0x9 |
| `pdf-export-cache.ts` | 0.000 | 0x9 |
| `invalidation.ts` | 0.000 | 0xb |
| `dag-cache.ts` | 0.000 | 0xb |
| `cartridge-tensor-bridge.ts` | 0.000 | 0xb |
