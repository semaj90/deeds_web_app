...
|------|-----------|-------|
| `compare.ts` | 0.000 | 0x9 |
| `analysis.ts` | 0.000 | 0x9 |
| `summarize.ts` | 0.000 | 0xb |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/pgai/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/pgai/+server.ts" })`
