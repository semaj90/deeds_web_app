# LLMS.md — `sveltekit-frontend/src/lib/server/pgai`
...
> Directory: sveltekit-frontend/src/lib/server/pgai
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/pgai/<file>" })` — fetch any file's contents (sandboxed to src/)
