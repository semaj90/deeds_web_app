...
export const SemanticRepresentationAuthorityV2Schema = z.enum([
  'semantic_768',
  'semantic_mrl_512',
  'semantic_mrl_256',
  'semantic_mrl_128',
  // Compatibility identifier retained for historical callers only.
  'semantic_512',
]);
...
export const DEFAULT_RETRIEVAL_EXECUTOR_CAPABILITIES_V2: readonly RetrievalExecutorCapabilityV2[] = [
  ...
  { id:'diskann_vamana', status:'CONFIGURED_UNPROVEN', logicalLane:'semantic', mode:'query-and-build', supportedRepresentations:['semantic_768','semantic_mrl_512','semantic_mrl_256','semantic_mrl_128','semantic_512'], exact:false, approximate:true, gpu:false, persistentIndex:true, onDiskCapable:true, evidenceAuthority:false, notes:'DiskANN/Vamana SSD-oriented ANN challenger.' },
