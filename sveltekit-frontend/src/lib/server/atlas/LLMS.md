...
|------|-----------|-------|
| `types.ts` | 3.000 | 0x9 |
| `master-feature-map.ts` | 3.000 | - |
| `context-for-file.ts` | 0.000 | 0xb |
| `prompt-mapper.ts` | 0.000 | 0x9 |
| `atlas-loader.ts` | 0.000 | 0x9 |
| `drizzle-sidecar-policy.spec.ts` | 0.000 | - |
| `master-feature-map.test.ts` | 0.000 | - |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/atlas/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/atlas/+server.ts" })`
