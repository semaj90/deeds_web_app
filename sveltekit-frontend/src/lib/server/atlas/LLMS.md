# LLMS.md — `sveltekit-frontend/src/lib/server/atlas`
...
> Directory: sveltekit-frontend/src/lib/server/atlas
...
- `context-for-file.ts`
- `gpu-ast-mapper.ts`
- `master-feature-map.schema.ts`
- `master-feature-map.ts`
- `prompt-mapper.ts`
- `route-feature-map.ts`
- `types.ts`
...
- `wiki_note_lookup({ query: "server atlas", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/atlas/<file>" })` — fetch any file's contents (sandboxed to src/)
