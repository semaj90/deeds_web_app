...
describe('GraphSnapshotRevisionV1', () => {
  ...
  it('changes graphRevision when logical workspace or topology changes', () => {
  ...
  it('rejects Git SHAs, cache epochs, and prose as workspaceRevision', () => {
    expect(() => buildGraphSnapshotRevisionV1({ ...fixture, workspaceRevision: 'a'.repeat(40) })).toThrow();
    expect(() => buildGraphSnapshotRevisionV1({ ...fixture, workspaceRevision: '41' })).toThrow();
    expect(() => buildGraphSnapshotRevisionV1({ ...fixture, workspaceRevision: 'git:deadbeef' })).toThrow();
  });

  it('rejects source-inventory revision drift', () => {
  ...
  it('derives sourceInventoryRevision without inventing node sourceRevision', () => {
