...
/**
 * Read-only control view used by the board projection. This is intentionally
 * structural: the board consumes an existing control packet and does not
 * establish a second transport contract owner.
 */
