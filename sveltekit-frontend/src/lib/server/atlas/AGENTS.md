# AGENTS.md — `src/lib/server/atlas`
...
| `8645c1e676` | 2026-05-07T22:01 | fix(atlas): cap unfiltered scan at 2000 files for prompt mapper |
| `89eaa3bacc` | 2026-05-07T21:55 | feat(atlas): directory-aware atlas + Zod-typed prompt mapper |
| `208ab1bc3d` | 2026-05-07T21:53 | fix(atlas/prompt-mapper): normalize Karpathy blend, alias paths, deterministic order |
...
> Directory audit: src/lib/server/atlas
...
- `read_file({ filePath: "src/lib/server/atlas/<file>" })` — fetch any file's contents (sandboxed to src/)
