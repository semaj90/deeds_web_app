...
export const DEFAULT_QDRANT_URL = (process.env.QDRANT_URL ?? 'http://127.0.0.1:6333').replace(
  /^0\.0\.0\.0/,
  '127.0.0.1'
);
...
export function emptyFieldStat() {
  return { nonNull: 0, coveragePct: 0, typeCounts: {}, distinct: 0, samples: [] };
}

export function inferFieldSchema(typeCounts) {
