...
|------|-----------|-------|
| `agents-card-store.ts` | 15.000 | 0xb |
| `trace-subagent-registry.ts` | 3.000 | 0x8 |
| `AGENTS.md` | 0.554 | - |
| `agents-context-source.ts` | 0.000 | 0x9 |
| `trace-subagent-orchestrator.ts` | 0.000 | 0x9 |
| `ontology-sortation-agent.ts` | 0.000 | 0x9 |
| `memory-encoding-agent.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/agents/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/agents/+server.ts" })`
