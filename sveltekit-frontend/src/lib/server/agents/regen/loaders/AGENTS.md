# AGENTS.md — `src/lib/server/agents/regen/loaders`
...
> Directory: src/lib/server/agents/regen/loaders
...
- `read_file({ filePath: "src/lib/server/agents/regen/loaders/<file>" })` — fetch any file's contents (sandboxed to src/)
