# AGENTS.md — `src/lib/server/agents/regen/writers`
...
> Directory: src/lib/server/agents/regen/writers
...
- `read_file({ filePath: "src/lib/server/agents/regen/writers/<file>" })` — fetch any file's contents (sandboxed to src/)
