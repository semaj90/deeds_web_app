...
|------|-----------|-------|
| `couchdb-writer.ts` | 4.000 | 0x9 |
| `qdrant-backfill.ts` | 0.000 | 0x9 |
| `markdown-writer.ts` | 0.000 | 0x9 |
| `couchdb-writer.test.ts` | 0.000 | - |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/agents/regen/writers/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/agents/regen/writers/+server.ts" })`
