# LLMS.md — `sveltekit-frontend/src/lib/server/concurrency`
...
> Directory: sveltekit-frontend/src/lib/server/concurrency
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/concurrency/<file>" })` — fetch any file's contents (sandboxed to src/)
