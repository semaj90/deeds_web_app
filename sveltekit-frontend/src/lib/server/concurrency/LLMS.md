...
|------|-----------|-------|
| `queue-manager.ts` | 0.000 | 0x9 |
| `transaction-manager.ts` | 0.000 | 0x9 |
| `advisory-locks.ts` | 0.000 | 0x8 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/concurrency/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/concurrency/+server.ts" })`
