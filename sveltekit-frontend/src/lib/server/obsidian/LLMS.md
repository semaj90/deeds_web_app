...
|------|-----------|-------|
| `wiki-vault-watcher.ts` | 0.000 | 0xb |
| `markdown-wiki-note.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/obsidian/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/obsidian/+server.ts" })`
