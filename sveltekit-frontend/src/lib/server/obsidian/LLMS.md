# LLMS.md — `sveltekit-frontend/src/lib/server/obsidian`
...
> Directory: sveltekit-frontend/src/lib/server/obsidian
...
- `markdown-wiki-note.ts`
- `wiki-vault-watcher.ts`
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/obsidian/<file>" })` — fetch any file's contents (sandboxed to src/)
