...
export class DynamicPortManager {
    ...
    private initializeServicePorts() {
        const serviceDefinitions: ServicePort[] = [
            ...
            { name: 'postgresql', basePort: 5434, portRange: [5430, 5431, 5432, 5433, 5434, 5435, 5436, 5437, 5438, 5439] },
            ...
            { name: 'binary-vector-engine', basePort: 8130, portRange: [8130, 8131, 8132, 8133, 8134, 8135, 8136, 8137, 8138, 8139] },
