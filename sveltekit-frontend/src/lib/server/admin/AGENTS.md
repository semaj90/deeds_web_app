# AGENTS.md — `src/lib/server/admin`
...
> Directory audit: src/lib/server/admin
...
- `src/lib/server/admin/ai-chat-context.ts`
- `src/lib/server/admin/ai-chat-service.ts`
- `src/lib/server/admin/browser-context-sanitizer.ts`
- `src/lib/server/admin/intent-orchestrator.ts`
- `src/lib/server/admin/model-manager.ts`
...
- `wiki_note_lookup({ query: "server admin", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/lib/server/admin/<file>" })` — fetch any file's contents (sandboxed to src/)
