...
|------|-----------|-------|
| `browser-context-sanitizer.ts` | 3.000 | 0x9 |
| `ai-chat-service.ts` | 3.000 | 0xb |
| `skills-service.ts` | 0.560 | 0x9 |
| `ai-chat-context.ts` | 0.560 | 0x9 |
| `model-manager.ts` | 0.554 | 0x9 |
| `intent-orchestrator.ts` | 0.000 | 0x9 |
| `subagent-orchestrator.ts` | 0.000 | 0x9 |
| `recommendation-engine.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/admin/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/admin/+server.ts" })`
