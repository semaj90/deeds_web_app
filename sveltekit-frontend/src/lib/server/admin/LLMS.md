# LLMS.md — `sveltekit-frontend/src/lib/server/admin`
...
> Directory: sveltekit-frontend/src/lib/server/admin
...
- `retrieval-analytics-service.ts`
- `skills-service.ts`
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/admin/<file>" })` — fetch any file's contents (sandboxed to src/)
