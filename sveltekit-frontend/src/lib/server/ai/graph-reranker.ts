...
/**
 * Signed feature-direction similarity for normalized 4-vectors.
 *
 * Historical callers named this `quaternionSimilarity`; keep the name for API
 * compatibility, but these coordinates are retrieval features, not physical
 * rotations. Therefore q and -q are opposite directions, not equivalent
 * quaternion representations. Mapping cosine from [-1,1] to [0,1] gives:
 ...
 * Missing optional signals are treated as zero and all six coefficients sum to 1.
 */
...
/**
 * Presence-aware recommendation score.
 *
