...
export const routeRuntimePackets = pgTable('route_runtime_packets', {
  ...
  (t) => [
    ...
    index('idx_rrp_feature_cluster').on(t.featureId, t.clusterId),
    index('idx_rrp_raw_domain').using('gin', sql`${t.raw} -> 'domain'`),
    index('idx_rrp_raw_feature_id').using('gin', sql`${t.raw} -> 'feature_id'`),
    index('idx_rrp_raw_gin').using('gin', t.raw),
