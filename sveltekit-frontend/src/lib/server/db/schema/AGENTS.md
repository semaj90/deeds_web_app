...
- [ ] **test-coverage** `src/lib/server/db/schema/graph-mappings.ts` fanIn=11 — add G26-pattern test (11 consumers depend on this)
...
- **Paired tests**: 9/48 files have paired tests
