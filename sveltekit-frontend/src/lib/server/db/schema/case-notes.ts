 ...
 *   sveltekit-frontend/src/lib/server/db/schema-postgres.ts:1955
 *
...
export type CaseNotes = typeof caseNotes.$inferSelect;
export type NewCaseNotes = typeof caseNotes.$inferInsert;
