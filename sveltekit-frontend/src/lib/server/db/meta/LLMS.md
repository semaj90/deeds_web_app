# LLMS.md — `sveltekit-frontend/src/lib/server/db/meta`
...
> Directory: sveltekit-frontend/src/lib/server/db/meta
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/db/meta/<file>" })` — fetch any file's contents (sandboxed to src/)
