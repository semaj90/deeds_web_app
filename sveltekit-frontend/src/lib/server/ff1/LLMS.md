# LLMS.md — `sveltekit-frontend/src/lib/server/ff1`
...
> Directory: sveltekit-frontend/src/lib/server/ff1
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/ff1/<file>" })` — fetch any file's contents (sandboxed to src/)
