...
|------|-----------|-------|
| `planner.ts` | 0.000 | 0xb |
| `registry.ts` | 0.000 | 0x8 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/ff1/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/ff1/+server.ts" })`
