# LLMS.md — `sveltekit-frontend/src/lib/server/ff1/agent`
...
> Directory: sveltekit-frontend/src/lib/server/ff1/agent
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/ff1/agent/<file>" })` — fetch any file's contents (sandboxed to src/)
