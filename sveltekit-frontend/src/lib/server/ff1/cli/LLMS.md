...
|------|-----------|-------|
| `ff1-audit.ts` | 0.000 | 0x9 |
| `ff1-propose.ts` | 0.000 | 0xb |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/ff1/cli/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/ff1/cli/+server.ts" })`
