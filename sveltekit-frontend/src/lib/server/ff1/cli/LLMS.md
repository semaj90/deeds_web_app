# LLMS.md — `sveltekit-frontend/src/lib/server/ff1/cli`
...
> Directory: sveltekit-frontend/src/lib/server/ff1/cli
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/ff1/cli/<file>" })` — fetch any file's contents (sandboxed to src/)
