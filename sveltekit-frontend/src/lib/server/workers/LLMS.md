# LLMS.md — `sveltekit-frontend/src/lib/server/workers`
...
> Directory: sveltekit-frontend/src/lib/server/workers
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/workers/<file>" })` — fetch any file's contents (sandboxed to src/)
