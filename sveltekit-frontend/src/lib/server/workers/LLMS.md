...
|------|-----------|-------|
| `document-embed-consumer.ts` | 0.000 | 0xb |
| `compute-pool.ts` | 0.000 | 0xb |
| `video-vlm-processor.ts` | 0.000 | 0xb |
| `audio-queue-consumer.ts` | 0.000 | 0x9 |
| `audio-processor.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/workers/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/workers/+server.ts" })`
