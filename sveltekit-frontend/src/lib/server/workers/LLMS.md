...
|------|-----------|-------|
| `video-vlm-processor.ts` | 0.879 | 0xb |
| `audio-queue-consumer.ts` | 0.506 | 0x9 |
| `audio-processor.ts` | 0.506 | 0x9 |
| `compute-pool.ts` | 0.490 | 0xb |
| `document-embed-consumer.ts` | 0.150 | 0xb |
## Audit Gates — General
