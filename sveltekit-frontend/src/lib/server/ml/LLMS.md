...
|------|-----------|-------|
| `topic-clustering-worker.ts` | 0.505 | 0xb |
| `som-cluster.ts` | 0.483 | 0x9 |
| `multi-modal-ranker.ts` | 0.483 | 0x9 |
| `recommendation-glyph.ts` | 0.455 | 0x9 |
| `user-history.ts` | 0.150 | 0x9 |
| `feedback-store.ts` | 0.150 | 0x8 |
| `topic-cluster.ts` | 0.150 | 0x9 |
| `recommendation-metrics.ts` | 0.150 | 0x9 |
## Audit Gates — General
