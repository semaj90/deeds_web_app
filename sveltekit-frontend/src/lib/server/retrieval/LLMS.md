...
|------|-----------|-------|
| `manifold4-search.ts` | 11.000 | 0x9 |
| `hyperrag-fusion-service.ts` | 7.000 | - |
| `codebase-context.ts` | 6.000 | 0xb |
| `prefilter.redis.ts` | 4.000 | 0x9 |
| `cross-encoder-reranker.ts` | 3.000 | 0xb |
| `prefilter.types.ts` | 3.000 | 0x8 |
| `subgraph-structural-multihop.ts` | 3.000 | - |
