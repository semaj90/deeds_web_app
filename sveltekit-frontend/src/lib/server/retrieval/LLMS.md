...
|------|-----------|-------|
| `codebase-context.ts` | 1.454 | 0xb |
| `qlora-boost.ts` | 0.533 | 0x9 |
| `document-dag.ts` | 0.533 | 0x8 |
| `graph-context.ts` | 0.533 | 0xb |
| `legal-pagerank.ts` | 0.533 | 0x8 |
| `citation-graph.ts` | 0.533 | 0x9 |
| `topological-search.ts` | 0.533 | 0xb |
| `centroid-cache.ts` | 0.511 | 0xb |
| `cross-encoder-reranker.ts` | 0.488 | 0xb |
| `context-buffer.ts` | 0.471 | 0x9 |
