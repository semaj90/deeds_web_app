# LLMS.md — `sveltekit-frontend/src/lib/server/agent`
...
> Directory: sveltekit-frontend/src/lib/server/agent
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/agent/<file>" })` — fetch any file's contents (sandboxed to src/)
