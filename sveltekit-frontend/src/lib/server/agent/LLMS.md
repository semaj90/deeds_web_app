...
|------|-----------|-------|
| `subagents.ts` | 0.417 | 0x9 |
| `supervisor.ts` | 0.150 | 0x9 |
| `autonomous-agent.ts` | 0.150 | 0xb |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/agent/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/agent/+server.ts" })`
