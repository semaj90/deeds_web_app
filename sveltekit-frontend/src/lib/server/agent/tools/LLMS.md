...
|------|-----------|-------|
| `web-search-searxng.ts` | 0.554 | - |
| `index.ts` | 0.150 | 0x8 |
| `find-files.ts` | 0.150 | 0x9 |
| `web-search.ts` | 0.150 | 0x9 |
| `ripgrep-search.ts` | 0.150 | 0x9 |
| `extract-pattern.ts` | 0.150 | 0x9 |
| `analyze-imports.ts` | 0.150 | 0x9 |
| `analyze-file.ts` | 0.150 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/agent/tools/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/agent/tools/+server.ts" })`
