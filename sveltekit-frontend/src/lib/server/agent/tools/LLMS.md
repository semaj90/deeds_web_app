# LLMS.md — `sveltekit-frontend/src/lib/server/agent/tools`
...
> Directory: sveltekit-frontend/src/lib/server/agent/tools
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/agent/tools/<file>" })` — fetch any file's contents (sandboxed to src/)
