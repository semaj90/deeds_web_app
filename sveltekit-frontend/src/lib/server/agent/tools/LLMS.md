...
|------|-----------|-------|
| `index.ts` | 0.000 | 0x8 |
| `find-files.ts` | 0.000 | 0x9 |
| `web-search.ts` | 0.000 | 0x9 |
| `ripgrep-search.ts` | 0.000 | 0x9 |
| `extract-pattern.ts` | 0.000 | 0x9 |
| `analyze-imports.ts` | 0.000 | 0x9 |
| `analyze-file.ts` | 0.000 | 0x9 |
## Audit Gates — General
