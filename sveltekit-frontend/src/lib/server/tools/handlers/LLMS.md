...
|------|-----------|-------|
| `crawlDocs.ts` | 0.520 | 0x9 |
| `kbSearch.ts` | 0.520 | 0x9 |
| `clusterTag.ts` | 0.505 | 0x9 |
| `langextractBatch.ts` | 0.449 | 0x9 |
| `chunkEmbed.ts` | 0.150 | 0x9 |
| `index.ts` | 0.150 | 0x9 |
| `scanRepo.ts` | 0.150 | 0x9 |
| `research.ts` | 0.150 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/tools/handlers/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/tools/handlers/+server.ts" })`
