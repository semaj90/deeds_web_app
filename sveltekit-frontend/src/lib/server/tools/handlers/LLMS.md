# LLMS.md — `sveltekit-frontend/src/lib/server/tools/handlers`
...
> Directory: sveltekit-frontend/src/lib/server/tools/handlers
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/tools/handlers/<file>" })` — fetch any file's contents (sandboxed to src/)
