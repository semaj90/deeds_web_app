...
|------|-----------|-------|
| `crawlDocs.ts` | 0.000 | 0x9 |
| `chunkEmbed.ts` | 0.000 | 0x9 |
| `index.ts` | 0.000 | 0x9 |
| `scanRepo.ts` | 0.000 | 0x9 |
| `research.ts` | 0.000 | 0x9 |
| `kbSearch.ts` | 0.000 | 0x9 |
| `langextractBatch.ts` | 0.000 | 0x9 |
| `clusterTag.ts` | 0.000 | 0x9 |
## Audit Gates — General
