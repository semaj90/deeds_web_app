# LLMS.md — `sveltekit-frontend/src/lib/server/hypergraph`
...
> Directory: sveltekit-frontend/src/lib/server/hypergraph
...
- `hypergraph-builder.ts`
- `hypergraph-search.ts`
- `hypergraph-sync.ts`
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/hypergraph/<file>" })` — fetch any file's contents (sandboxed to src/)
