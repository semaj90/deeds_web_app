...
|------|-----------|-------|
| `hypergraph-search.ts` | 11.000 | 0x9 |
| `hypergraph-traversal.ts` | 10.000 | 0x9 |
| `hypergraph-types.ts` | 5.000 | 0x8 |
| `hypergraph-builder.ts` | 0.000 | 0x9 |
| `hypergraph-sync.ts` | 0.000 | 0xb |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/hypergraph/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/hypergraph/+server.ts" })`
