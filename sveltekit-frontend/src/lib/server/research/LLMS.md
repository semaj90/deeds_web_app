...
|------|-----------|-------|
| `web-research-ingester.ts` | 10.000 | 0x9 |
| `research-utils.ts` | 5.000 | 0x8 |
| `reddit-search.ts` | 3.000 | 0x9 |
| `store-web-doc.ts` | 3.000 | 0x9 |
| `github-mcp.ts` | 0.000 | 0x9 |
| `chunk-web-doc.ts` | 0.000 | 0x9 |
| `research-to-wiki-encoder.ts` | 0.000 | 0x9 |
| `reddit-harvester.ts` | 0.000 | 0x9 |
| `normalize-html.ts` | 0.000 | 0x9 |
| `github-search.ts` | 0.000 | 0x9 |
## Audit Gates — General
