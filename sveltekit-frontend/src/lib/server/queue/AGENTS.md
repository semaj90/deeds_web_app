...
- server module directory with 8 files, 0 API handlers, 1 Drizzle refs, 2 TODOs
- Audit score: **93/100**
- TODOs: 2
- Tags: `src` `lib` `server` `zod` `db-schema` `has-todo`
...
- **[LOW]** [TODO] `rabbitmq-manager-fixed.ts`: TODO
- **[LOW]** [TODO] `rabbitmq-manager-fixed.ts`: TODO
