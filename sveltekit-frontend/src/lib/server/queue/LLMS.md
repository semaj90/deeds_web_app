...
|------|-----------|-------|
| `rabbitmq-manager-fixed.ts` | 14.000 | 0xb |
| `queue-worker.ts` | 6.000 | 0xa |
| `dispatch-inline.ts` | 4.000 | 0xb |
| `workflow-publish.ts` | 0.444 | 0x9 |
| `rabbitmq-client.ts` | 0.436 | 0xb |
| `rabbitmq-xstate-integration.ts` | 0.150 | 0xb |
| `job-types.ts` | 0.150 | 0x8 |
| `rabbitmq-connection.ts` | 0.150 | 0xb |
