# LLMS.md — `sveltekit-frontend/src/lib/server/error-brain/transport`
...
> Directory: sveltekit-frontend/src/lib/server/error-brain/transport
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/error-brain/transport/<file>" })` — fetch any file's contents (sandboxed to src/)
