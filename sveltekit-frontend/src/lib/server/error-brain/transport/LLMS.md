...
| `redis.ts` | 0.150 | 0xb |
| `sse.ts` | 0.150 | 0x9 |
| `factory.ts` | 0.150 | 0x9 |
| `mux.ts` | 0.150 | 0x9 |
| `interface.ts` | 0.150 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/error-brain/transport/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/error-brain/transport/+server.ts" })`
