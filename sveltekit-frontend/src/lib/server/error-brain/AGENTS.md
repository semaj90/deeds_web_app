# AGENTS.md — `src/lib/server/error-brain`
...
- Audit score: **100/100**
- no audit signals
- Tags: `src` `lib` `server` `db-schema` `auth` `zod`
...
- `wiki_note_lookup({ query: "server error-brain", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/lib/server/error-brain/<file>" })` — fetch any file's contents (sandboxed to src/)
