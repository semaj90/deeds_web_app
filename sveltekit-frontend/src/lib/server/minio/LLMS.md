# LLMS.md — `sveltekit-frontend/src/lib/server/minio`
...
> Directory: sveltekit-frontend/src/lib/server/minio
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/minio/<file>" })` — fetch any file's contents (sandboxed to src/)
