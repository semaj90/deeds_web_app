...
|------|-----------|-------|
| `native.ts` | 0.000 | 0xb |
| `bag-cache.ts` | 0.000 | 0x9 |
| `google-langextract.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/langextract/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/langextract/+server.ts" })`
