# LLMS.md — `sveltekit-frontend/src/lib/server/langextract`
...
> Directory: sveltekit-frontend/src/lib/server/langextract
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/langextract/<file>" })` — fetch any file's contents (sandboxed to src/)
