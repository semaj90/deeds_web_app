# LLMS.md — `sveltekit-frontend/src/lib/server/chrrom`
...
> Directory: sveltekit-frontend/src/lib/server/chrrom
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/chrrom/<file>" })` — fetch any file's contents (sandboxed to src/)
