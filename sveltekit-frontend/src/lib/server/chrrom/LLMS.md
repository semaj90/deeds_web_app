...
|------|-----------|-------|
| `predictor.ts` | 0.000 | 0x9 |
| `patterns.ts` | 0.000 | 0x9 |
| `bus.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/chrrom/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/chrrom/+server.ts" })`
