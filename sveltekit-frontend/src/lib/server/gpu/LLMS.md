...
| `encode-768-to-64.ts` | 0.000 | 0x9 |
| `cuda-bridge.ts` | 0.000 | 0xb |
| `autoencoder-session.ts` | 0.000 | 0x9 |
| `autoencoder-bridge.ts` | 0.000 | 0x9 |
| `libtorch-bridge.ts` | 0.000 | 0xb |
| `gpu-monitor.ts` | 0.000 | 0x9 |
| `autoencoder.test.ts` | 0.000 | 0x109 |
| `pytorch-graph.ts` | 0.000 | 0x9 |
## Audit Gates — GPU / N-API / LibTorch
