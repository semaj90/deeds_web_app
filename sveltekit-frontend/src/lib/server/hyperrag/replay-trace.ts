...
export class HyperRagReplayTrace {
  ...
  setReplayMetadata(context: {
    ...
    if (context.protocol) this.metadata.protocol = context.protocol;
    if (context.accelerator) this.metadata.accelerator = context.accelerator;
    if (context.cuda_available !== undefined) this.metadata.cuda_available = context.cuda_available;
    if (context.cuvs_enabled !== undefined) this.metadata.cuvs_enabled = context.cuvs_enabled;
    if (context.matmul_ms !== undefined) this.metadata.matmul_ms = context.matmul_ms;
    if (context.embedding_ms !== undefined) this.metadata.embedding_ms = context.embedding_ms;
