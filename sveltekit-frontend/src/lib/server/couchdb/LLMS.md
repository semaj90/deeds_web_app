...
|------|-----------|-------|
| `memory-mirror.ts` | 0.000 | 0x9 |
| `mango-indexes.ts` | 0.000 | 0x9 |
| `changes-consumer.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/couchdb/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/couchdb/+server.ts" })`
