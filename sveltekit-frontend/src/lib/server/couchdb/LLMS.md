# LLMS.md — `sveltekit-frontend/src/lib/server/couchdb`
...
> Directory: sveltekit-frontend/src/lib/server/couchdb
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/couchdb/<file>" })` — fetch any file's contents (sandboxed to src/)
