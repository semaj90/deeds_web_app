...
|------|-----------|-------|
| `topology-byte-mapper.ts` | 0.000 | 0x8 |
| `tensor-analysis-cache.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/tensor/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/tensor/+server.ts" })`
