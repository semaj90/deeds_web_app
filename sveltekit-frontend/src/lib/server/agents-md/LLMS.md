# LLMS.md — `sveltekit-frontend/src/lib/server/agents-md`
...
|------|-----------|-------|
| `schema.ts` | 0.000 | 0x9 |
| `parse-agents-md.ts` | 0.000 | 0x9 |
| `resolve-directory-context.ts` | 0.000 | 0x8 |
## Audit Gates — General
...
> Directory: sveltekit-frontend/src/lib/server/agents-md
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/agents-md/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/agents-md/+server.ts" })`
