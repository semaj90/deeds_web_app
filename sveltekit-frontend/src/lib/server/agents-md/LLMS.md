# LLMS.md — `sveltekit-frontend/src/lib/server/LLMS.md`
...
> Directory: sveltekit-frontend/src/lib/server/LLMS.md
...
- `graph_search({ query: "LLMS.md", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "server LLMS.md", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/LLMS.md/<file>" })` — fetch any file's contents (sandboxed to src/)
