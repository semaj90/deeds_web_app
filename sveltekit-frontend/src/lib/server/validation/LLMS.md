# LLMS.md — `sveltekit-frontend/src/lib/server/validation`
...
> Directory: sveltekit-frontend/src/lib/server/validation
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/validation/<file>" })` — fetch any file's contents (sandboxed to src/)
