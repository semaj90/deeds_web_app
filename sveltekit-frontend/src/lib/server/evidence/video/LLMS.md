# LLMS.md — `sveltekit-frontend/src/lib/server/evidence/video`
...
> Directory: sveltekit-frontend/src/lib/server/evidence/video
...
- `video-ingest-service.ts`
- `video-ingest-types.ts`
...
- `graph_search({ query: "video", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "evidence video", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/evidence/video/<file>" })` — fetch any file's contents (sandboxed to src/)
