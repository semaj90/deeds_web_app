...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/evidence/video/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/evidence/video/+server.ts" })`
