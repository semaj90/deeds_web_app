# AGENTS.md — `src/lib/server/evidence/video`
...
> Directory: src/lib/server/evidence/video
...
- `read_file({ filePath: "src/lib/server/evidence/video/<file>" })` — fetch any file's contents (sandboxed to src/)
