...
|------|-----------|-------|
| `type-detector.ts` | 0.737 | 0x9 |
| `proto-serializer.ts` | 0.455 | 0x9 |
| `worker-ocr.ts` | 0.150 | 0x9 |
| `worker-embed.ts` | 0.150 | 0x9 |
| `docling-structure.ts` | 0.150 | 0x9 |
| `rabbitmq.ts` | 0.150 | 0x9 |
| `docling-structure.test.ts` | 0.150 | 0x109 |
| `batch-entity-storer.ts` | 0.150 | 0x9 |
| `batch-entity-embedder.ts` | 0.150 | 0x9 |
| `audit.ts` | 0.000 | 0x8 |
## Audit Gates — General
