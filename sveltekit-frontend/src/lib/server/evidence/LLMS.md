# LLMS.md — `sveltekit-frontend/src/lib/server/evidence`
...
> Directory: sveltekit-frontend/src/lib/server/evidence
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/evidence/<file>" })` — fetch any file's contents (sandboxed to src/)
