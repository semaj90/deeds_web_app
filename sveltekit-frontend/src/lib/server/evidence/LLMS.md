...
|------|-----------|-------|
| `worker-ocr.ts` | 0.000 | 0x9 |
| `worker-embed.ts` | 0.000 | 0x9 |
| `proto-serializer.ts` | 0.000 | 0x9 |
| `docling-structure.ts` | 0.000 | 0x9 |
| `rabbitmq.ts` | 0.000 | 0x9 |
| `docling-structure.test.ts` | 0.000 | 0x109 |
| `batch-entity-storer.ts` | 0.000 | 0x9 |
| `batch-entity-embedder.ts` | 0.000 | 0x9 |
| `audit.ts` | 0.000 | 0x8 |
| `type-detector.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/evidence/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/evidence/+server.ts" })`
