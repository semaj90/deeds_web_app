...
|------|-----------|-------|
| `forensics.ts` | 0.000 | 0x8 |
| `entity-extractor.ts` | 0.000 | 0xa |
| `ocr.ts` | 0.000 | 0x9 |
| `embedding.ts` | 0.000 | 0xb |
| `drizzle-stub.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/evidence/services/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/evidence/services/+server.ts" })`
