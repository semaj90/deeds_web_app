# LLMS.md — `sveltekit-frontend/src/lib/server/evidence/services`
...
> Directory: sveltekit-frontend/src/lib/server/evidence/services
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/evidence/services/<file>" })` — fetch any file's contents (sandboxed to src/)
