...
|------|-----------|-------|
| `gemmaReports.ts` | 0.000 | 0x9 |
| `gemmaIntake.ts` | 0.000 | 0x9 |
| `ollamaClient.ts` | 0.000 | 0x9 |
| `ollama-client.ts` | 0.000 | 0x9 |
| `contextual-chat.ts` | 0.000 | 0x9 |
| `gemma4-tool-loop.ts` | 0.000 | 0xb |
| `token-budget.spec.ts` | 0.000 | - |
## Audit Gates — General
