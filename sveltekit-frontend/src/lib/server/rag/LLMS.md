...
| `sdk.ts` | 0.000 | 0xb |
| `ranker.ts` | 0.000 | 0x8 |
| `uiComplianceRag.ts` | 0.000 | 0x9 |
| `tag-extractor.ts` | 0.000 | 0x8 |
| `rag-types.ts` | 0.000 | 0x8 |
| `evidenceRag.ts` | 0.000 | 0x9 |
| `types.ts` | 0.000 | 0x8 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/rag/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/rag/+server.ts" })`
