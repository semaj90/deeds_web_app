# LLMS.md — `sveltekit-frontend/src/lib/server/rag`
...
> Directory: sveltekit-frontend/src/lib/server/rag
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/rag/<file>" })` — fetch any file's contents (sandboxed to src/)
