...
export const EMBEDDING_CONTRACT = {
  ...
  representations: {
    ...
    latent_256: {
      ...
      source_dimension: 768,
      output_dimension: 256,
      projection_method: 'nested_autoencoder',
      projection_version: 'nested-semantic-autoencoder-v3-full01',
      normalization: 'L2',
      collection: 'codebase_chunks_latent256',
      parent_representation: 'semantic_768',
    },
    latent_128: {
      lane_id: 'latent_128',
      ...
      source_dimension: 768,
      output_dimension: 128,
      projection_method: 'nested_prefix_l2_renormalize',
      projection_version: 'nested-semantic-autoencoder-v3-full01',
      normalization: 'L2',
      collection: null,
      parent_representation: 'latent_256',
    },
    semantic_384: {
      lane_id: 'dense_384',
