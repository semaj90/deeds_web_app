...
/** Google EmbeddingGemma retrieval-query task format. */
...
/** Google EmbeddingGemma code-retrieval-query task format. */
...
/** Retrieval document format. Title is part of representation lineage. */
...
/** Google EmbeddingGemma classification task format. */
