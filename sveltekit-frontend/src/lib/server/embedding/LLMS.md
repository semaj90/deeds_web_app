...
|------|-----------|-------|
| `embed-schema.ts` | 0.699 | 0x9 |
| `embedding-persist.ts` | 0.502 | 0x9 |
| `knn-helper.ts` | 0.150 | 0x8 |
| `text-splitter.ts` | 0.150 | 0x8 |
| `ollama-embed.ts` | 0.150 | 0x9 |
| `ingestion-queue.ts` | 0.150 | 0x9 |
| `embed.ts` | 0.150 | 0x9 |
| `embedding-repository.ts` | 0.150 | 0x9 |
## Audit Gates — General
