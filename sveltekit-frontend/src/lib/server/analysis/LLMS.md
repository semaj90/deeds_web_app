...
|------|-----------|-------|
| `analysis-jobs.ts` | 0.817 | 0x9 |
| `entity-extraction.ts` | 0.754 | 0x9 |
| `vlm-evidence-analyzer.ts` | 0.522 | 0x9 |
| `evidence-analysis-pipeline.ts` | 0.436 | 0xb |
| `hmm-section-classifier.ts` | 0.150 | 0x9 |
| `granite-docling.ts` | 0.150 | 0xb |
| `forensics.ts` | 0.150 | 0x9 |
| `concurrency-gate.ts` | 0.150 | 0x9 |
| `hmm-ace-analyzer.ts` | 0.150 | 0x9 |
| `summarizer.ts` | 0.150 | 0x9 |
## Audit Gates — General
