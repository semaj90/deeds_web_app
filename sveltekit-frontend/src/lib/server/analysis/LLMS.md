...
- [ ] **test-coverage** `src/lib/server/analysis/hmm-ace-analyzer.ts` fanIn=14 — add G26-pattern test (14 consumers depend on this)
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/analysis/<file>" })` — fetch any file's contents (sandboxed to src/)
