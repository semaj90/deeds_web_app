# LLMS.md — `sveltekit-frontend/src/lib/server/utils`
...
> Directory: sveltekit-frontend/src/lib/server/utils
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/utils/<file>" })` — fetch any file's contents (sandboxed to src/)
