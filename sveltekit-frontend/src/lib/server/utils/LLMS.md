...
|------|-----------|-------|
| `endpoints.ts` | 0.491 | 0x9 |
| `vector-schemas.ts` | 0.488 | 0x9 |
| `avatar-upload.ts` | 0.456 | 0x9 |
| `extract-component.ts` | 0.150 | 0x8 |
| `ollama-endpoint.ts` | 0.150 | 0x9 |
| `http-error-mapper.ts` | 0.150 | 0x9 |
| `ollama-client.ts` | 0.150 | 0x9 |
| `json-fast.ts` | 0.150 | 0xa |
| `graceful-error-handler.ts` | 0.150 | 0x8 |
| `service-error.ts` | 0.150 | 0x8 |
## Audit Gates — General
