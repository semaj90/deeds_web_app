...
|------|-----------|-------|
| `extract-component.ts` | 0.000 | 0x8 |
| `ollama-endpoint.ts` | 0.000 | 0x9 |
| `http-error-mapper.ts` | 0.000 | 0x9 |
| `ollama-client.ts` | 0.000 | 0x9 |
| `json-fast.ts` | 0.000 | 0xa |
| `graceful-error-handler.ts` | 0.000 | 0x8 |
| `service-error.ts` | 0.000 | 0x8 |
| `endpoints.ts` | 0.000 | 0x9 |
| `avatar-upload.ts` | 0.000 | 0x9 |
| `vector-schemas.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
|--------|-----------|---------|
| `c3d675bb9f` | 2026-05-27T21:42 | 5_27_26__Treat Atlas Library as feature-complete v1. Next checkpoint: Commit: "Add Atlas Library UI and read-only cache/card viewer" |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/utils/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/utils/+server.ts" })`
