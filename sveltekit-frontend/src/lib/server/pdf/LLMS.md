# LLMS.md — `sveltekit-frontend/src/lib/server/pdf`
...
> Directory: sveltekit-frontend/src/lib/server/pdf
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/pdf/<file>" })` — fetch any file's contents (sandboxed to src/)
