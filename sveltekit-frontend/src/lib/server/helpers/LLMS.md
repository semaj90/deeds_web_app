...
|------|-----------|-------|
| `docker-discovery.ts` | 0.608 | 0x9 |
| `service-discovery.ts` | 0.150 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/helpers/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/helpers/+server.ts" })`
