# LLMS.md — `sveltekit-frontend/src/lib/server/helpers`
...
> Directory: sveltekit-frontend/src/lib/server/helpers
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/helpers/<file>" })` — fetch any file's contents (sandboxed to src/)
