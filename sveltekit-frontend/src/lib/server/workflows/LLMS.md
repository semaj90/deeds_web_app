...
|------|-----------|-------|
| `pdf-ocr-workflow.test.ts` | 0.000 | - |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/workflows/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/workflows/+server.ts" })`
