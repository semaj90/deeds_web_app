# LLMS.md — `sveltekit-frontend/src/lib/server/data`
...
> Directory: sveltekit-frontend/src/lib/server/data
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/data/<file>" })` — fetch any file's contents (sandboxed to src/)
