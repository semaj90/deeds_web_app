...
|------|-----------|-------|
| `legal-seed-data.ts` | 0.000 | 0x8 |
| `legal-glossary-extended.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/data/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/data/+server.ts" })`
