# LLMS.md — `sveltekit-frontend/src/lib/server/ocr`
...
> Directory: sveltekit-frontend/src/lib/server/ocr
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/ocr/<file>" })` — fetch any file's contents (sandboxed to src/)
