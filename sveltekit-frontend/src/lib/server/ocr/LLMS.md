...
|------|-----------|-------|
| `hybrid.ts` | 0.000 | 0xb |
| `tesseract.ts` | 0.000 | 0x9 |
| `extractText.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/server/ocr/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/server/ocr/+server.ts" })`
