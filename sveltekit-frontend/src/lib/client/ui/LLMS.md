# LLMS.md — `sveltekit-frontend/src/lib/client/ui`
...
> Directory: sveltekit-frontend/src/lib/client/ui
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/client/ui/<file>" })` — fetch any file's contents (sandboxed to src/)
