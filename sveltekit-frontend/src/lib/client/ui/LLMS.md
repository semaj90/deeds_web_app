...
|------|-----------|-------|
| `POIPhotoUploader.svelte` | 0.000 | 0x9 |
| `POIPhotoModal.svelte` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/client/ui/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/client/ui/+server.ts" })`
