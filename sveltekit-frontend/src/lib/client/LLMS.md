# LLMS.md — `sveltekit-frontend/src/lib/client`
...
> Directory: sveltekit-frontend/src/lib/client
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/client/<file>" })` — fetch any file's contents (sandboxed to src/)
