...
|------|-----------|-------|
| `timeline-client.ts` | 0.000 | 0x8 |
| `streaming-handler.ts` | 0.000 | 0x8 |
| `workflow-event-stream.ts` | 0.000 | 0x8 |
| `sw-register.ts` | 0.000 | 0x9 |
| `subscribeEmbedding.svelte.ts` | 0.000 | 0x9 |
| `search-client.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/client/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/client/+server.ts" })`
