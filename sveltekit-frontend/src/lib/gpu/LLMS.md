...
- [ ] **test-coverage** `src/lib/gpu/gpu-compute-pipeline.ts` fanIn=10 — add G26-pattern test (10 consumers depend on this)
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/gpu/<file>" })` — fetch any file's contents (sandboxed to src/)
