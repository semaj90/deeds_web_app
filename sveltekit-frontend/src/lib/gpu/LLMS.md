...
| `rune-to-legal-doc.ts` | 0.608 | 0x9 |
| `AGENTS.md` | 0.554 | - |
| `gpu-search-reranker.ts` | 0.483 | 0xb |
| `shader-registry.ts` | 0.483 | 0x9 |
| `webgpu-palace-core.ts` | 0.473 | 0xb |
| `global-gpu-manager.ts` | 0.473 | 0x9 |
| `webgpu-palace-shaders.ts` | 0.150 | 0x8 |
| `nes-memory-architecture.ts` | 0.150 | 0x8 |
| `nes-gpu-memory-bridge.ts` | 0.150 | 0x8 |
## Audit Gates — General
