...
export const cyber_elephant = $root.cyber_elephant = (() => {
    ...
    cyber_elephant.DocumentVector = (function() {
         ...
         */
        DocumentVector.encode = function encode(message, writer, q) {
            if (!writer)
            ...
            if (message.projected_3d != null && Object.hasOwnProperty.call(message, "projected_3d"))
                $root.cyber_elephant.ProjectedPoint.encode(message.projected_3d, writer.uint32(/* id 5, wireType 2 =*/42).fork(), q + 1).ldelim();
         ...
         */
        DocumentVector.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 5: {
                        message.projected_3d = $root.cyber_elephant.ProjectedPoint.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 6: {
    ...
    cyber_elephant.ProjectedPoint = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ProjectedPoint.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ProjectedPoint.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
    ...
    cyber_elephant.DocumentCluster = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DocumentCluster.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (message.centroid != null && Object.hasOwnProperty.call(message, "centroid"))
                $root.cyber_elephant.ProjectedPoint.encode(message.centroid, writer.uint32(/* id 3, wireType 2 =*/26).fork(), q + 1).ldelim();
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DocumentCluster.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            ...
            while (reader.pos < end) {
                ...
                case 3: {
                        message.centroid = $root.cyber_elephant.ProjectedPoint.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 4: {
    ...
    cyber_elephant.VectorQuery = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        VectorQuery.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VectorQuery.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            ...
            while (reader.pos < end) {
                ...
                case 6: {
                        ...
                        if (key === "__proto__")
                            $util.makeProp(message.filters, key);
    ...
    cyber_elephant.VectorSearchResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        VectorSearchResponse.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (message.documents != null && message.documents.length)
                for (let i = 0; i < message.documents.length; ++i)
                    $root.cyber_elephant.DocumentVector.encode(message.documents[i], writer.uint32(/* id 1, wireType 2 =*/10).fork(), q + 1).ldelim();
            if (message.clusters != null && message.clusters.length)
                for (let i = 0; i < message.clusters.length; ++i)
                    $root.cyber_elephant.DocumentCluster.encode(message.clusters[i], writer.uint32(/* id 2, wireType 2 =*/18).fork(), q + 1).ldelim();
            if (message.stats != null && Object.hasOwnProperty.call(message, "stats"))
                $root.cyber_elephant.QueryStatistics.encode(message.stats, writer.uint32(/* id 3, wireType 2 =*/26).fork(), q + 1).ldelim();
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VectorSearchResponse.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            ...
            while (reader.pos < end) {
                ...
                case 1: {
                        if (!(message.documents && message.documents.length))
                            message.documents = [];
                        message.documents.push($root.cyber_elephant.DocumentVector.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                case 2: {
                        if (!(message.clusters && message.clusters.length))
                            message.clusters = [];
                        message.clusters.push($root.cyber_elephant.DocumentCluster.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                case 3: {
                        message.stats = $root.cyber_elephant.QueryStatistics.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 4: {
    ...
    cyber_elephant.QueryStatistics = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        QueryStatistics.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        QueryStatistics.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
    ...
    cyber_elephant.DocumentBatch = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DocumentBatch.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (message.options != null && Object.hasOwnProperty.call(message, "options"))
                $root.cyber_elephant.ProcessingOptions.encode(message.options, writer.uint32(/* id 3, wireType 2 =*/26).fork(), q + 1).ldelim();
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DocumentBatch.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            ...
            while (reader.pos < end) {
                ...
                case 3: {
                        message.options = $root.cyber_elephant.ProcessingOptions.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
    ...
    cyber_elephant.ProcessingOptions = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ProcessingOptions.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ProcessingOptions.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
    ...
    cyber_elephant.SystemStatus = (function() {
        ...
        SystemStatus.encode = function encode(message, writer, q) {
            ...
            if (message.metrics != null && Object.hasOwnProperty.call(message, "metrics"))
                $root.cyber_elephant.SystemMetrics.encode(message.metrics, writer.uint32(/* id 3, wireType 2 =*/26).fork(), q + 1).ldelim();
        ...
        SystemStatus.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 3: {
                        message.metrics = $root.cyber_elephant.SystemMetrics.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 4: {
    ...
    cyber_elephant.SystemMetrics = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SystemMetrics.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SystemMetrics.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
    ...
    cyber_elephant.DocumentIdRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DocumentIdRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DocumentIdRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
    ...
    cyber_elephant.ClusterRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ClusterRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ClusterRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
    ...
    cyber_elephant.ClusterResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ClusterResponse.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (message.clusters != null && message.clusters.length)
                for (let i = 0; i < message.clusters.length; ++i)
                    $root.cyber_elephant.DocumentCluster.encode(message.clusters[i], writer.uint32(/* id 1, wireType 2 =*/10).fork(), q + 1).ldelim();
            if (message.stats != null && Object.hasOwnProperty.call(message, "stats"))
                $root.cyber_elephant.QueryStatistics.encode(message.stats, writer.uint32(/* id 2, wireType 2 =*/18).fork(), q + 1).ldelim();
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ClusterResponse.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
    ...
    cyber_elephant.ClusterUpdateRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ClusterUpdateRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (message.clusterId != null && Object.hasOwnProperty.call(message, "clusterId"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.clusterId);
            if (message.options != null && Object.hasOwnProperty.call(message, "options"))
                $root.cyber_elephant.ProcessingOptions.encode(message.options, writer.uint32(/* id 2, wireType 2 =*/18).fork(), q + 1).ldelim();
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ClusterUpdateRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
