...
- shared library directory with 8 files, 0 API handlers, 2 TODOs
- Audit score: **83/100**
- TODOs: 2
- Tags: `src` `lib` `workers` `zod` `mjs` `has-todo`

## Files (8)

- `src/lib/workers/admin-chat.worker.ts`
- `src/lib/workers/ast-graph-worker.mjs`
- `src/lib/workers/browser-context-embed.worker.ts`
