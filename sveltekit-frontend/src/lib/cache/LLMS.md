...
|------|-----------|-------|
| `cache-service.svelte.ts` | 0.511 | 0x9 |
| `indexdb-cache.svelte.ts` | 0.511 | 0x9 |
| `offline-fetch.ts` | 0.150 | 0x9 |
| `loki-cache.svelte.ts` | 0.150 | 0x9 |
| `cache-invalidation.ts` | 0.150 | 0x8 |
## Audit Gates — General
