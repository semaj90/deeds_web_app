...
|------|-----------|-------|
| `offline-fetch.ts` | 0.000 | 0x9 |
| `loki-cache.svelte.ts` | 0.000 | 0x9 |
| `cache-service.svelte.ts` | 0.000 | 0x9 |
| `cache-invalidation.ts` | 0.000 | 0x8 |
| `indexdb-cache.svelte.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/cache/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/cache/+server.ts" })`
