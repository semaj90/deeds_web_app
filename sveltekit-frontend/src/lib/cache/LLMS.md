# LLMS.md — `sveltekit-frontend/src/lib/cache`
...
> Directory: sveltekit-frontend/src/lib/cache
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/cache/<file>" })` — fetch any file's contents (sandboxed to src/)
