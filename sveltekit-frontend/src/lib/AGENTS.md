...
- [ ] **hotspot** `src/lib/ambient-events.d.ts` (fanIn=0) — consider splitting or adding circuit breaker; top callers: 
...
- module directory with 11 files, 3 API handlers, 208 Drizzle refs, 9 TODOs
- Audit score: **100/100**
- no audit signals
