...
- [ ] **test-coverage** `src/lib/types.ts` fanIn=17 — add G26-pattern test (17 consumers depend on this)
- [ ] **test-coverage** `src/lib/utils.ts` fanIn=10 — add G26-pattern test (10 consumers depend on this)
