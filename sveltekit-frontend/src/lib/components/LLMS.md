...
|------|-----------|-------|
| `WebGPUSimilarityDemo.svelte` | 0.000 | 0x9 |
| `UploadProgress.svelte` | 0.000 | 0x8 |
| `RoutesList.svelte` | 0.000 | 0x8 |
| `RouteOperationsDashboard.svelte` | 0.000 | 0x9 |
| `PersonStatsPanel.svelte` | 0.000 | 0x9 |
| `PersonProfile.svelte` | 0.000 | 0x9 |
| `NESGraphRenderer.svelte` | 0.000 | 0x9 |
| `LazyLoader.svelte` | 0.000 | 0x9 |
| `RouteInspectorModal.svelte` | 0.000 | 0x8 |
| `RouteInspectorDetectiveBoard.svelte` | 0.000 | 0x8 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/+server.ts" })`
