...
<section class="awareness panel">
  ...
  <div class="mini-summary">
    ...
    <article><small>FILE LABELS</small><strong>{awareness.progress.fileLabels}</strong></article>
    <article><small>FANOUT FILES</small><strong>{awareness.progress.fanoutFiles.toLocaleString()}</strong></article>
...
<style>
  .awareness{margin-bottom:12px}.mini-summary{display:grid;grid-template-columns:repeat(7,1fr);gap:8px;margin:10px 0 14px}.mini-summary article{padding:10px;border:1px solid var(--line);border-radius:10px;background:#09131c}.mini-summary small{display:block;color:var(--muted);font:.58rem var(--mono)}.mini-summary strong{font-size:1.15rem}.subtabs{display:flex;gap:6px;overflow:auto;margin-bottom:12px}.subtabs :global(button){border:1px solid var(--line);border-radius:8px;background:#0d1a26;color:#a9bdcb;padding:.5rem .65rem;font:700 .65rem var(--mono);cursor:pointer}.subtabs :global(button[data-state='active']){background:#153042;color:var(--cyan)}
