# LLMS.md — `sveltekit-frontend/src/lib/components/legal`
...
> Directory: sveltekit-frontend/src/lib/components/legal
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/legal/<file>" })` — fetch any file's contents (sandboxed to src/)
