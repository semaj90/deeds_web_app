# LLMS.md — `sveltekit-frontend/src/lib/components/ui/gaming/effects`
...
> Directory: sveltekit-frontend/src/lib/components/ui/gaming/effects
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/gaming/effects/<file>" })` — fetch any file's contents (sandboxed to src/)
