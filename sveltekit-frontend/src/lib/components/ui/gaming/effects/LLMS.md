...
|------|-----------|-------|
| `index.ts` | 0.000 | 0x8 |
| `NES3DLODProcessor.svelte` | 0.000 | 0x8 |
| `gradient-utils.ts` | 0.000 | 0x8 |
| `audio-effects.ts` | 0.000 | 0x8 |
## Audit Gates — Svelte 5 Components
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/gaming/effects/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/ui/gaming/effects/+server.ts" })`
