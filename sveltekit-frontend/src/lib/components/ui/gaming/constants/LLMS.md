# LLMS.md — `sveltekit-frontend/src/lib/components/ui/gaming/constants`
...
> Directory: sveltekit-frontend/src/lib/components/ui/gaming/constants
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/gaming/constants/<file>" })` — fetch any file's contents (sandboxed to src/)
