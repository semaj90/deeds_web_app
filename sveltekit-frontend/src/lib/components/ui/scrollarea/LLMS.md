# LLMS.md — `sveltekit-frontend/src/lib/components/ui/scrollarea`
...
> Directory: sveltekit-frontend/src/lib/components/ui/scrollarea
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/scrollarea/<file>" })` — fetch any file's contents (sandboxed to src/)
