# LLMS.md — `sveltekit-frontend/src/lib/components/ui/progress`
...
> Directory: sveltekit-frontend/src/lib/components/ui/progress
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/progress/<file>" })` — fetch any file's contents (sandboxed to src/)
