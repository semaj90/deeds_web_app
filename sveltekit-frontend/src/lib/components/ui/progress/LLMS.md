...
|------|-----------|-------|
| `Svelte5Progress.svelte` | 0.000 | 0x9 |
| `ProgressRoot.svelte` | 0.000 | 0x9 |
| `ProgressIndicator.svelte` | 0.000 | 0x8 |
| `Progress.svelte` | 0.000 | 0x8 |
| `index.ts` | 0.000 | 0x9 |
## Audit Gates — Svelte 5 Components
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/progress/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/ui/progress/+server.ts" })`
