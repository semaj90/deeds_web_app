...
|------|-----------|-------|
| `SelectRoot.svelte` | 0.000 | 0x9 |
| `SelectTrigger.svelte` | 0.000 | 0x9 |
| `SelectItem.svelte` | 0.000 | 0x9 |
| `SelectContent.svelte` | 0.000 | 0x9 |
| `Select.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/select/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/ui/select/+server.ts" })`
