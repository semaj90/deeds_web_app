# LLMS.md — `sveltekit-frontend/src/lib/components/ui/button`
...
> Directory: sveltekit-frontend/src/lib/components/ui/button
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/button/<file>" })` — fetch any file's contents (sandboxed to src/)
