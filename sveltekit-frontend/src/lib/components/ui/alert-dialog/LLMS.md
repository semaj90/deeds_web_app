# LLMS.md — `sveltekit-frontend/src/lib/components/ui/alert-dialog`
...
- [ ] **test-coverage** `src/lib/components/ui/alert-dialog/types.ts` fanIn=10 — add G26-pattern test (10 consumers depend on this)
...
> Directory: sveltekit-frontend/src/lib/components/ui/alert-dialog
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/alert-dialog/<file>" })` — fetch any file's contents (sandboxed to src/)
