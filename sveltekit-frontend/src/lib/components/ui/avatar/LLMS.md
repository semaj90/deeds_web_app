...
|------|-----------|-------|
| `Svelte5Avatar.svelte` | 0.000 | 0x9 |
| `index.ts` | 0.000 | 0x8 |
| `Avatar.svelte` | 0.000 | 0x8 |
| `AvatarImage.svelte` | 0.000 | 0x8 |
| `AvatarFallback.svelte` | 0.000 | 0x8 |
## Audit Gates — Svelte 5 Components
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/avatar/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/ui/avatar/+server.ts" })`
