...
- [ ] **test-coverage** `src/lib/components/ui/Icon.svelte` fanIn=252 — add G26-pattern test (252 consumers depend on this)
- [ ] **test-coverage** `src/lib/components/ui/Button.svelte` fanIn=89 — add G26-pattern test (89 consumers depend on this)
- [ ] **hotspot** `src/lib/components/ui/Icon.svelte` (fanIn=252) — consider splitting or adding circuit breaker; top callers: `AutonomousInvestigator.svelte`, `AIChatWidget.svelte`, `AIRecommendation.svelte`
- [ ] **hotspot** `src/lib/components/ui/Button.svelte` (fanIn=89) — consider splitting or adding circuit breaker; top callers: `POIPhotoUploader.svelte`, `AutonomousInvestigator.svelte`, `AIAssistantPanel.svelte`
