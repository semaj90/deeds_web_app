...
|------|-----------|-------|
| `Svelte5Input.svelte` | 0.000 | 0x9 |
| `InputBits.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/ui/input/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/ui/input/+server.ts" })`
