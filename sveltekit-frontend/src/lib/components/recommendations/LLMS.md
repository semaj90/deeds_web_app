...
|------|-----------|-------|
| `RecommendationWidget.svelte` | 0.000 | 0xb |
| `index.ts` | 0.000 | 0x8 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/recommendations/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/recommendations/+server.ts" })`
