...
|------|-----------|-------|
| `StrategyWizard.svelte` | 0.000 | 0x9 |
| `CourtroomHUD.svelte` | 0.000 | 0x9 |
## Audit Gates — Svelte 5 Components
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/courtroom/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/courtroom/+server.ts" })`
