...
> Directory audit: src/lib/components/courtroom
...
- `src/lib/components/courtroom/CourtroomHUD.svelte`
- `src/lib/components/courtroom/StrategyWizard.svelte`
...
- `wiki_note_lookup({ query: "components courtroom", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/lib/components/courtroom/<file>" })` — fetch any file's contents (sandboxed to src/)
