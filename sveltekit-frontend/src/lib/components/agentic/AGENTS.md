...
> Directory audit: src/lib/components/agentic
...
- `src/lib/components/agentic/AgenticController.svelte`
...
- `graph_search({ query: "agentic", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "components agentic", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/lib/components/agentic/<file>" })` — fetch any file's contents (sandboxed to src/)
