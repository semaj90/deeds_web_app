...
|------|-----------|-------|
| `ProvenanceGraph.svelte` | 0.000 | 0x9 |
| `CitationInspector.svelte` | 0.000 | 0x9 |
| `AnswerGenerator.svelte` | 0.000 | 0x9 |
| `SourceValidator.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/source-validation/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/source-validation/+server.ts" })`
