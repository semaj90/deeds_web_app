# LLMS.md — `sveltekit-frontend/src/lib/components/yorha/cases`
...
> Directory: sveltekit-frontend/src/lib/components/yorha/cases
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/yorha/cases/<file>" })` — fetch any file's contents (sandboxed to src/)
