...
|------|-----------|-------|
| `SystemOverview.svelte` | 0.000 | 0x9 |
| `RecentActivity.svelte` | 0.000 | 0x8 |
| `GPUMetrics.svelte` | 0.000 | 0xb |
| `EvidenceStats.svelte` | 0.000 | 0x9 |
| `ActiveCasesWidget.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/yorha/dashboard/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/yorha/dashboard/+server.ts" })`
