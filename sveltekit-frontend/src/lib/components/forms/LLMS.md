...
|------|-----------|-------|
| `EvidenceForm.svelte` | 0.000 | 0x9 |
| `EnhancedFileUpload.svelte` | 0.000 | 0x9 |
| `CaseForm.svelte` | 0.000 | 0x9 |
| `SmartDocumentForm.svelte` | 0.000 | 0x9 |
| `ProgressiveForm.svelte` | 0.000 | 0x9 |
| `LegalCaseForm.svelte` | 0.000 | 0x9 |
| `EnhancedCaseForm.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/forms/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/forms/+server.ts" })`
