...
|------|-----------|-------|
| `UploadZone.svelte` | 0.000 | 0x9 |
| `index.ts` | 0.000 | 0x8 |
| `EvidenceTheoryBoard.svelte` | 0.000 | 0x9 |
| `EvidenceCard.svelte` | 0.000 | 0x9 |
| `DetectiveBoard.svelte` | 0.000 | 0x9 |
| `ContextualDetectiveBoard.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/detective/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/detective/+server.ts" })`
