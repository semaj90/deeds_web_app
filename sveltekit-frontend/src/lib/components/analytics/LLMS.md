...
|------|-----------|-------|
| `ResearchSummariesBrowser.svelte` | 0.000 | 0x9 |
| `LiveResearchPanel.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/analytics/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/analytics/+server.ts" })`
