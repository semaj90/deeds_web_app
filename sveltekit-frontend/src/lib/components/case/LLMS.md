...
|------|-----------|-------|
| `SummaryEditor.svelte` | 0.000 | 0x9 |
| `SimilarCasesPanel.svelte` | 0.000 | 0x9 |
| `ErrorAlert.svelte` | 0.000 | 0x8 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/case/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/case/+server.ts" })`
