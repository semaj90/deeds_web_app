...
|------|-----------|-------|
| `EvidenceModal.svelte` | 0.000 | 0x9 |
| `EvidenceCRUDModal.svelte` | 0.000 | 0x9 |
## Audit Gates — Svelte 5 Components
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/modals/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/modals/+server.ts" })`
