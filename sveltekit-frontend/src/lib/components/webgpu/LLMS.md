...
|------|-----------|-------|
| `SwarmManifoldVisualizer.svelte` | 0.000 | 0x9 |
| `WebGPUTopologyRenderer.svelte` | 0.000 | 0x9 |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/components/webgpu/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/components/webgpu/+server.ts" })`
