# AGENTS.md — `src/lib/components/rag`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-06T16:15:22.211Z · agents.md spec · regen: npm run agents:write -->

> Directory audit: src/lib/components/rag
...
- `src/lib/components/rag/SourceValidator.svelte`
...
- `wiki_note_lookup({ query: "components rag", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "src/lib/components/rag/<file>" })` — fetch any file's contents (sandboxed to src/)
