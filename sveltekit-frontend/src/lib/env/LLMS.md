# LLMS.md — `sveltekit-frontend/src/lib/env`
...
> Directory: sveltekit-frontend/src/lib/env
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/env/<file>" })` — fetch any file's contents (sandboxed to src/)
