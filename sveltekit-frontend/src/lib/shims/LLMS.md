...
|------|-----------|-------|
| `worker-threads-browser-shim.js` | 0.776 | 0x8 |
| `os-browser-shim.js` | 0.471 | 0x8 |
| `lokijs-browser-adapter.js` | 0.150 | 0x8 |
| `ioredis-browser-shim.js` | 0.150 | 0x8 |
| `fs-browser-shim.js` | 0.150 | 0x8 |
| `drizzle-node-postgres.ts` | 0.150 | 0x8 |
| `piper-expressions-shim.js` | 0.150 | 0x8 |
| `dns-browser-shim.js` | 0.150 | 0x8 |
| `commonjs-shim.js` | 0.150 | 0x8 |
