...
|------|-----------|-------|
| `user.svelte.ts` | 0.000 | 0x8 |
| `search.svelte.ts` | 0.000 | 0x8 |
| `theme.svelte.ts` | 0.000 | 0x9 |
| `research-tasks.svelte.ts` | 0.000 | 0x9 |
| `preferences.svelte.ts` | 0.000 | 0x8 |
| `notifications.svelte.ts` | 0.000 | 0x8 |
| `knowledge-search.svelte.ts` | 0.000 | 0x8 |
| `index.ts` | 0.000 | 0x8 |
| `evidenceCommandCenter.store.svelte.ts` | 0.000 | 0x8 |
| `app-store.svelte.ts` | 0.000 | 0x9 |
