...
|------|-----------|-------|
| `vite-error-schema.ts` | 0.000 | 0x9 |
| `pool.ts` | 0.000 | 0x9 |
| `schema.ts` | 0.000 | 0x9 |
| `client-db.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/db/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/db/+server.ts" })`
