# LLMS.md — `sveltekit-frontend/src/lib/db`
...
> Directory: sveltekit-frontend/src/lib/db
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/db/<file>" })` — fetch any file's contents (sandboxed to src/)
