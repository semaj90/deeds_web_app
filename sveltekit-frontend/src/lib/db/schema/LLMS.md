# LLMS.md — `sveltekit-frontend/src/lib/db/schema`
...
> Directory: sveltekit-frontend/src/lib/db/schema
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/db/schema/<file>" })` — fetch any file's contents (sandboxed to src/)
