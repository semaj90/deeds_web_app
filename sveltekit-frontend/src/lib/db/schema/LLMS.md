...
|------|-----------|-------|
| `yorha.ts` | 0.000 | 0x9 |
| `route-health-tables.ts` | 0.000 | 0x9 |
| `gpuInferenceDemo.ts` | 0.000 | 0x9 |
| `evidence.ts` | 0.000 | 0x9 |
| `cutlass.ts` | 0.000 | 0x9 |
| `ace-web.ts` | 0.000 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/db/schema/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/db/schema/+server.ts" })`
