# LLMS.md — `sveltekit-frontend/src/lib/courtroom`
...
> Directory: sveltekit-frontend/src/lib/courtroom
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/courtroom/<file>" })` — fetch any file's contents (sandboxed to src/)
