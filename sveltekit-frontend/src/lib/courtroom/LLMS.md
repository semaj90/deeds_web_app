...
|------|-----------|-------|
| `crt-postprocess.ts` | 0.150 | 0x8 |
| `courtroom-types.ts` | 0.150 | 0x8 |
| `courtroom-scene.svelte.ts` | 0.150 | 0xb |
| `timeline-engine.svelte.ts` | 0.150 | 0x8 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/courtroom/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/courtroom/+server.ts" })`
