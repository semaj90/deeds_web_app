# LLMS.md — `src/lib/services/knowledge-search`
...
|------|-----------|-------|
| `QdrantKnowledgeStore.ts` | 1.228 | - |
| `PostgresKnowledgeStore.ts` | 0.837 | - |
| `TfIdfRanker.ts` | 0.541 | - |
| `KnowledgeSearcher.ts` | 0.541 | - |
| `TagExtractor.ts` | 0.490 | - |
| `KnowledgeIndexer.ts` | 0.490 | - |
| `MinioKnowledgeStore.ts` | 0.490 | - |
| `types.ts` | 0.488 | - |
