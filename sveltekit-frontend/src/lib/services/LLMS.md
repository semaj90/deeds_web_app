...
|------|-----------|-------|
| `source-validation-api.ts` | 0.000 | 0x9 |
| `api-client.ts` | 0.000 | 0x8 |
| `voice-commands.ts` | 0.000 | 0x8 |
| `rag-source-validation.ts` | 0.000 | 0x8 |
| `tts.ts` | 0.000 | 0xb |
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/services/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/services/+server.ts" })`
