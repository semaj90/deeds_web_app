# LLMS.md — `sveltekit-frontend/src/lib/services`
...
> Directory: sveltekit-frontend/src/lib/services
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/services/<file>" })` — fetch any file's contents (sandboxed to src/)
