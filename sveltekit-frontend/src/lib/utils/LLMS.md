...
|------|-----------|-------|
| `webgpu-array-utils.ts` | 0.765 | 0x8 |
| `api-endpoints.ts` | 0.740 | 0x8 |
| `security.ts` | 0.726 | 0x9 |
| `progressive-enhancement-audit.ts` | 0.667 | 0x8 |
| `accessibility-validator.ts` | 0.667 | 0x8 |
| `type-utils.ts` | 0.560 | 0x8 |
| `ui-recon.ts` | 0.560 | 0x8 |
| `gpu-reranker.ts` | 0.512 | 0x8 |
| `route-operation-logger.ts` | 0.471 | 0x8 |
| `type-guards.ts` | 0.444 | 0x9 |
## Audit Gates — General
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/utils/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/lib/utils/+server.ts" })`
