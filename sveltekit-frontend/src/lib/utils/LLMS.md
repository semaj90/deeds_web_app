# LLMS.md — `sveltekit-frontend/src/lib/utils`
...
> Directory: sveltekit-frontend/src/lib/utils
...
- `read_file({ filePath: "sveltekit-frontend/src/lib/utils/<file>" })` — fetch any file's contents (sandboxed to src/)
