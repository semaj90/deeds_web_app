...
|------|-----------|-------|
| `toast.ts` | 0.000 | 0x8 |
| `simd-json-parser.ts` | 0.000 | 0x8 |
| `case-logic.ts` | 0.000 | 0x8 |
| `buffer-conversion.ts` | 0.000 | 0x8 |
| `tracking.ts` | 0.000 | 0x8 |
| `telemetry.ts` | 0.000 | 0x9 |
| `sse-client.ts` | 0.000 | 0x8 |
| `fuse-index.ts` | 0.000 | 0x9 |
| `sensitive-info-detector.ts` | 0.000 | 0x8 |
| `debounce.ts` | 0.000 | 0x8 |
## Audit Gates — General
