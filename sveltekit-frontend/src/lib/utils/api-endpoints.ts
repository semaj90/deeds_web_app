...
export function getSummarizerServiceEndpoint(): string {
    if (typeof process !== 'undefined' && process.env?.SUMMARIZER_SERVICE_URL) {
        return process.env.SUMMARIZER_SERVICE_URL;
    }
    return 'http://gpu-orchestrator:8095';
}
...
export function getEvidenceProcessorEndpoint(): string {
    if (typeof process !== 'undefined' && process.env?.EVIDENCE_PROCESSOR_URL) {
        return process.env.EVIDENCE_PROCESSOR_URL;
    }
    return 'http://evidence-processor-service:8092';
}
...
export function getIngestionServiceEndpoint(): string {
    if (typeof process !== 'undefined' && process.env?.INGESTION_SERVICE_URL) {
        return process.env.INGESTION_SERVICE_URL;
    }
    return 'http://ingestion-service:8091';
}
...
export function getWasmLlvmServiceEndpoint(): string {
    if (typeof process !== 'undefined' && process.env?.WASM_LLVM_SERVICE_URL) {
        return process.env.WASM_LLVM_SERVICE_URL;
    }
    return 'http://wasm-llvm-service:8225';
}
