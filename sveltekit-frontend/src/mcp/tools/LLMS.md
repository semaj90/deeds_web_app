# LLMS.md — `sveltekit-frontend/src/mcp/tools`
...
> Directory: sveltekit-frontend/src/mcp/tools
...
- `cluster-lenses.tool.ts`
- `graph-analysis.tool.ts`
- `legal-skills.tool.ts`
- `repair_tools.ts`
- `topology-search.tool.ts`
- `trace-kag.tool.ts`
- `vault-walker.tool.ts`
- `video-analysis.ts`
...
- `read_file({ filePath: "sveltekit-frontend/src/mcp/tools/<file>" })` — fetch any file's contents (sandboxed to src/)
