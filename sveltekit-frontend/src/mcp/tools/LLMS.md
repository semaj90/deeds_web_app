...
|------|-----------|-------|
| `repair_tools.ts` | 0.000 | 0x8 |
| `vault-walker.tool.ts` | 0.000 | 0xb |
| `topology-search.tool.ts` | 0.000 | 0xb |
| `graph-analysis.tool.ts` | 0.000 | 0xb |
| `video-analysis.ts` | 0.000 | 0x9 |
| `trace-kag.tool.ts` | 0.000 | 0xb |
| `legal-skills.tool.ts` | 0.000 | 0xb |
| `cluster-lenses.tool.ts` | 0.000 | 0xb |
## Audit Gates — MCP Tool Surface (TRACE)
...
- `read_file({ filePath: "sveltekit-frontend/src/mcp/tools/<file>" })`
- `verify_fix({ filePath: "sveltekit-frontend/src/mcp/tools/+server.ts" })`
