# AGENTS.md — `src/mcp/zod-to-json-schema-bridge`
...
> Directory audit: src/mcp/zod-to-json-schema-bridge
...
- Audit score: **90/100**
- no audit signals
- Tags: `src` `mcp` `zod-to-json-schema-bridge` `zod` `json`

## Files (2)

- `src/mcp/zod-to-json-schema-bridge/index.js`
- `src/mcp/zod-to-json-schema-bridge/package.json`
...
- `read_file({ filePath: "src/mcp/zod-to-json-schema-bridge/<file>" })` — fetch any file's contents (sandboxed to src/)
