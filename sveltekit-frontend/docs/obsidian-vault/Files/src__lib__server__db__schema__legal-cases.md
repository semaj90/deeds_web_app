---
type: "file"
path: "src/lib/server/db/schema/legal-cases.ts"
aliases: ["legal-cases.ts","src/lib/server/db/schema/legal-cases.ts"]
clusterId: 53
ext: ".ts"
lineCount: 109
pagerank: 0
...
hasZod: false
importCount: 2
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/db/schema/legal-cases.ts"
