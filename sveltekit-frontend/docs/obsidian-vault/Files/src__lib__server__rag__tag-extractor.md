---
type: "file"
path: "src/lib/server/rag/tag-extractor.ts"
aliases: ["tag-extractor.ts","src/lib/server/rag/tag-extractor.ts"]
clusterId: 43
ext: ".ts"
lineCount: 56
pagerank: 0
...
hasZod: false
importCount: 0
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/rag/tag-extractor.ts"
