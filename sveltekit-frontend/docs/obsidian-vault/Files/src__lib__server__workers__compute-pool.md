---
type: "file"
path: "src/lib/server/workers/compute-pool.ts"
aliases: ["compute-pool.ts","src/lib/server/workers/compute-pool.ts"]
clusterId: 17
ext: ".ts"
lineCount: 378
pagerank: 0
...
hasZod: false
importCount: 4
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/workers/compute-pool.ts"
