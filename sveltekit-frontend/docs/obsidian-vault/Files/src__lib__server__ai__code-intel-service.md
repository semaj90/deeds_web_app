---
type: "file"
path: "src/lib/server/ai/code-intel-service.ts"
aliases: ["code-intel-service.ts","src/lib/server/ai/code-intel-service.ts"]
clusterId: 19
ext: ".ts"
lineCount: 301
pagerank: 0
...
hasZod: false
importCount: 5
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/ai/code-intel-service.ts"
