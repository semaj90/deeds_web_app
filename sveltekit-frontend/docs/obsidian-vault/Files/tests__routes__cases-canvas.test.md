---
type: "file"
path: "tests/routes/cases-canvas.test.ts"
aliases: ["cases-canvas.test.ts","tests/routes/cases-canvas.test.ts"]
clusterId: -1
ext: ".ts"
lineCount: 385
pagerank: 0
...
hasZod: false
importCount: 2
embedding_id: "qdrant://codebase_chunks_768/tests/routes/cases-canvas.test.ts"
