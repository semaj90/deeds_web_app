---
type: "file"
path: "src/lib/server/db/schema/jurisdictions.ts"
aliases: ["jurisdictions.ts","src/lib/server/db/schema/jurisdictions.ts"]
clusterId: 53
ext: ".ts"
lineCount: 27
pagerank: 0
...
hasZod: false
importCount: 2
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/db/schema/jurisdictions.ts"
