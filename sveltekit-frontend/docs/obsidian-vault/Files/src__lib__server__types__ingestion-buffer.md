---
type: "file"
path: "src/lib/server/types/ingestion-buffer.ts"
aliases: ["ingestion-buffer.ts","src/lib/server/types/ingestion-buffer.ts"]
clusterId: 46
ext: ".ts"
lineCount: 65
pagerank: 0
...
hasZod: false
importCount: 0
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/types/ingestion-buffer.ts"
