---
type: "file"
path: "src/lib/server/gpu/gpu-monitor.ts"
aliases: ["gpu-monitor.ts","src/lib/server/gpu/gpu-monitor.ts"]
clusterId: 20
ext: ".ts"
lineCount: 218
pagerank: 0
...
hasZod: false
importCount: 2
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/gpu/gpu-monitor.ts"
