---
type: "file"
path: "scripts/phase104-backups/src/lib/workers/rabbitmq-embedding-worker.ts"
aliases: ["rabbitmq-embedding-worker.ts","scripts/phase104-backups/src/lib/workers/rabbitmq-embedding-worker.ts"]
clusterId: -1
ext: ".ts"
lineCount: 553
pagerank: 0
...
hasZod: false
importCount: 9
embedding_id: "qdrant://codebase_chunks_768/scripts/phase104-backups/src/lib/workers/rabbitmq-embedding-worker.ts"
...
# `scripts/phase104-backups/src/lib/workers/rabbitmq-embedding-worker.ts`
## For future Claude
