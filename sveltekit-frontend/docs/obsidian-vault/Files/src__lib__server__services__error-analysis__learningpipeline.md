---
type: "file"
path: "src/lib/server/services/error-analysis/LearningPipeline.ts"
aliases: ["LearningPipeline.ts","src/lib/server/services/error-analysis/LearningPipeline.ts"]
clusterId: -1
ext: ".ts"
lineCount: 394
pagerank: 0
...
hasZod: false
importCount: 5
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/services/error-analysis/LearningPipeline.ts"
...
# `src/lib/server/services/error-analysis/LearningPipeline.ts`
## For future Claude
