---
type: "file"
path: "src/routes/(app)/admin/search-intelligence/+page.svelte"
...
## For future Claude
> .svelte at src/routes/(app)/admin/search-intelligence/+page.svelte (4472 lines), SvelteKit route, Svelte component, auth-guarded.
pagerank:: 0.000000
blend:: 0.000000
lines:: 4472
## Backlinks (Dataview)
