---
type: "file"
path: "src/lib/server/db/schema-chat.ts"
aliases: ["schema-chat.ts","src/lib/server/db/schema-chat.ts"]
clusterId: 53
ext: ".ts"
lineCount: 76
pagerank: 0
...
hasZod: false
importCount: 2
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/db/schema-chat.ts"
