---
type: "file"
path: "src/routes/api/indexing/+server.ts"
aliases: ["+server.ts","src/routes/api/indexing/+server.ts"]
clusterId: -1
ext: ".ts"
lineCount: 547
pagerank: 0
...
hasZod: true
importCount: 10
embedding_id: "qdrant://codebase_chunks_768/src/routes/api/indexing/+server.ts"
