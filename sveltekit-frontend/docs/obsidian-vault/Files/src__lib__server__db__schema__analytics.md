---
type: "file"
path: "src/lib/server/db/schema/analytics.ts"
aliases: ["analytics.ts","src/lib/server/db/schema/analytics.ts"]
clusterId: 53
ext: ".ts"
lineCount: 17
pagerank: 0
...
hasZod: false
importCount: 1
embedding_id: "qdrant://codebase_chunks_768/src/lib/server/db/schema/analytics.ts"
