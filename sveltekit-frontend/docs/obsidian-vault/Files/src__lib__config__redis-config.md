---
type: "file"
path: "src/lib/config/redis-config.ts"
aliases: ["redis-config.ts","src/lib/config/redis-config.ts"]
clusterId: 75
ext: ".ts"
lineCount: 288
pagerank: 0
...
hasZod: false
importCount: 1
embedding_id: "qdrant://codebase_chunks_768/src/lib/config/redis-config.ts"
