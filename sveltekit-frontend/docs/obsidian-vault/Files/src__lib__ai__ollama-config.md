---
type: "file"
path: "src/lib/ai/ollama-config.ts"
aliases: ["ollama-config.ts","src/lib/ai/ollama-config.ts"]
clusterId: 14
ext: ".ts"
lineCount: 69
pagerank: 0
...
hasZod: false
importCount: 0
embedding_id: "qdrant://codebase_chunks_768/src/lib/ai/ollama-config.ts"
