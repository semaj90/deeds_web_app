...
> Generated: 2026-06-04T05:24:10.623Z
...
| Hardcoded localhost refs | 1606 |
| Routes without test pairing | 90 |
| Cyclic import pairs | 2 |
| Drizzle table refs | 2789 |
...
| G11 | No hardcoded localhost (excl env.server) | 53177 | 1606 |
| G14a | No `export let` (Svelte 4 props) | 54744 | 39 |
| G14b | No `$:` reactive declarations | 54768 | 15 |
| G14c | No `on:event=` directives | 54727 | 56 |
| G14d | No `createEventDispatcher()` | 54750 | 33 |
| G14e | No runes in plain `.ts` files | 54149 | 634 |
| G15 | No SSR-unsafe globals (unguarded) | 54783 | 0 |
...
## Directory Scorecard (1402 dirs · lowest score = most attention needed)
...
| ✅ | `sveltekit-frontend/src/routes/api` | 84 | 732 | 108714 | 726 | 708/557 | 1 | 🟠lh ⬜notest |
...
| ✅ | `sveltekit-frontend/.tmp` | 85 | 36 | 11043907 | 0 | 0/1 | 10 | — |
...
| ✅ | `docs/graph` | 90 | 46 | 1580442 | 0 | 0/0 | 0 | — |
...
| ✅ | `memory/exports` | 90 | 44 | 295080 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/.tmp/offline-analysis` | 90 | 45 | 10815067 | 0 | 0/1 | 0 | — |
...
| ✅ | `sveltekit-frontend/docs` | 90 | 1 | 2412708 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/atlas-index` | 90 | 4 | 143985 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/graph` | 90 | 6 | 2259694 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/obsidian-vault` | 90 | 2 | 108 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports` | 90 | 25 | 8859 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/memory/graphify/deep` | 90 | 5 | 780945 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/scripts/atlas` | 95 | 52 | 7739 | 0 | 0/30 | 0 | 🟠lh |
...
| ✅ | `sveltekit-frontend/scripts/tests` | 95 | 70 | 14758 | 0 | 4/24 | 0 | 🟠lh |
...
| ✅ | `scripts/atlas` | 100 | 615 | 162624 | 5 | 0/401 | 2 | 🟠lh |
...
| ✅ | `scripts/tests` | 100 | 138 | 84918 | 2 | 4/20 | 0 | 🟠lh |
...
| ✅ | `sveltekit-frontend/scripts` | 100 | 369 | 198300 | 14 | 26/416 | 36 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src` | 100 | 16 | 721820 | 739 | 1169/1012 | 14 | 🟠lh ⬜notest |
| ✅ | `sveltekit-frontend/src/lib` | 100 | 6 | 463384 | 5 | 15/375 | 13 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src/lib/server` | 100 | 1139 | 247693 | 5 | 12/293 | 5 | 🟠lh |
| ✅ | `sveltekit-frontend/src/lib/types` | 100 | 22 | 3163 | 0 | 0/5 | 0 | — |
| ✅ | `sveltekit-frontend/src/routes` | 100 | 6 | 234849 | 734 | 1152/613 | 1 | 🟠lh ⬜notest |
...
## G11 — Hardcoded Localhost References (1606 files)
