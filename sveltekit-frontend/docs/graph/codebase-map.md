...
> Generated: 2026-08-21T17:21:23.948Z
...
|--------|-------|
| Files scanned | 24151 |
| Directories analysed | 1034 |
| Route files | 1202 |
| Svelte components | 1162 |
| API handlers | 3317 |
| API routes without auth | 41 |
| API routes without Zod | 23 |
| SSR-unsafe files | 0 |
| Svelte 4 legacy patterns | 3 |
| Hardcoded localhost refs | 1680 |
| Routes without test pairing | 67 |
| Cyclic import pairs | 16 |
| Drizzle table refs | 1554 |
| TODO/FIXME markers | 977 |
...
|------|-------|------|------|
| G4  | Auth guard on API routes | 899 | 42 |
| G5  | Zod validation on API routes | 631 | 23 |
| G11 | No hardcoded localhost (excl env.server) | 22471 | 1680 |
| G14a | No `export let` (Svelte 4 props) | 24151 | 0 |
| G14b | No `$:` reactive declarations | 24149 | 2 |
| G14c | No `on:event=` directives | 24149 | 2 |
| G14d | No `createEventDispatcher()` | 24151 | 0 |
| G14e | No runes in plain `.ts` files | 24126 | 25 |
| G15 | No SSR-unsafe globals (unguarded) | 24151 | 0 |
| G16 | Server routes have test pairing | 808 | 67 |
| G17 | Server routes have error handling | 822 | 133 |
| G20 | Cyclic import pairs | — | 16 |

---

## Directory Scorecard (1034 dirs · lowest score = most attention needed)
...
| ✅ | `sveltekit-frontend/src/routes/api` | 75 | 840 | 123677 | 822 | 775/607 | 9 | 🟠lh ⬜notest |
...
| ✅ | `sveltekit-frontend/src/mcp` | 78 | 27 | 26199 | 0 | 3/30 | 1 | 🔴ssr 🟠lh |
...
| ✅ | `sveltekit-frontend/src/lib/utils` | 85 | 50 | 7656 | 0 | 2/7 | 0 | 🟠lh |
...
| ✅ | `packages/parent-atlas/src` | 88 | 3 | 23011 | 0 | 0/106 | 1 | 🟠lh |
| ✅ | `packages/parent-atlas/src/core` | 88 | 107 | 19217 | 0 | 0/100 | 1 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src/routes` | 89 | 6 | 254662 | 830 | 1235/665 | 9 | 🟠lh ⬜notest |
...
| ✅ | `data/atlas-ml` | 90 | 4 | 109 | 0 | 0/0 | 0 | — |
| ✅ | `deeds-web-app/temp_poc_amqp_test` | 90 | 1 | 106 | 0 | 0/0 | 0 | — |
| ✅ | `docs/.okf/dev` | 90 | 3 | 215 | 0 | 0/0 | 0 | — |
...
| ✅ | `docs/graph` | 90 | 26 | 660951 | 0 | 0/0 | 0 | — |
...
| ✅ | `docs/reports` | 90 | 525 | 5254190 | 0 | 0/0 | 0 | — |
...
| ✅ | `docs/reports/schema` | 90 | 5 | 130051 | 0 | 0/0 | 0 | — |
| ✅ | `docs/reports/semantic-contracts` | 90 | 2 | 745 | 0 | 0/0 | 0 | — |
...
| ✅ | `parent-atlas-kimi-containment/src` | 90 | 3 | 193 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-kimi-containment/tests` | 90 | 1 | 36 | 0 | 0/0 | 0 | — |
...
| ✅ | `python/atlas_compute` | 90 | 2 | 102 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/docs` | 90 | 1 | 12907168 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/docs/graph` | 90 | 21 | 8270078 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/graph/.build` | 90 | 3 | 33 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/docs/reports` | 90 | 137 | 4543477 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/atlas` | 90 | 2 | 432 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/benchmarks` | 90 | 1 | 49 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/graph-probes` | 90 | 3 | 2407836 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/drizzle/meta` | 90 | 36 | 860392 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/memory/graphify/gds` | 90 | 120 | 2974317 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/src/lib/agent` | 90 | 15 | 1550 | 0 | 0/2 | 0 | — |
| ✅ | `sveltekit-frontend/src/lib/ai` | 90 | 20 | 5522 | 0 | 0/1 | 0 | — |
...
| ✅ | `scripts/opencode` | 95 | 150 | 21922 | 0 | 0/126 | 0 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src` | 95 | 17 | 1013099 | 837 | 1261/1520 | 89 | 🔴ssr 🟠lh ⬜notest |
...
| ✅ | `gsd_archives/phase-2f1-baseline` | 100 | 1 | 13588 | 0 | 0/8 | 0 | — |
| ✅ | `gsd_archives/phase-2f1-baseline/schema-backup` | 100 | 220 | 13316 | 0 | 0/8 | 0 | — |
...
| ✅ | `packages/parent-atlas` | 100 | 3 | 30664 | 1 | 0/144 | 1 | 🟠lh |
| ✅ | `packages/parent-atlas/test` | 100 | 57 | 6981 | 1 | 0/38 | 0 | — |
| ✅ | `packages/parent-atlas-retrieval/src/gpu` | 100 | 29 | 9013 | 0 | 0/4 | 0 | — |
| ✅ | `scripts/atlas` | 100 | 2489 | 674092 | 7 | 0/1011 | 12 | 🟠lh |
| ✅ | `scripts/atlas/lib` | 100 | 107 | 13928 | 3 | 0/30 | 0 | 🟠lh |
...
| ✅ | `sveltekit-frontend/scripts` | 100 | 403 | 364845 | 16 | 33/581 | 48 | 🟠lh |
| ✅ | `sveltekit-frontend/scripts/agents` | 100 | 5 | 1365 | 0 | 1/2 | 0 | — |
| ✅ | `sveltekit-frontend/scripts/agents/skills` | 100 | 5 | 546 | 0 | 1/1 | 0 | — |
| ✅ | `sveltekit-frontend/scripts/atlas` | 100 | 361 | 153753 | 1 | 4/154 | 3 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src/lib` | 100 | 11 | 725693 | 7 | 22/821 | 79 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src/lib/server` | 100 | 2255 | 456555 | 7 | 19/716 | 69 | 🟠lh |
...
| ✅ | `sveltekit-frontend/tests` | 100 | 286 | 170101 | 5 | 819/86 | 1 | 🟠lh |
| ✅ | `sveltekit-frontend/tests/atlas` | 100 | 22 | 5425 | 0 | 0/12 | 0 | — |
...
_…and 770 more. See `codebase-graph.json` for full list._

---

## G4 — API Routes Missing Auth Guard (41)
...
## G5 — API Routes Missing Zod Validation (23)
...
## G16 — Routes Without Test Pairing (67)
...
## G11 — Hardcoded Localhost References (1680 files)
...
| `$lib/enums` | 88 |
| `$lib/server/llm/runtime-contract.js` | 79 |
| `$lib/server/redis` | 78 |
...
| `$lib/types` | 662 |
| `ioredis` | 656 |
| `node:fs/promises` | 557 |
| `node:child_process` | 540 |
| `$lib/server/db/client` | 519 |
| `$lib/server/env.server.js` | 469 |
| `child_process` | 459 |
| `fs/promises` | 384 |
...
- `sveltekit-frontend/src` — 89 marker(s), score 95
...
- `sveltekit-frontend/src/routes` — 9 marker(s), score 89
