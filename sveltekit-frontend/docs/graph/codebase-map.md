...
> Generated: 2026-05-06T15:27:14.948Z
...
|--------|-------|
| Files scanned | 3529 |
| Directories analysed | 389 |
| Route files | 924 |
| Svelte components | 860 |
| API handlers | 626 |
| API routes without auth | 32 |
| API routes without Zod | 4 |
| SSR-unsafe files | 3 |
| Svelte 4 legacy patterns | 0 |
| Hardcoded localhost refs | 53 |
| Routes without test pairing | 18 |
| Cyclic import pairs | 0 |
| Drizzle table refs | 421 |
...
|------|-------|------|------|
| G4  | Auth guard on API routes | 675 | 32 |
| G5  | Zod validation on API routes | 483 | 4 |
| G11 | No hardcoded localhost (excl env.server) | 3476 | 53 |
| G14a | No `export let` (Svelte 4 props) | 3529 | 0 |
| G14b | No `$:` reactive declarations | 3529 | 0 |
| G14c | No `on:event=` directives | 3529 | 0 |
| G14d | No `createEventDispatcher()` | 3529 | 0 |
| G14e | No runes in plain `.ts` files | 3529 | 0 |
| G15 | No SSR-unsafe globals (unguarded) | 3526 | 3 |
| G16 | Server routes have test pairing | 628 | 18 |
| G17 | Server routes have error handling | 618 | 89 |
| G20 | Cyclic import pairs | — | 0 |

---

## Directory Scorecard (389 dirs · lowest score = most attention needed)
...
| ✅ | `src/routes/api/code-intel` | 76 | 19 | 422 | 19 | 19/1 | 0 | ⬜notest | — |
...
| ✅ | `src/lib/components` | 80 | 56 | 170786 | 0 | 0/46 | 6 | 🟠lh | C92: component chunks in `src/lib/components/evidence` (tag: embedding) |
| ✅ | `src/routes/(app)/citations` | 80 | 10 | 2390 | 0 | 10/0 | 0 | 🔴ssr ⬜notest | — |
| ✅ | `src/routes` | 82 | 6 | 211030 | 620 | 987/510 | 7 | 🔴ssr 🟠lh ⬜notest | — |
| ✅ | `src/lib/ai/onnx` | 83 | 2 | 340 | 0 | 0/0 | 1 | — | — |
| ✅ | `src/lib/workers` | 83 | 5 | 1252 | 0 | 0/0 | 2 | — | — |
...
| ✅ | `src/lib/server/grpc` | 85 | 10 | 4186 | 0 | 0/4 | 0 | 🟠lh | C82: function chunks in `src/lib/server/grpc` (tag: embedding) |
...
| ✅ | `src/routes/api/wiki` | 85 | 3 | 309 | 3 | 3/2 | 0 | ⬜notest | — |
...
| ✅ | `src/routes/api/research` | 87 | 5 | 808 | 5 | 5/4 | 0 | ⬜notest | — |
...
| ✅ | `src/lib/client/ui` | 90 | 2 | 183 | 0 | 0/0 | 0 | — | C92: component chunks in `src/lib/components/evidence` (tag: embedding) |
...
| ✅ | `src/lib/server/cache` | 90 | 11 | 3968 | 0 | 0/7 | 0 | — | C22: function chunks in `src/lib/server/cache` (tag: redis) |
| ✅ | `src/lib/server/cartridge` | 90 | 5 | 1614 | 0 | 0/2 | 0 | — | C12: function chunks in `src/lib/server/cartridge` (tag: embedding) |
| ✅ | `src/lib/server/config` | 90 | 4 | 701 | 0 | 0/1 | 0 | — | C75: function chunks in `src/lib/config` (tag: embedding) |
...
| ✅ | `src/lib/server/inference` | 90 | 4 | 2067 | 0 | 0/4 | 0 | — | C58: type chunks in `src/lib/server/indexer` (tag: vector) |
...
| ✅ | `src/routes/code-intel` | 90 | 1 | 1886 | 0 | 0/0 | 0 | — | — |
| ✅ | `src/routes/code-intel/clusters` | 90 | 1 | 200 | 0 | 0/0 | 0 | — | — |
| ✅ | `src/routes/code-intel/memory` | 90 | 1 | 215 | 0 | 0/0 | 0 | — | — |
| ✅ | `src/routes/code-intel/research` | 90 | 1 | 228 | 0 | 0/0 | 0 | — | — |
| ✅ | `src/routes/code-intel/retrieval` | 90 | 1 | 279 | 0 | 0/0 | 0 | — | — |
| ✅ | `src/routes/code-intel/subagents` | 90 | 1 | 156 | 0 | 0/0 | 0 | — | — |
| ✅ | `src/routes/code-intel/topology` | 90 | 1 | 502 | 0 | 0/0 | 0 | — | — |
...
| ✅ | `src/routes/api/graph` | 92 | 17 | 2589 | 17 | 17/14 | 0 | 🟠lh ⬜notest | — |
...
| ✅ | `src/lib/server/db` | 95 | 111 | 18029 | 0 | 0/4 | 0 | 🟠lh | C6: function chunks in `src/lib/server/db` (tag: embedding) |
| ✅ | `src/lib/server/gpu` | 95 | 11 | 3997 | 0 | 0/2 | 0 | 🟠lh | C20: function chunks in `src/lib/webgpu` (tag: embedding) |
| ✅ | `src/lib/server/graph` | 95 | 20 | 9130 | 0 | 1/7 | 0 | 🟠lh | C73: function chunks in `src/lib/server/retrieval` (tag: vector) |
| ✅ | `src/lib/server/ml` | 95 | 8 | 2973 | 0 | 0/0 | 0 | 🟠lh | C69: route-handler chunks in `src/routes/(app)/admin/api-testing/agentic-loop` (tag: api) |
| ✅ | `src/lib/server/vector` | 95 | 10 | 2837 | 0 | 0/1 | 0 | 🟠lh | C18: type chunks in `src/lib/types` (tag: embedding) |
| ✅ | `src/lib/services` | 95 | 8 | 9875 | 0 | 0/3 | 0 | 🟠lh | C43: type chunks in `src/lib/services/knowledge-search` (tag: embedding) |
| ✅ | `src/lib/services/knowledge-search` | 95 | 11 | 3966 | 0 | 0/2 | 0 | 🟠lh | C17: function chunks in `src/lib/services/error-analysis` (tag: embedding) |
| ✅ | `src/mcp` | 95 | 2 | 4884 | 0 | 1/2 | 0 | 🟠lh | — |
...
| ✅ | `src/routes/api/admin` | 97 | 10 | 1790 | 10 | 10/8 | 0 | — | — |
| ✅ | `src/routes/api/analytics` | 97 | 26 | 4112 | 26 | 25/22 | 0 | — | — |
| ✅ | `src/routes/api/codebase-index` | 97 | 47 | 13178 | 46 | 46/38 | 0 | ⬜notest | — |
...
| ✅ | `src/lib` | 100 | 11 | 383163 | 3 | 12/236 | 9 | 🔴ssr 🟠lh | C57: const chunks in `src/lib/shims` (tag: embedding) |
...
| ✅ | `src/lib/server` | 100 | 62 | 146283 | 3 | 9/147 | 0 | 🟠lh | C90: function chunks in `src/lib/server` (tag: auth) |
| ✅ | `src/lib/server/ace` | 100 | 19 | 8097 | 0 | 0/8 | 0 | — | C72: function chunks in `src/lib/server/ace` (tag: vector) |
| ✅ | `src/lib/server/adapters` | 100 | 1 | 638 | 0 | 0/1 | 0 | — | — |
| ✅ | `src/lib/server/agents` | 100 | 4 | 256 | 0 | 0/0 | 0 | — | — |
| ✅ | `src/lib/server/ai` | 100 | 32 | 8227 | 0 | 2/11 | 0 | — | C19: type chunks in `src/lib/types` (tag: embedding) |
| ✅ | `src/lib/server/analysis` | 100 | 12 | 2988 | 0 | 0/4 | 0 | — | C54: function chunks in `src/lib/server/analysis` |
| ✅ | `src/lib/server/analytics` | 100 | 15 | 6715 | 0 | 0/10 | 0 | — | C60: function chunks in `src/lib/server/analytics` (tag: embedding) |
...
| ✅ | `src/lib/server/evidence` | 100 | 15 | 1229 | 0 | 0/2 | 0 | — | C66: type chunks in `src/lib/server/services` (tag: types) |
| ✅ | `src/lib/server/indexer` | 100 | 19 | 6297 | 1 | 0/5 | 0 | — | C58: type chunks in `src/lib/server/indexer` (tag: vector) |
...
| ✅ | `src/lib/server/retrieval` | 100 | 28 | 7292 | 0 | 0/5 | 0 | — | C73: function chunks in `src/lib/server/retrieval` (tag: vector) |
...
| ✅ | `src/lib/server/workers` | 100 | 5 | 1769 | 0 | 0/4 | 0 | — | C24: class chunks in `src/lib/server/workers` (tag: redis) |
| ✅ | `src/lib/types` | 100 | 52 | 7126 | 0 | 0/3 | 0 | — | C77: type chunks in `src/lib/types` (tag: embedding) |
| ✅ | `src/routes/(app)` | 100 | 2 | 100885 | 4 | 390/40 | 6 | 🔴ssr 🟠lh ⬜notest | — |
...
| ✅ | `src/routes/(app)/simulation` | 100 | 2 | 1305 | 0 | 2/0 | 0 | — | C21: component chunks in `src/lib/components/legal` (tag: auth) |
...
| ✅ | `tests/routes` | 100 | 30 | 47732 | 2 | 594/9 | 0 | — | — |

---

## API Routes (620 total · top 60)
...
_…and 560 more. See `codebase-graph.json` for full list._
...
## G15 — SSR-Unsafe Globals (3 files · unguarded window/document/localStorage)
...
## G16 — Routes Without Test Pairing (18)
- `src/routes/api/code-intel/claude-plan/+server.ts` · POST
...
- `src/routes/api/code-intel/graph/gds-status/+server.ts` · GET/POST
...
- `src/routes/api/codebase-index/centroids/+server.ts` · POST/GET
- `src/routes/api/graph/topology-neighbors/+server.ts` · GET
- `src/routes/api/research/encode/+server.ts` · POST
- `src/routes/api/wiki/moc/+server.ts` · POST
- `src/routes/api/wiki/watch/+server.ts` · GET/POST/DELETE

---

## G11 — Hardcoded Localhost References (53 files)
...
| `$lib/server/env.server.js` | 325 |
| `$lib/components/ui/Icon.svelte` | 252 |
| `$lib/server/redis.js` | 212 |
| `$lib/server/ollama.js` | 167 |
| `$lib/server/db/schema-postgres.js` | 143 |
| `$lib/server/middleware/cache-headers.js` | 113 |
| `$lib/server/validation.js` | 93 |
| `$lib/components/ui/Button.svelte` | 88 |
| `$lib/server/grpc/embedding-client.js` | 82 |
| `$lib/server/vector/qdrant-manager.js` | 71 |
...
| `$lib/server/gpu/libtorch-bridge.js` | 28 |
| `$lib/types/enhanced-svelte5-types` | 27 |
| `$lib/server/db/schema.js` | 27 |
...
## Svelte Components (60 shown of 860)
...
| `@sveltejs/kit` | 690 |
| `zod` | 483 |
| `$lib/server/db/client` | 396 |
| `drizzle-orm` | 319 |
| `$lib/server/env.server.js` | 294 |
| `$lib/components/ui/Icon.svelte` | 252 |
| `svelte` | 226 |
| `$lib/server/ollama.js` | 143 |
| `$lib/server/redis.js` | 139 |
...
| `bits-ui` | 41 |
| `$lib/server/vector/qdrant-manager.js` | 37 |
| `$lib/server/analytics/search-analytics.js` | 36 |
| `$lib/server/db/schema-postgres` | 34 |
| `ioredis` | 32 |
...
- `src/routes` — 7 marker(s), score 82
