...
> Generated: 2026-08-30T18:47:18.042Z
...
|--------|-------|
| Files scanned | 25618 |
| Directories analysed | 1054 |
| Route files | 1204 |
| Svelte components | 1162 |
| API handlers | 3322 |
| API routes without auth | 22 |
| API routes without Zod | 2 |
| SSR-unsafe files | 0 |
| Svelte 4 legacy patterns | 3 |
| Hardcoded localhost refs | 1702 |
| Routes without test pairing | 69 |
| Cyclic import pairs | 16 |
| Drizzle table refs | 1580 |
| TODO/FIXME markers | 971 |
...
|------|-------|------|------|
| G4  | Auth guard on API routes | 920 | 23 |
| G5  | Zod validation on API routes | 656 | 2 |
| G11 | No hardcoded localhost (excl env.server) | 23916 | 1702 |
| G14a | No `export let` (Svelte 4 props) | 25618 | 0 |
| G14b | No `$:` reactive declarations | 25616 | 2 |
| G14c | No `on:event=` directives | 25616 | 2 |
| G14d | No `createEventDispatcher()` | 25618 | 0 |
| G14e | No runes in plain `.ts` files | 25593 | 25 |
| G15 | No SSR-unsafe globals (unguarded) | 25618 | 0 |
| G16 | Server routes have test pairing | 808 | 69 |
| G17 | Server routes have error handling | 824 | 133 |
| G20 | Cyclic import pairs | — | 16 |

---

## Directory Scorecard (1054 dirs · lowest score = most attention needed)
...
| ✅ | `packages/parent-atlas-core` | 75 | 1 | 1246 | 0 | 0/0 | 5 | — |
| ✅ | `packages/parent-atlas-core/src` | 75 | 3 | 1202 | 0 | 0/0 | 5 | — |
| ✅ | `sveltekit-frontend/scripts/topology` | 75 | 1 | 203 | 0 | 0/0 | 9 | — |
| ✅ | `sveltekit-frontend/src/routes/api` | 76 | 843 | 124367 | 824 | 796/632 | 9 | 🟠lh ⬜notest |
...
| ✅ | `packages/parent-atlas-retrieval/src/crossencoder` | 78 | 5 | 759 | 0 | 1/2 | 1 | 🟠lh |
| ✅ | `sveltekit-frontend/src/mcp` | 78 | 28 | 26236 | 0 | 3/30 | 1 | 🔴ssr 🟠lh |
| ✅ | `packages/atlas-core/src/evidence` | 80 | 15 | 1177 | 1 | 0/2 | 0 | — |
| ✅ | `scripts/agent` | 80 | 18 | 4660 | 0 | 0/8 | 4 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src/lib/workers` | 83 | 10 | 1874 | 0 | 0/1 | 2 | — |
...
| ✅ | `packages/parent-atlas/src/pipelines` | 85 | 15 | 2119 | 0 | 0/3 | 0 | 🟠lh |
| ✅ | `packages/parent-atlas-runtime` | 85 | 1 | 1513 | 0 | 0/0 | 7 | — |
| ✅ | `packages/parent-atlas-runtime/src` | 85 | 1 | 1484 | 0 | 0/0 | 7 | — |
| ✅ | `packages/parent-atlas-runtime/src/facade` | 85 | 1 | 277 | 0 | 0/0 | 6 | — |
| ✅ | `scripts/agentic` | 85 | 10 | 2886 | 0 | 0/10 | 0 | 🟠lh |
| ✅ | `scripts/ai` | 85 | 8 | 716 | 0 | 0/8 | 0 | 🟠lh |
| ✅ | `scripts/atlas/ingester` | 85 | 22 | 2496 | 0 | 0/14 | 0 | 🟠lh |
| ✅ | `scripts/atlas/knowledge-layer` | 85 | 20 | 2452 | 0 | 0/0 | 0 | 🟠lh |
...
| ✅ | `scripts/gpu` | 85 | 12 | 2338 | 0 | 0/2 | 0 | 🟠lh |
...
| ✅ | `sveltekit-frontend/scripts/lib` | 85 | 7 | 1262 | 0 | 0/4 | 0 | 🟠lh |
| ✅ | `sveltekit-frontend/scripts/scenarios` | 85 | 4 | 359 | 0 | 0/3 | 0 | 🟠lh |
| ✅ | `sveltekit-frontend/src/lib/components` | 85 | 697 | 177584 | 0 | 0/49 | 8 | — |
| ✅ | `sveltekit-frontend/src/lib/gpu` | 85 | 30 | 8322 | 0 | 0/4 | 0 | 🟠lh |
| ✅ | `sveltekit-frontend/src/lib/utils` | 85 | 51 | 7755 | 0 | 2/7 | 0 | 🟠lh |
...
| ✅ | `packages/parent-atlas/src` | 88 | 3 | 30401 | 0 | 0/137 | 1 | 🟠lh |
| ✅ | `packages/parent-atlas/src/core` | 88 | 157 | 26557 | 0 | 0/131 | 1 | 🟠lh |
| ✅ | `packages/parent-atlas-retrieval` | 88 | 2 | 11452 | 0 | 1/6 | 1 | 🟠lh |
| ✅ | `packages/parent-atlas-retrieval/src` | 88 | 1 | 10264 | 0 | 1/6 | 1 | 🟠lh |
...
| ✅ | `.vscode/extensions/mcp-context7-assistant/src` | 90 | 128 | 128 | 0 | 0/0 | 0 | — |
| ✅ | `.vscode/tasks` | 90 | 1 | 11 | 0 | 0/0 | 0 | — |
| ✅ | `ace-vector-selection-slice/src/lib/server` | 90 | 7 | 616 | 0 | 0/0 | 0 | — |
| ✅ | `backups/qdrant-upgrade-20260825-211412` | 90 | 2 | 29 | 0 | 0/0 | 0 | — |
...
| ✅ | `claude-mem/src/bin` | 90 | 2 | 427 | 0 | 0/1 | 0 | — |
...
| ✅ | `claude-mem/src/services` | 90 | 4 | 31700 | 0 | 23/37 | 0 | — |
...
| ✅ | `data/atlas-ml` | 90 | 5 | 330 | 0 | 0/0 | 0 | — |
| ✅ | `deeds-web-app/temp_poc_amqp_test` | 90 | 1 | 106 | 0 | 0/0 | 0 | — |
| ✅ | `docs/.okf/dev` | 90 | 4 | 291 | 0 | 0/0 | 0 | — |
| ✅ | `docs/.okf/dev/raw` | 90 | 1 | 59 | 0 | 0/0 | 0 | — |
| ✅ | `docs/.okf/langextract` | 90 | 1 | 316 | 0 | 0/0 | 0 | — |
| ✅ | `docs/.okf/langextract/raw` | 90 | 7 | 161 | 0 | 0/0 | 0 | — |
| ✅ | `docs/.okf/legacy/deeds_lab` | 90 | 1 | 54 | 0 | 0/0 | 0 | — |
| ✅ | `docs/.okf/library-module-index` | 90 | 2 | 806 | 0 | 0/0 | 0 | — |
| ✅ | `docs/ai-os` | 90 | 1 | 4 | 0 | 0/0 | 0 | — |
| ✅ | `docs/architecture` | 90 | 2 | 170 | 0 | 0/0 | 0 | — |
| ✅ | `docs/atlas` | 90 | 6 | 55638 | 0 | 0/0 | 0 | — |
| ✅ | `docs/contracts` | 90 | 3 | 344 | 0 | 0/0 | 0 | — |
| ✅ | `docs/graph` | 90 | 26 | 660952 | 0 | 0/0 | 0 | — |
...
| ✅ | `docs/reports` | 90 | 948 | 8429649 | 0 | 0/0 | 0 | — |
| ✅ | `docs/reports/atlas` | 90 | 4 | 174 | 0 | 0/0 | 0 | — |
| ✅ | `docs/reports/current-structural-graph-artifact-v2` | 90 | 2 | 25478 | 0 | 0/0 | 0 | — |
| ✅ | `docs/reports/embedding-tile-artifacts` | 90 | 1 | 24 | 0 | 0/0 | 0 | — |
...
| ✅ | `docs/reports/schema` | 90 | 5 | 136823 | 0 | 0/0 | 0 | — |
| ✅ | `docs/reports/semantic-contracts` | 90 | 2 | 1272 | 0 | 0/0 | 0 | — |
...
| ✅ | `log/artifacts/phase109` | 90 | 2 | 2972 | 0 | 0/0 | 0 | — |
...
| ✅ | `memory/exports` | 90 | 53 | 387935 | 0 | 0/0 | 0 | — |
...
| ✅ | `packages/atlas-core/src/types` | 90 | 2 | 201 | 0 | 0/2 | 0 | — |
| ✅ | `packages/atlas-duckdb` | 90 | 2 | 2100 | 0 | 0/0 | 0 | — |
| ✅ | `packages/atlas-duckdb/src` | 90 | 12 | 2030 | 0 | 0/0 | 0 | — |
| ✅ | `packages/atlas-orchestrator` | 90 | 2 | 244 | 0 | 0/2 | 0 | — |
| ✅ | `packages/atlas-orchestrator/src/steps` | 90 | 1 | 96 | 0 | 0/1 | 0 | — |
| ✅ | `packages/atlas-orchestrator/src/workflows` | 90 | 1 | 82 | 0 | 0/1 | 0 | — |
| ✅ | `packages/parent-atlas/docs/reports` | 90 | 1 | 126 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas/fixtures/structured-value` | 90 | 2 | 68 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas/src/adapters` | 90 | 5 | 910 | 0 | 0/2 | 0 | — |
| ✅ | `packages/parent-atlas/src/gates` | 90 | 6 | 316 | 0 | 0/1 | 0 | — |
| ✅ | `packages/parent-atlas-client` | 90 | 7 | 1825 | 0 | 0/2 | 0 | — |
| ✅ | `packages/parent-atlas-client/src` | 90 | 2 | 1242 | 0 | 0/2 | 0 | — |
| ✅ | `packages/parent-atlas-client/src/a2a` | 90 | 1 | 239 | 0 | 0/1 | 0 | — |
| ✅ | `packages/parent-atlas-client/src/grpc` | 90 | 1 | 375 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-client/src/http` | 90 | 1 | 134 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-client/src/mcp` | 90 | 1 | 306 | 0 | 0/1 | 0 | — |
| ✅ | `packages/parent-atlas-client/test` | 90 | 1 | 75 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-core/src/contracts` | 90 | 2 | 327 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-core/src/schemas` | 90 | 1 | 51 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-ingest` | 90 | 2 | 476 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-ingest/src` | 90 | 1 | 420 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-ingest/src/scanner` | 90 | 3 | 406 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-opencode` | 90 | 1 | 62 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-opencode/src` | 90 | 1 | 15 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas-retrieval/src/bifrost` | 90 | 8 | 950 | 0 | 0/1 | 0 | — |
| ✅ | `packages/parent-atlas-retrieval/tests/bifrost` | 90 | 4 | 1106 | 0 | 0/0 | 0 | — |
...
| ✅ | `packages/semantic-contracts` | 90 | 1 | 2028 | 0 | 0/7 | 0 | — |
| ✅ | `packages/semantic-contracts/schemas` | 90 | 6 | 1062 | 0 | 0/0 | 0 | — |
| ✅ | `packages/semantic-contracts/src` | 90 | 8 | 932 | 0 | 0/7 | 0 | — |
| ✅ | `parent-atlas-ampere-quantization-proof-kit/sveltekit-frontend/src/lib` | 90 | 2 | 335 | 0 | 0/2 | 0 | — |
...
| ✅ | `parent-atlas-graph-revision-fix-v1/docs/reports` | 90 | 1 | 23 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-graph-revision-fix-v1/scripts/atlas` | 90 | 1 | 376 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-graph-revision-fix-v1/scripts/atlas/lib` | 90 | 1 | 202 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-graph-revision-fix-v1/sveltekit-frontend/src/lib` | 90 | 2 | 139 | 0 | 0/0 | 0 | — |
...
| ✅ | `parent-atlas-qas-bundle/scripts/atlas/qas` | 90 | 2 | 167 | 0 | 0/1 | 0 | — |
| ✅ | `parent-atlas-qas-bundle/sveltekit-frontend/src/lib` | 90 | 3 | 321 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-rel-01a-current-ontology-cohort/packages/parent-atlas/test` | 90 | 1 | 152 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-rel-01a-current-ontology-cohort/scripts/atlas` | 90 | 1 | 447 | 0 | 0/1 | 0 | — |
| ✅ | `parent-atlas-rel-01a-current-ontology-cohort/scripts/atlas/lib` | 90 | 1 | 166 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-rel-01a3-explicit-alias-review/scripts/atlas` | 90 | 3 | 936 | 0 | 0/3 | 0 | — |
| ✅ | `parent-atlas-rel-01a3-explicit-alias-review/scripts/atlas/lib` | 90 | 3 | 321 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-tensor-residency-integration/examples` | 90 | 6 | 178 | 0 | 0/0 | 0 | — |
| ✅ | `parent-atlas-tensor-residency-integration/sveltekit-frontend/src/lib` | 90 | 64 | 1787 | 0 | 0/6 | 0 | — |
...
| ✅ | `parent_atlas_tensor_residency_integration_v2/sveltekit-frontend/src/lib` | 90 | 15 | 411 | 0 | 0/0 | 0 | — |
| ✅ | `parent_atlas_tensor_residency_integration_v2/sveltekit-frontend/tests/atlas` | 90 | 7 | 73 | 0 | 0/0 | 0 | — |
| ✅ | `python/atlas_compute` | 90 | 2 | 104 | 0 | 0/0 | 0 | — |
...
| ✅ | `scripts/valkey` | 90 | 6 | 474 | 0 | 0/6 | 0 | — |
| ✅ | `services/embedding-onnx-webgpu` | 90 | 6 | 2372 | 0 | 0/0 | 0 | — |
...
| ✅ | `simd-bridge/cpp` | 90 | 4 | 1504 | 0 | 0/2 | 0 | — |
...
| ✅ | `sveltekit-frontend/data` | 90 | 1 | 17109 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/data/atlas-tensor-proof` | 90 | 4 | 93 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs` | 90 | 1 | 14136130 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/docs/graph` | 90 | 21 | 7351916 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/graph/.build` | 90 | 4 | 44 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/docs/reports` | 90 | 141 | 6690601 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/atlas` | 90 | 2 | 432 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/benchmarks` | 90 | 1 | 49 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/current-structural-graph-artifact-v1` | 90 | 2 | 143 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/graph-ordinal-parity-fixture-v1` | 90 | 1 | 10 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/graph-probes` | 90 | 5 | 4537031 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/docs/reports/graph-snapshot-parity` | 90 | 2 | 55 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/drizzle/meta` | 90 | 37 | 909601 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/memory/graphify/gds` | 90 | 157 | 4663441 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/memory/runs/2026-06-01T22-22-15` | 90 | 19 | 37678 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/memory/runs/2026-07-27T01-57-07` | 90 | 11 | 815780 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/memory/runs/2026-08-25T17-24-26` | 90 | 3 | 2244 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/memory/runs/2026-08-25T17-31-18` | 90 | 3 | 2244 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/memory/runs/2026-08-25T17-31-24` | 90 | 3 | 2244 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/reports` | 90 | 7 | 288769 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/reports/deep-audit` | 90 | 4 | 288109 | 0 | 0/0 | 0 | — |
| ✅ | `sveltekit-frontend/reports/deep-audit/encoded` | 90 | 31 | 171518 | 0 | 0/0 | 0 | — |
...
| ✅ | `sveltekit-frontend/scripts/atlas/sparse` | 90 | 26 | 1666 | 0 | 0/9 | 0 | — |
...
| ✅ | `sveltekit-frontend/src/lib/agent` | 90 | 16 | 1578 | 0 | 0/2 | 0 | — |
| ✅ | `sveltekit-frontend/src/lib/ai` | 90 | 20 | 5509 | 0 | 0/1 | 0 | — |
...
| ✅ | `sveltekit-frontend/src/lib/config` | 90 | 9 | 1802 | 0 | 1/2 | 0 | — |
...
| ✅ | `sveltekit-frontend/src/routes` | 90 | 6 | 255340 | 832 | 1256/690 | 9 | 🟠lh ⬜notest |
...
| ✅ | `sveltekit-frontend/tests/retrieval` | 90 | 5 | 1005 | 0 | 0/1 | 0 | — |
...
| ✅ | `tests/retrieval` | 90 | 10 | 2560 | 0 | 0/0 | 0 | — |
| ✅ | `tmp/ace-context-snapshots` | 90 | 3 | 54 | 0 | 0/0 | 0 | — |
| ✅ | `tmp/atlas/discovery` | 90 | 1 | 867 | 0 | 0/0 | 0 | — |
...
| ✅ | `packages/parent-atlas-runtime/src/adapters` | 93 | 6 | 1161 | 0 | 0/0 | 1 | — |
| ✅ | `claude-mem/plugin` | 95 | 2 | 24717 | 0 | 2/10 | 0 | 🟠lh |
| ✅ | `claude-mem/plugin/scripts` | 95 | 9 | 23096 | 0 | 2/8 | 0 | 🟠lh |
| ✅ | `packages/atlas-core/src/retrieval` | 95 | 5 | 2227 | 0 | 0/1 | 0 | 🟠lh |
| ✅ | `scripts/docs-atlas` | 95 | 28 | 4390 | 0 | 0/14 | 0 | 🟠lh |
| ✅ | `scripts/graphify-audit` | 95 | 8 | 2790 | 0 | 0/6 | 0 | 🟠lh |
| ✅ | `scripts/ingest` | 95 | 48 | 6834 | 0 | 0/34 | 0 | 🟠lh |
| ✅ | `scripts/memory` | 95 | 10 | 574892 | 0 | 0/4 | 0 | 🟠lh |
| ✅ | `scripts/opencode` | 95 | 150 | 21956 | 0 | 0/126 | 0 | 🟠lh |
| ✅ | `scripts/qdrant` | 95 | 6 | 604 | 0 | 0/2 | 0 | 🟠lh |
| ✅ | `scripts/smoke` | 95 | 30 | 4814 | 0 | 0/12 | 0 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src` | 98 | 17 | 1048783 | 840 | 1282/1674 | 89 | 🔴ssr 🟠lh ⬜notest |
| ✅ | `.claude/hooks` | 100 | 2 | 163 | 0 | 0/2 | 0 | — |
| ✅ | `drizzle/migrations` | 100 | 2 | 76 | 0 | 0/0 | 0 | — |
| ✅ | `drizzle/schema` | 100 | 2 | 50 | 0 | 0/0 | 0 | — |
| ✅ | `gsd_archives/phase-2f1-baseline` | 100 | 1 | 13555 | 0 | 0/8 | 0 | — |
| ✅ | `gsd_archives/phase-2f1-baseline/schema-backup` | 100 | 219 | 13283 | 0 | 0/8 | 0 | — |
| ✅ | `packages/atlas-core` | 100 | 3 | 13946 | 1 | 0/16 | 2 | 🟠lh |
| ✅ | `packages/atlas-core/src` | 100 | 6 | 13664 | 1 | 0/16 | 2 | 🟠lh |
...
| ✅ | `packages/parent-atlas` | 100 | 3 | 39977 | 1 | 0/177 | 1 | 🟠lh |
| ✅ | `packages/parent-atlas/scripts` | 100 | 2 | 520 | 0 | 0/0 | 0 | — |
| ✅ | `packages/parent-atlas/test` | 100 | 86 | 8370 | 1 | 0/40 | 0 | — |
| ✅ | `packages/parent-atlas-retrieval/src/gpu` | 100 | 28 | 8506 | 0 | 0/3 | 0 | — |
| ✅ | `scripts/atlas` | 100 | 2945 | 734120 | 9 | 0/1295 | 12 | 🟠lh |
| ✅ | `scripts/atlas/lib` | 100 | 157 | 18036 | 5 | 0/36 | 0 | 🟠lh |
| ✅ | `scripts/atlas/schema` | 100 | 12 | 2774 | 0 | 0/8 | 0 | — |
...
| ✅ | `sveltekit-frontend/src/lib` | 100 | 11 | 760687 | 8 | 22/950 | 79 | 🟠lh |
...
| ✅ | `sveltekit-frontend/src/lib/server` | 100 | 2572 | 491432 | 8 | 19/845 | 69 | 🟠lh |
| ✅ | `sveltekit-frontend/src/lib/shims` | 100 | 11 | 1248 | 0 | 0/1 | 0 | — |
| ✅ | `sveltekit-frontend/src/lib/types` | 100 | 56 | 7361 | 0 | 0/5 | 0 | — |
| ✅ | `sveltekit-frontend/src/routes/(app)` | 100 | 442 | 113855 | 4 | 442/46 | 0 | 🟠lh ⬜notest |
...
| ✅ | `sveltekit-frontend/src/types` | 100 | 26 | 936 | 0 | 0/1 | 0 | — |
| ✅ | `sveltekit-frontend/tests` | 100 | 288 | 169973 | 5 | 819/86 | 1 | 🟠lh |
| ✅ | `sveltekit-frontend/tests/atlas` | 100 | 23 | 5552 | 0 | 0/12 | 0 | — |
| ✅ | `sveltekit-frontend/tests/routes` | 100 | 33 | 67562 | 2 | 786/13 | 0 | — |
| ✅ | `sveltekit-frontend/tests/routes/auto` | 100 | 791 | 56953 | 0 | 778/3 | 0 | — |
...
| `sveltekit-frontend/api/admin/atlas/taxonomy-candidates/+server.ts` | GET, POST | ❌ | ❌ | ✅ |
...
_…and 772 more. See `codebase-graph.json` for full list._

---

## G4 — API Routes Missing Auth Guard (22)
...
- `sveltekit-frontend/src/routes/api/admin/atlas/graph/projection/load/+server.ts` · POST
- `sveltekit-frontend/src/routes/api/admin/atlas/graph/traverse/+server.ts` · POST
- `sveltekit-frontend/src/routes/api/admin/atlas/registry/search/+server.ts` · GET/POST
- `sveltekit-frontend/src/routes/api/admin/atlas/synthesize/+server.ts` · POST
- `sveltekit-frontend/src/routes/api/admin/atlas/taxonomy-candidates/+server.ts` · GET/POST
...
- `sveltekit-frontend/src/routes/api/ai/emotion/+server.ts` · POST
...
- `sveltekit-frontend/src/routes/api/telemetry/implementation-clusters/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/trpc/[...procedure]/+server.ts` · GET/POST
...
## G16 — Routes Without Test Pairing (69)
- `sveltekit-frontend/src/routes/api/admin/ai-chat/[sessionId]/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/graph/projection/load/+server.ts` · POST
- `sveltekit-frontend/src/routes/api/admin/atlas/graph/proof/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/node/[id]/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/pass-fabric/boundary/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/pass-fabric/current/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/pass-fabric/live/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/pass-fabric/proof/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/phase-lanes/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/phase-lanes/proof/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/retrieval/proof/+server.ts` · GET
- `sveltekit-frontend/src/routes/api/admin/atlas/taxonomy-candidates/+server.ts` · GET/POST
...
- `sveltekit-frontend/src/routes/api/atlas/concept-tagging/+server.ts` · POST
...
## G11 — Hardcoded Localhost References (1702 files)
...
| `url` | 865 |
| `dotenv` | 784 |
| `node:fs/promises` | 740 |
| `crypto` | 685 |
| `ioredis` | 665 |
| `$lib/types` | 662 |
| `node:child_process` | 600 |
| `$lib/server/db/client` | 520 |
| `$lib/server/env.server.js` | 468 |
| `child_process` | 463 |
| `fs/promises` | 384 |
| `drizzle-orm/pg-core` | 331 |
| `svelte` | 316 |
| `@playwright/test` | 299 |
| `$lib/server/db` | 267 |
| `$lib/server/redis.js` | 263 |
| `$lib/components/ui/Icon.svelte` | 260 |
| `node-fetch` | 255 |
| `neo4j-driver` | 226 |
...
- `sveltekit-frontend/src/routes/api` — 9 marker(s), score 76
