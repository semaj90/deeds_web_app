...
- `batch-gpu-analysis-report.json`
- `cluster-agents-index.json`
- `cluster-aliases.json`
...
- `wiki_note_lookup({ query: "docs graph", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/docs/graph/<file>" })` — fetch any file's contents (sandboxed to src/)
