...
Generated: 2026-05-06T01:51:41.499Z
Graph files: 3417
...
| :--- | :--- | ---: |
| D9 | Likely orphans (0 fanIn, no dynImport ref) | 138 |
...
- `src/lib/server/acp/phase90-tools.ts:1` — 0 refs across static/dynamic/type/barrel/path scans; classification=true-orphan-candidate
- `src/lib/server/agents-md/parse-agents-md.ts:1` — 0 refs across static/dynamic/type/barrel/path scans; classification=true-orphan-candidate
- `src/lib/server/agents-md/resolve-directory-context.ts:1` — 0 refs across static/dynamic/type/barrel/path scans; classification=true-orphan-candidate
- `src/lib/server/ai/caching-layer.ts:1` — 0 refs across static/dynamic/type/barrel/path scans; classification=true-orphan-candidate
...
- /audit-components — verify 138 D9 orphan candidates with 8-gate test (G0 transitive-dep, G0.5 dynamic-import, G1-G8 disposition)
