...
| Gate | Status |
|------|--------|
| G4  Auth on API routes | 683✅ / 32❌ |
| G5  Zod on body-parsing routes | 484✅ / 4❌ |
| G15 SSR-unsafe globals | 1❌ |
| G16 Routes without tests | 13❌ |
...
| Dir | Files | Score | Cluster | KAG slug | Quick tool call |
|-----|-------|-------|---------|----------|-----------------|
| `src/lib/ai` | 14 | — | — | `src_lib_ai` | `agents_md({ path: "src/lib/ai" })` |
...
| `src/lib/components/admin` | 5 | — | — | `src_lib_components_admin` | `agents_md({ path: "src/lib/components/admin" })` |
...
| `src/lib/components/evidence` | 41 | — | — | `src_lib_components_evidence` | `agents_md({ path: "src/lib/components/evidence" })` |
...
### `src/lib/server/` (104 dirs)

| Dir | Files | Score | Cluster | KAG slug | Quick tool call |
|-----|-------|-------|---------|----------|-----------------|
| `src/lib/server` | 62 | — | — | `src_lib_server` | `agents_md({ path: "src/lib/server" })` |
| `src/lib/server/ace` | 22 | — | — | `src_lib_server_ace` | `agents_md({ path: "src/lib/server/ace" })` |
...
| `src/lib/server/ai` | 38 | — | — | `src_lib_server_ai` | `agents_md({ path: "src/lib/server/ai" })` |
| `src/lib/server/analysis` | 12 | — | — | `src_lib_server_analysis` | `agents_md({ path: "src/lib/server/analysis" })` |
...
| `src/lib/server/cache` | 13 | — | — | `src_lib_server_cache` | `agents_md({ path: "src/lib/server/cache" })` |
...
| `src/lib/server/config` | 4 | — | — | `src_lib_server_config` | `agents_md({ path: "src/lib/server/config" })` |
...
| `src/lib/server/db` | 70 | — | — | `src_lib_server_db` | `agents_md({ path: "src/lib/server/db" })` |
| `src/lib/server/db/meta` | 2 | — | — | `src_lib_server_db_meta` | `agents_md({ path: "src/lib/server/db/meta" })` |
| `src/lib/server/db/schema` | 38 | — | — | `src_lib_server_db_schema` | `agents_md({ path: "src/lib/server/db/schema" })` |
...
| `src/lib/server/gpu` | 11 | — | — | `src_lib_server_gpu` | `agents_md({ path: "src/lib/server/gpu" })` |
| `src/lib/server/graph` | 20 | — | — | `src_lib_server_graph` | `agents_md({ path: "src/lib/server/graph" })` |
...
| `src/lib/server/indexer` | 19 | — | — | `src_lib_server_indexer` | `agents_md({ path: "src/lib/server/indexer" })` |
...
| `src/lib/server/legal` | 7 | — | — | `src_lib_server_legal` | `agents_md({ path: "src/lib/server/legal" })` |
| `src/lib/server/llm` | 6 | — | — | `src_lib_server_llm` | `agents_md({ path: "src/lib/server/llm" })` |
| `src/lib/server/mcp` | 3 | — | — | `src_lib_server_mcp` | `agents_md({ path: "src/lib/server/mcp" })` |
...
| `src/lib/server/retrieval` | 28 | — | — | `src_lib_server_retrieval` | `agents_md({ path: "src/lib/server/retrieval" })` |
| `src/lib/server/search` | 9 | — | — | `src_lib_server_search` | `agents_md({ path: "src/lib/server/search" })` |
| `src/lib/server/services` | 2 | — | — | `src_lib_server_services` | `agents_md({ path: "src/lib/server/services" })` |
...
| `src/lib/server/types` | 10 | — | — | `src_lib_server_types` | `agents_md({ path: "src/lib/server/types" })` |
...
| `src/lib/server/vector` | 10 | — | — | `src_lib_server_vector` | `agents_md({ path: "src/lib/server/vector" })` |
...
| Dir | Files | Score | Cluster | KAG slug | Quick tool call |
|-----|-------|-------|---------|----------|-----------------|
| `src/lib/services` | 8 | — | — | `src_lib_services` | `agents_md({ path: "src/lib/services" })` |
| `src/lib/services/error-analysis` | 17 | — | — | `src_lib_services_error_analysis` | `agents_md({ path: "src/lib/services/error-analysis" })` |
| `src/lib/services/knowledge-search` | 11 | — | — | `src_lib_services_knowledge_search` | `agents_md({ path: "src/lib/services/knowledge-search" })` |
...
| Dir | Files | Score | Cluster | KAG slug | Quick tool call |
|-----|-------|-------|---------|----------|-----------------|
| `src/lib/stores` | 14 | — | — | `src_lib_stores` | `agents_md({ path: "src/lib/stores" })` |
| `src/lib/stores/dashboard` | 3 | — | — | `src_lib_stores_dashboard` | `agents_md({ path: "src/lib/stores/dashboard" })` |
| `src/lib/stores/unified` | 6 | — | — | `src_lib_stores_unified` | `agents_md({ path: "src/lib/stores/unified" })` |
...
| Dir | Files | Score | Cluster | KAG slug | Quick tool call |
|-----|-------|-------|---------|----------|-----------------|
| `src/lib/types` | 52 | — | — | `src_lib_types` | `agents_md({ path: "src/lib/types" })` |

### `src/lib/utils/` (1 dir)

| Dir | Files | Score | Cluster | KAG slug | Quick tool call |
|-----|-------|-------|---------|----------|-----------------|
| `src/lib/utils` | 42 | — | — | `src_lib_utils` | `agents_md({ path: "src/lib/utils" })` |

### `src/lib/webgpu/` (1 dir)

| Dir | Files | Score | Cluster | KAG slug | Quick tool call |
|-----|-------|-------|---------|----------|-----------------|
| `src/lib/webgpu` | 19 | — | — | `src_lib_webgpu` | `agents_md({ path: "src/lib/webgpu" })` |
...
| `src/routes/(app)/legal-corpus` | 2 | — | — | `src_routes__app__legal_corpus` | `agents_md({ path: "src/routes/(app)/legal-corpus" })` |
