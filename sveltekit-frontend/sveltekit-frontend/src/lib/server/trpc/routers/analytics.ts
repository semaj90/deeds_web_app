...
// Inline schema — avoids importing from analytics-sink which may not exist
  ...
  recommendation: router({
    feedback: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        // Lazy import analytics-sink — it may not be loaded at server start
        try {
          ...
          // analytics-sink may not be available; non-fatal
        }
