 ...
 *   npm run graphify:audit            # gemma4 path with mock fallback (default)
 *   npm run graphify:audit:mock       # mock path only
 *   npm run graphify:audit:gemma4     # Gemma4 path with fallback
 *   npm run graphify:audit:full       # full codebase (1000+ files)
 */
