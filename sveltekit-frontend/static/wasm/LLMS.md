...
- `wiki_note_lookup({ query: "static wasm", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/static/wasm/<file>" })` — fetch any file's contents (sandboxed to src/)
