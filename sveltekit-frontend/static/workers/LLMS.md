# AGENTS.md — `sveltekit-frontend/static/workers`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: sveltekit-frontend/static/workers
...
- `flatbuffers.js`
- `legal-bert-onnx-worker.js`
- `llama-rl-worker.js`
- `llama-worker.js`
- `lod-cache-worker.js`
- `nes-rl.js`
- `ocr-service-worker.js`
- `qlora-trainer.js`
...
| Gate | Status | Detail |
|------|--------|--------|
| G17 | ❌ FAIL | 2/13 files — use env.server.ts getters |

_Gates checked: G17. Run `npm run index:codebase:fast && npm run agents:write` to refresh._
## Todos + Enhancements

- **[HIGH]** [G17] Fix **G17** No hardcoded localhost URLs: 2/13 files — use env.server.ts getters
...
- `wiki_note_lookup({ query: "static workers", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/static/workers/<file>" })` — fetch any file's contents (sandboxed to src/)
