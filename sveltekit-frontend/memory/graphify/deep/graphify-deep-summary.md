...
Generated: 2026-05-09T01:31:12.858Z
...
|------|-------|
| imports_static | 5544 |
| test_covers_file | 2508 |
| server_route_depends_on | 1024 |
| db_dependency | 902 |
| env_dependency | 608 |
| imports_dynamic | 492 |
| redis_dependency | 387 |
| exports_from | 276 |
...
| 2 | `src/lib/server/env.server.ts` | server | 409 | 0 |
| 3 | `src/lib/components/ui/Icon.svelte` | client | 253 | 14 |
| 4 | `src/lib/server/redis.ts` | server | 248 | 1 |
| 5 | `src/lib/server/db/schema-postgres.ts` | server | 194 | 2 |
| 6 | `src/lib/server/ollama.ts` | server | 172 | 11 |
