# TRACE MCP Tool Audit — 2026-05-09T03-42-33
...
|------|--------|---------|--------|
| `graph.expand_neighborhood` | PASS | 52ms | {"content":[{"type":"text","text":"{\n  \"center\": \"file:src/lib/server/ace/co |
| `graph.shortest_path` | PASS | 33ms | {"content":[{"type":"text","text":"{\n  \"path\": null,\n  \"hops\": null,\n  \" |
...
| `topology.search_near` | PASS | 129ms | {"content":[{"type":"text","text":"{\n  \"ok\": true,\n  \"query\": \"redis cach |
| `topology.same_som_cluster` | PASS | 5ms | {"content":[{"type":"text","text":"{\"error\":\"Node not found in Postgres index |
| `topology.search_4d` | PASS | 3ms | {"content":[{"type":"text","text":"{\n  \"ok\": false,\n  \"source\": \"topology |
| `clusters.get_members` | PASS | 14ms | {"content":[{"type":"text","text":"{\n  \"clusterKey\": \"gpu:92\",\n  \"count\" |
| `trace.kag_search` | PASS | 59ms | {"content":[{"type":"text","text":"{\n  \"success\": true,\n  \"data\": [],\n  \ |
...
| `search.hybrid` | PASS | 11ms | {"content":[{"type":"text","text":"{\n  \"results\": [],\n  \"count\": 0,\n  \"m |
| `search.go_hybrid` | PASS | 24ms | {"content":[{"type":"text","text":"{\n  \"ok\": true,\n  \"source\": \"go-search |
...
| `kag.record_agent_run` | PASS | 3ms | {"content":[{"type":"text","text":"{\n  \"success\": true,\n  \"taskId\": \"smok |
...
| `kag.multi_lane_search` | PASS | 1437ms | {"content":[{"type":"text","text":"{\n  \"queryHash\": \"1619ea78ab79\",\n  \"la |
...
| `clusters.get_summary_lenses` | PASS | 25ms | {"content":[{"type":"text","text":"{\"clusterId\":92,\"keyFiles\":[],\"kagNotes\ |
...
| `ops.record_fix_attempt` | PASS | 4ms | {"content":[{"type":"text","text":"{\"ok\":true,\"fix_attempt_id\":\"22\",\"fix_ |
...
| `hypergraph.expand_members` | PASS | 3ms | {"content":[{"type":"text","text":"{\"ok\":false,\"error\":\"TypeError: fetch fa |
