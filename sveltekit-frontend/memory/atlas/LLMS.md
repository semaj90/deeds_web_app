...
- `codebase-atlas.dirs.json`
- `codebase-atlas.min.json`
- `codebase-atlas.top.json`
...
- `wiki_note_lookup({ query: "memory atlas", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/memory/atlas/<file>" })` — fetch any file's contents (sandboxed to src/)
