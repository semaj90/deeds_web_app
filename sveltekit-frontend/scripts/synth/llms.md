# AGENTS.md — `sveltekit-frontend/scripts/synth`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: sveltekit-frontend/scripts/synth
...
- `export-cartridge-binary.mjs`
- `handoff-to-claude.mjs`
- `run-loop.mjs`
...
- `read_file({ filePath: "sveltekit-frontend/scripts/synth/<file>" })` — fetch any file's contents (sandboxed to src/)
