...
> Directory audit: scripts/lib

## Snapshot

- module directory with 11 files, 1 API handlers, 1 Drizzle refs
- Audit score: **100/100**
- 🟠 hardcoded localhost: 1
- Tags: `mjs` `scripts` `lib` `bounded-output.mjs` `mcp_unwrap.mjs` `zod`

## Files (11)

- `scripts/lib/bounded-output.mjs`
- `scripts/lib/mcp_unwrap.mjs`
- `scripts/lib/phase89-adaptive-chunker.mjs`
...
- `wiki_note_lookup({ query: "scripts lib", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/lib/<file>" })` — fetch any file's contents (sandboxed to src/)
