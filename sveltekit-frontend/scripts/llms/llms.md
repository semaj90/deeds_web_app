# AGENTS.md — `sveltekit-frontend/scripts/agents`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: sveltekit-frontend/scripts/agents
...
- `build-agents-index.mjs`
- `build-mini-active-cache.mjs`
- `qdrant-payload-backfill.mjs`
- `setup-karpathy-wiki.mjs`
- `som-cluster-cards.mjs`
...
- `read_file({ filePath: "sveltekit-frontend/scripts/agents/<file>" })` — fetch any file's contents (sandboxed to src/)
