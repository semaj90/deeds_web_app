...
- Tags: `mjs` `scripts` `tools` `gemma4-agent-prompt.mjs` `gemma4-turboquant-prompt.mjs`

## Files (2)

- `scripts/tools/gemma4-agent-prompt.mjs`
- `scripts/tools/gemma4-turboquant-prompt.mjs`
...
- `wiki_note_lookup({ query: "scripts tools", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/tools/<file>" })` — fetch any file's contents (sandboxed to src/)
