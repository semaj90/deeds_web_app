# AGENTS.md — `scripts/mcp`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-14T00:50:41.701Z · agents.md spec · regen: npm run agents:write -->

> Directory audit: scripts/mcp

## Snapshot

- module directory with 10 files, 0 API handlers
- Audit score: **85/100**
- 🟠 hardcoded localhost: 6
- Tags: `mjs` `scripts` `mcp` `agent-orchestrator.mjs` `zod` `contextual-prompt-engineer.mjs`

## Files (10)

- `scripts/mcp/agent-orchestrator.mjs`
- `scripts/mcp/contextual-prompt-engineer.mjs`
- `scripts/mcp/demo-svelte5-query.mjs`
- `scripts/mcp/gemma4-offload-mcp.mjs`
- `scripts/mcp/query-db-for-svelte5-errors.mjs`
...
| Gate | Status | Detail |
|------|--------|--------|
| G17 | ❌ FAIL | 6/10 files — use env.server.ts getters |

_Gates checked: G17. Run `npm run index:codebase:fast && npm run agents:write` to refresh._
## Todos + Enhancements

- **[HIGH]** [G17] Fix **G17** No hardcoded localhost URLs: 6/10 files — use env.server.ts getters
...
- `wiki_note_lookup({ query: "scripts mcp", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/mcp/<file>" })` — fetch any file's contents (sandboxed to src/)
