...
- Audit score: **90/100**
- no audit signals
- Tags: `mjs` `scripts` `diff` `applier.mjs` `zod` `generator.mjs`
...
- `read_file({ filePath: "scripts/diff/<file>" })` — fetch any file's contents (sandboxed to src/)
