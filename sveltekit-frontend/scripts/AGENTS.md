...
- 303 file(s), 0 handler(s)
- Audit score: _(no GPU audit)_
- 🟠 hardcoded localhost: 46 · TODOs: 2
...
| Gate | Status | Detail |
|------|--------|--------|
| G17 | ❌ FAIL | 46/303 files — use env.server.ts getters |

_Gates checked: G17. Run `npm run index:codebase:fast && npm run agents:write` to refresh._
## Todos + Enhancements

- **[HIGH]** [G17] Fix **G17** No hardcoded localhost URLs: 46/303 files — use env.server.ts getters
...
- **Paired tests**: 1/303 files have paired tests
