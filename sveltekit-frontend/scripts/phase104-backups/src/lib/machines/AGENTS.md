# AGENTS.md — `scripts/phase104-backups/src/lib/machines`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-14T00:50:41.701Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/phase104-backups/src/lib/machines
...
- `read_file({ filePath: "scripts/phase104-backups/src/lib/machines/<file>" })` — fetch any file's contents (sandboxed to src/)
