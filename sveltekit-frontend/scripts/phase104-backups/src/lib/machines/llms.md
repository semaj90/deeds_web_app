# AGENTS.md — `sveltekit-frontend/scripts/phase104-backups/src/lib/machines`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: sveltekit-frontend/scripts/phase104-backups/src/lib/machines
...
- `aiAssistantMachine.minimal.ts`
- `case-workflow-machine.ts`
- `graph-cache-machine.ts`
- `legalAIMachine.ts`
- `predictive-typing-machine.ts`
...
- `read_file({ filePath: "sveltekit-frontend/scripts/phase104-backups/src/lib/machines/<file>" })` — fetch any file's contents (sandboxed to src/)
