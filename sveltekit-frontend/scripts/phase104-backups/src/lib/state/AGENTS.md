# AGENTS.md — `scripts/phase104-backups/src/lib/state`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-13T05:38:18.598Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/phase104-backups/src/lib/state
...
- `read_file({ filePath: "scripts/phase104-backups/src/lib/state/<file>" })` — fetch any file's contents (sandboxed to src/)
