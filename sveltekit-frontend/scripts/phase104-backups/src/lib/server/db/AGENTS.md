# AGENTS.md — `scripts/phase104-backups/src/lib/server/db`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-14T00:50:41.701Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/phase104-backups/src/lib/server/db
...
- `read_file({ filePath: "scripts/phase104-backups/src/lib/server/db/<file>" })` — fetch any file's contents (sandboxed to src/)
