# AGENTS.md — `scripts/phase104-backups/src/lib/server`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-13T18:24:25.300Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/phase104-backups/src/lib/server
...
- `read_file({ filePath: "scripts/phase104-backups/src/lib/server/<file>" })` — fetch any file's contents (sandboxed to src/)
