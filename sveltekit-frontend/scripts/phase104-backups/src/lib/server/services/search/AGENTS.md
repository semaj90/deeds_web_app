# AGENTS.md — `scripts/phase104-backups/src/lib/server/services/search`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-13T18:24:25.300Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/phase104-backups/src/lib/server/services/search
...
- `read_file({ filePath: "scripts/phase104-backups/src/lib/server/services/search/<file>" })` — fetch any file's contents (sandboxed to src/)
