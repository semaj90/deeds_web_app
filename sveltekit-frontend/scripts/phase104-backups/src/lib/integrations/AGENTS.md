# AGENTS.md — `scripts/phase104-backups/src/lib/integrations`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-13T05:38:18.598Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/phase104-backups/src/lib/integrations
...
- `read_file({ filePath: "scripts/phase104-backups/src/lib/integrations/<file>" })` — fetch any file's contents (sandboxed to src/)
