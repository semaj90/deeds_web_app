# AGENTS.md — `scripts/phase104-backups/src/lib/types`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-13T22:18:48.377Z · agents.md spec · regen: npm run agents:write -->

> Directory: scripts/phase104-backups/src/lib/types
...
- `read_file({ filePath: "scripts/phase104-backups/src/lib/types/<file>" })` — fetch any file's contents (sandboxed to src/)
