...
- Tags: `mjs` `scripts` `diagnostics` `audit-dead-npm-scripts.mjs` `zod` `clean-dead-npm-scripts.mjs`

## Files (4)

- `scripts/diagnostics/audit-dead-npm-scripts.mjs`
- `scripts/diagnostics/clean-dead-npm-scripts.mjs`
- `scripts/diagnostics/log-ollama-response.ts`
- `scripts/diagnostics/playwright-live-recorder.mjs`
...
- `wiki_note_lookup({ query: "scripts diagnostics", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "scripts/diagnostics/<file>" })` — fetch any file's contents (sandboxed to src/)
