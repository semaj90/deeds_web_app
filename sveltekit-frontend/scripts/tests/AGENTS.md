...
> Directory audit: scripts/tests

## Snapshot

- module directory with 57 files, 0 API handlers, 1 Drizzle refs
- Audit score: **95/100**
- 🟠 hardcoded localhost: 32
- Tags: `mjs` `scripts` `tests` `audit-gates.mjs` `zod` `test`

## Files (57)

- `scripts/tests/audit-gates.mjs`
- `scripts/tests/audit-gitignore-vs-indexer.mjs`
- `scripts/tests/audit-icons.mjs`
- `scripts/tests/bounded-output.mjs`
