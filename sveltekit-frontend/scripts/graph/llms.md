# AGENTS.md — `sveltekit-frontend/scripts/graph`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: sveltekit-frontend/scripts/graph
...
- `build-community-graph.mjs`
- `debug-gds-lookup.mjs`
- `ingest-to-kag-notes.mjs`
- `prune-graph-triples.mjs`
- `synthesize-next-actions.mjs`
- `synthesize-relationships.mjs`
...
- `wiki_note_lookup({ query: "scripts graph", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "sveltekit-frontend/scripts/graph/<file>" })` — fetch any file's contents (sandboxed to src/)
