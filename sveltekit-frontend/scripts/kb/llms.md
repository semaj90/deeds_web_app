...
- `build-embedding-jobs.mjs`
- `export-lane-router-training-set.mjs`
- `generate-module-cartridges.mjs`
- `graph-jsonl-to-cards.mjs`
- `rank-graph-cards.mjs`
- `run-embedding-jobs.mjs`
- `search-graph-cards.mjs`
- `search-graph-cards.ts`
...
- `read_file({ filePath: "sveltekit-frontend/scripts/kb/<file>" })` — fetch any file's contents (sandboxed to src/)
