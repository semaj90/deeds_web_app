...
const RABBITMQ_PORT   = parseInt(process.env.RABBITMQ_PORT ?? '5673');
const RABBITMQ_USER   = process.env.RABBITMQ_USER   ?? 'legal_admin';
const RABBITMQ_PASS   = process.env.RABBITMQ_PASSWORD ?? 'secret123';
