...
if(apply){
  ...
  try{
    ...
    try{
      ...
      for(const b of origin.bindings){await client.query(`INSERT INTO graphify_files (workspace_id,source_ref,source_revision,code_source_revision,content_hash,byte_length,first_seen_run_id,last_seen_run_id) VALUES ($1::uuid,$2,$3,$4,$5,$6,$7::uuid,$7::uuid) ON CONFLICT (workspace_id,source_ref,code_source_revision) WHERE code_source_revision IS NOT NULL DO UPDATE SET source_revision=EXCLUDED.source_revision,content_hash=EXCLUDED.content_hash,byte_length=EXCLUDED.byte_length,last_seen_run_id=EXCLUDED.last_seen_run_id`,[workspaceId,b.sourceRef,b.gitBlobOid,b.sourceRevision,b.contentDigest,b.byteLength,runId]);}
