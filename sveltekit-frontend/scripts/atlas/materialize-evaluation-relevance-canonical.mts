...
async function main() {
  ...
  console.log('Phase 3: Materialize Evaluation Relevance (Canonical Identity)');
  ...
  try {
    ...
    if (dryRun) {
      ...
      console.log('');
      console.log('Join strategy: match by packet_key (if exists in atlas_packets)');
      console.log('For unmatched evidence, use default neutral score (grade 1)');
      console.log('');
      console.log('To apply, run:');
      console.log(`  npx tsx scripts/atlas/materialize-evaluation-relevance-canonical.mts --apply`);
    } else {
