# Recommendations — 2026-06-05T03:14:25.974Z

**Total**: 2 recommendations across 1 clusters

## Top 10
1. **[HIGH]** `graph:missing-neighborhood` — Disconnected graph neighborhood for query seeds: [src/hooks.server.ts, scripts/activity/log-developer-activity.mjs]
...
2. **[MEDIUM]** `retrieval:low-context-density` — Low context density retrieved for query: "context-assembler 1780629210005"
...
- [medium] Low context density retrieved for query: "context-assembler 1780629210005"
- [high] Disconnected graph neighborhood for query seeds: [src/hooks.server.ts, scripts/activity/log-developer-activity.mjs]
