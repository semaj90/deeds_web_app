...
-- Git commit/tree IDs and packet cache epochs remain upstream provenance/cache
-- coordinates and are never accepted here as graph workspace authority.
-- Per-node source_revision stays nullable until the authoritative source owner
-- supplies CodeSourceRevisionV1.
