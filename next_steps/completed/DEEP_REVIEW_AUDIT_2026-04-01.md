...
|-------|----------|------|---------|--------|
| gemma4-rotorquant:latest Q4_K_M | `gemma3Q4_K_M/` | 7.38 GB | Unsloth fine-tuned LLM (GGUF) | ACTIVE — Ollama |
...
|-------|-----------|--------|-------------|
| **LLM Inference** | Ollama (native, GPU) | RUNNING | gemma4-rotorquant:latest Q4_K_M on RTX 3060 Ti |
...
- LLM Inference (Ollama, GPU, gemma4-rotorquant:latest + embeddinggemma)
...
| Ollama LLM | gemma4-rotorquant:latest + embeddinggemma, GPU |
...
RAG Pipeline (corrective reformulation)                   ← WORKING (7 endpoints, 14 consumers)
  ...
  ↓
Ollama gemma4-rotorquant:latest (or TRT-LLM when WSL2 ready)         ← WORKING (Ollama) / NOT BUILT (TRT)
  ↓
